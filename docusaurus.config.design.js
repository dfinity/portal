...
const navbarItems = [
  ...
  },
  {
    ...
    items: intoColumns([
      ...
      [
        // column 2
        menuDivider("Sections"),
        {
          label: "Translated layout",
          href: "/",
        },
        {
          label: "Shifted cards",
...
const config = {
  ...
  url: `https://xx5lk-lqaaa-aaaam-abqaa-cai.icp0.io`,
  baseUrl: "/",
  ...
  staticDirectories: ["design/static"],
  plugins: [
