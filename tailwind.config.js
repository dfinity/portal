  ...
  plugins: [
    ...
    plugin(({ addComponents }) => {
      ...
      const components = {
                ...
                '.button-fancy-ai': '@apply inline-block  rounded-xl text-white tw-heading-7-caps py-4 px-6 uppercase hover:no-underline hover:text-white transition-colors border-none',
