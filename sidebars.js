        ...
        items: [
          {
            ...
            },
            {
              ...
              link: {
                ...
                items: [
                  "developer-docs/backend/rust/1-infrastructure",
                  "developer-docs/backend/rust/2-code-organization",
                  "developer-docs/backend/rust/3-dev-env",
                  "developer-docs/backend/rust/4-quickstart",
                  "developer-docs/backend/rust/5-deploying",
                  "developer-docs/backend/rust/6-intercanister",
                  "developer-docs/backend/rust/7-upgrading",
                  "developer-docs/backend/rust/8-optimizing",
                  "developer-docs/backend/rust/9-counter",
                  "developer-docs/backend/rust/10-timers",
                  "developer-docs/backend/rust/11-stable-structures",
                  "developer-docs/backend/rust/12-searching-records",
                  "developer-docs/backend/rust/13-access-control",
                  "developer-docs/backend/rust/14-candid",
                  "developer-docs/backend/rust/15-samples",
              ],
            },
            {
              type: "category",
