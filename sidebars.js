...
const sidebars = {
  ...
  motoko: [
    ...
    },
    {
      ...
      link: {
        type: "doc",
        id: "motoko/guide-v1/about-this-guide",
      },
      items: [
        // "motoko/official/about-this-guide",
        "motoko/guide-v1/motoko-introduction",
        "motoko/guide-v1/basic-concepts",
        "motoko/guide-v1/base-intro",
        "motoko/guide-v1/mutable-state",
        "motoko/guide-v1/local-objects-classes",
        "motoko/guide-v1/actors-async",
        "motoko/guide-v1/errors",
        "motoko/guide-v1/pattern-matching",
        "motoko/guide-v1/sharing",
        "motoko/guide-v1/message-inspection",
        "motoko/guide-v1/modules-and-imports",
        "motoko/guide-v1/control-flow",
        "motoko/guide-v1/structural-equality",
        "motoko/guide-v1/actor-classes",
        "motoko/guide-v1/caller-id",
        "motoko/guide-v1/cycles",
        "motoko/guide-v1/upgrades",
        "motoko/guide-v1/compatibility",
        "motoko/guide-v1/stablememory",
        "motoko/guide-v1/heartbeats",
        "motoko/guide-v1/language-manual",
        "motoko/guide-v1/compiler-ref",
        "motoko/guide-v1/motoko-grammar",
        "motoko/guide-v1/overview",
        "motoko/guide-v1/style",
      ]
    },
    {
      type: "category",
