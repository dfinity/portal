...
Developers will be able to opt out of this restriction by setting `wasm_memory_limit=4GiB` your in canister settings using `dfx` version` 0.20.1-beta.0` or higher. Opting out of this restriction is risky, and requires you to program your canister very carefully.
