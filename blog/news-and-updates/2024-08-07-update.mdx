...
New documentation has been published that details Content Security Policies (CSPs) for asset canisters, security recommendations, and details about changes to the asset canister's default CSP in `dfx` versions newer than `v0.21.0`. You can learn more [on the developer docs](https://internetcomputer.org/docs/building-apps/frontends/asset-security).
