...
The DFINITY NNS team has proposed a change to neuron visibility. This change would allow neurons to choose whether they are publicly visible or private, allowing neurons to keep their voting decisions private or allow neurons to advertise themselves publicly for following.
