...
description: In this week's update, we have a very important message about a critical security bug in Agent JS, updates from the NFT working group, and info about ICP at ETHDenver next week!
tags: [Devs]
