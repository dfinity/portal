...
You can learn more about the Motoko VS Code extension [here](https://internetcomputer.org/docs/current/building-dapps/developer-tools/ide/vs-code).
...
For more information on `dfx nns` and `dfx sns`, please see the reference documentation [here](https://internetcomputer.org/docs/current/building-dapps/developer-tools/dfx/dfx-nns)
