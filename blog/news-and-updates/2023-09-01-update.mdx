...
You can learn more about the Motoko VS Code extension [here](/building-apps/developer-tools/icp-ninja).
...
For more information on `dfx nns` and `dfx sns`, please see the reference documentation [here](/building-apps/developer-tools/dfx/dfx-nns)
