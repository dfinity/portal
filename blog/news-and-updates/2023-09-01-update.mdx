...
![Motoko VS Code 1](../../static/img/blog/motoko-vs-code-1.jpg)
...
![Motoko VS Code2 ](../../static/img/blog/motoko-vs-code-2.jpg)
...
You can learn more about the Motoko VS Code extension [here](../../docs/developer-docs/setup/vs-code.md).
...
`dfx extensions` is a highly anticipated feature that will replace the way certain canisters are installed, such as the NNS and SNS canisters. Instead of having to manually install and deploy these canisters locally to use them, `dfx extensions` can be used to install them, such as:
...
Then, you can use them as you did before, such as `dfx nns` and `dfx sns`. `dfx extensions` will be available in `dfx release 0.15.0`. 
