...
You can learn more about the Motoko VS Code extension [here](https://internetcomputer.org/docs/building-apps/developer-tools/ide/icp-ninja).
...
For more information on `dfx nns` and `dfx sns`, please see the reference documentation [here](https://internetcomputer.org/docs/building-apps/developer-tools/dfx/dfx-nns)
