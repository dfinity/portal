...
Try it yourself on the [developer docs](https://internetcomputer.org/docs/current/home) by clicking the 'Ask AI' button!
...
- [3.2 Using HTTPS outcalls.](/docs/current/tutorials/developer-journey/level-3/3.2-https-outcalls): HTTPS outcalls are a feature of canisters on ICP that allow smart contracts to directly make calls to HTTP servers that are external to ICP. This module covers:
