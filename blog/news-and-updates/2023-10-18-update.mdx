...
- [3.1 Motoko package managers.](/docs/current/tutorials/developer-journey/level-3/3.1-package-managers.md): To use packages developed outside of the Motoko base library, a Motoko package manager can be used. This module covers:
...
- [3.2 Using HTTPS outcalls.](/docs/current/tutorials/developer-journey/level-3/3.2-https-outcalls.md): HTTPS outcalls are a feature of canisters on the IC that allow smart contracts to directly make calls to HTTPS servers that are external to the IC. This module covers:
...
- [3.4 Introduction to agents.](/docs/current/tutorials/developer-journey/level-3/3.4-intro-to-agents.md): On the Internet Computer, an **agent** is a library used to make calls to the IC's public interface. This module covers:
...
- [3.5 Identities and authentication.](/docs/current/tutorials/developer-journey/level-3/3.5-identities-and-auth.md): When developing on the Internet Identity, there are several types of identities and methods of authentication that you'll encounter. This module covers: 
    - Types of identity.
    - Internet Identity.
...
- [3.6 Motoko level 3.](/docs/current/tutorials/developer-journey/level-3/3.6-motoko-lvl3.md): In this Motoko level, we'll look into caller identification, adding access control with identities, plus other non-identity related functionalities such as pattern matching and periodic tasks. This module covers:
