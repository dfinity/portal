...
The first video, **ICP Developer Ladder 0.1 | Overview of the Internet Computer** corresponds to the very first page in the developer ladder series, which can be found [here](/docs/tutorials/developer-journey/level-0/ic-overview).
