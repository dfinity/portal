...
Hello developers, and welcome to this week's developer weekly update! In this week's update, we have new chain-key tokens live on the mainnet, proposals for updates to the NNS and SNSs, and a request for community feedback on the proposed ICRC-4 standard. Let's get started!
...
To learn more about creating ckERC20 tokens, check out the [developer documentation](/docs/current/building-dapps/chain-fusion/chain-key-tokens/ckerc20/overview).
