...
Hello Severin, thanks for helping me, and welcome to this week's developer weekly update! This week, there is a new release of `dfx` to discuss, new NNS proposals to vote on, and a new community project to explore. Let's get started!
...
v0.180 also includes Motoko v0.11.0, which also includes breaking changes. [Read the Motoko v0.11.0 migration guide](https://internetcomputer.org/docs/current/developer-docs/backend/motoko/0.11.0-migration-guide/).
