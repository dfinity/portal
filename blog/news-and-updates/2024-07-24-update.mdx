...
Want to learn more? Check out the [threshold Schnorr overview](/docs/current/building-apps/using-network-features/signatures/t-schnorr).

Want to start using threshold Schnorr? [Learn how to sign transactions with t-Schnorr](/docs/current/building-apps/using-network-features/signatures/t-schnorr)
...
- [System time and timestamps](/docs/current/building-apps/using-network-features/time-and-timestamps): Learn about how to use system time, how to convert timestamps into different formats, and how to calculate the difference between two timestamps.
...
- [Init args](/docs/current/building-apps/developer-tools/advanced-dfx/init-args): Learn how to use init args and init arg files with `dfx`.

This week, the agent documentation saw some significant revisions, specifically on these pages:

- [JavaScript agent](/docs/current/building-apps/calling-dapps/agents/javascript-agent)

- [Node.js](/docs/current/building-apps/calling-dapps/agents/nodejs)

- [Rust agent](/docs/current/building-apps/calling-dapps/agents/rust-agent)
