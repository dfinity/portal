...
Want to learn more? Check out the [threshold Schnorr overview](/docs/building-apps/network-features/signatures/t-schnorr).

Want to start using threshold Schnorr? [Learn how to sign transactions with t-Schnorr](/docs/building-apps/network-features/signatures/t-schnorr)
...
- [System time and timestamps](/docs/building-apps/network-features/time-and-timestamps): Learn about how to use system time, how to convert timestamps into different formats, and how to calculate the difference between two timestamps.

- [Auto-scaling architecture](/docs/home): View an example of how to create a project that auto-scales based on memory usage.

- [Init args](/docs/building-apps/developer-tools/advanced-dfx/init-args): Learn how to use init args and init arg files with `dfx`.

This week, the agent documentation saw some significant revisions, specifically on these pages:

- [JavaScript agent](/docs/building-apps/interact-with-canisters/agents/javascript-agent)

- [Node.js](/docs/building-apps/interact-with-canisters/agents/nodejs)

- [Rust agent](/docs/building-apps/interact-with-canisters/agents/rust-agent)
