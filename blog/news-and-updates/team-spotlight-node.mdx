...
**Could you give us a brief overview of what ICP-OS is?**

*ICP-OS is an umbrella term for all [of] the operating systems within ICP, including:*

- *SetupOS (AKA ICP-OS installer), which deploys a new replica node (by installing HostOS and GuestOS).*
...
*Readers should view ICP-OS folder in ICP repo where our operating systems reside: https://github.com/dfinity/ic/tree/master/ic-os*
...
*The node team supports node providers during the onboarding procedure (ICP-OS installation), but one of our team priorities is to make the Node Provider onboarding procedure as simple and decentralized as possible so that the Node Team and DFINITY are not a necessary part of the onboarding process.*
...
**With consistent upgrades and changes to ICP-OS software, how does the Node team contribute to the lifecycle of nodes?**
...
**What is one feature or aspect of ICP-OS that the team is the most proud of?**
