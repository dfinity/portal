...
description: Hello everyone! It's time for another issue of team spotlight. For this edition, we interviewed the Node team to learn more about the core technology of the Internet Computer. 
tags: [Team spotlight]
image: /img/blog/dev-update-blog-node.jpeg
---

![Node Team spotlight](../../static/img/blog/dev-update-blog-node.jpeg)
...
![Node diagram](../../static/image/blog/node-diagram.png)
...
![IC Stack](../../static/image/blog/ic-stack.png)
