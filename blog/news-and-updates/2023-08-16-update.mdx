...
The first portion of this series, Level 0: Pre-flight operations, is out now and ready for you to follow along with! You can get started with your Developer Ladder [here](https://internetcomputer.org/docs/current/tutorials/developer-journey/level-0/).
...
You can find the full documentation with examples [here](/docs/current/motoko/main/reference/generating-docs/.
