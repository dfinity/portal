...
The first portion of this series, Level 0: Pre-flight operations, is out now and ready for you to follow along with! You can get started with the Developer Liftoff [here](https://internetcomputer.org/docs/tutorials/developer-liftoff/level-0/).
...
- The new `dfx deploy --playground` feature, which can be used to deploy canisters directly to the playground. A blog post diving into this feature specifically will be released soon.
...
You can find the full documentation with examples [here](/docs/motoko/main/reference/generating-docs/.
