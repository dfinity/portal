...
description: In this issue, we're excited to introduce the first portion of a new documentation series: Developer Journey, plus talk about the upcoming `dfx` release, and some new documentation on the Motoko feature `mo-doc`.
tags: [Devs]
...
Hey developers! Welcome to this week's developer weekly update. In this issue, we're excited to introduce the first portion of a new documentation series: Developer Journey, plus talk about the upcoming `dfx` release, and some new documentation on the Motoko feature `mo-doc`. 
...
- Removal of the `dfx nns` and `dfx sns` commands, which will be part of the new upcoming subcommand, `dfx extenstions`. 

A full detailed breakdown of the full release notes will be available in an upcoming blog post. Stay tuned! 
...
That'll wrap things up for this week's update. Be sure to also check out this week's issue of team spotlight, where we interviewed the node team!
