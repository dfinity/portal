...
![Header image](blog/_assets/moonshot.png)

<head>
  <meta property="og:image" content={require('../_assets/moonshot.png').default}/>
  <meta property="twitter:image" content={require('../_assets/moonshot.png').default}/>
</head>
...
![Header image](blog/_assets/motoko-cubed.png)
...
![Header image](blog/_assets/code-blocks.png)
