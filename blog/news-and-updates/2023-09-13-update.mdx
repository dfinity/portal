...
- [Pulling canister dependencies](/docs/current/building-dapps/creating-dapps/using-third-party-canisters): Learn how to use the new `dfx deps` feature to pull third-party canister dependencies.
