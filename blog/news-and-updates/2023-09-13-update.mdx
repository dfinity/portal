...
- [Developer Liftoff level 0](/docs/tutorials/developer-liftoff/level-0/): Start the Developer Liftoff at the very beginning by following the level 0 module. In level 0, we cover the fundamentals of what the [Internet Computer](https://learn.internetcomputer.org/hc/en-us/articles/33152818663444-What-is-ICP) is, what terms you should be familiar with, and what tools we'll be using throughout our journey.
