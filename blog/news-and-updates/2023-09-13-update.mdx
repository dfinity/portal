...
- [Developer journey level 1](/docs/current/tutorials/developer-journey/level-1/index.md): In the next stage of the developer journey, become a space cadet by getting comfortable creating your first dapp, managing your canisters, and acquiring and using cycles.

- [Pulling canister dependencies](/docs/current/developer-docs/setup/pulling-canister-dependencies.md): Learn how to use the new `dfx deps` feature to pull third-party canister dependencies. 

- [Sharing links to dapps](/docs/current/developer-docs/production/social-sharing.md): Want to learn the best way to share your dapp with others? Check out this documentation to find out. 

- [Service Nervous System (SNS) documentation](/docs/current/developer-docs/integrations/sns/index.md): Over the past few months, our documentation on SNSs has been greatly expanded. New docs include a pre-flight checklist, guidelines on integrating with the ledger and index canisters, and guides for testing your SNS before deploying it. 
