...
- [Pulling canister dependencies](/docs/current/building-apps/creating-dapps/using-third-party-canisters): Learn how to use the new `dfx deps` feature to pull third-party canister dependencies.

- [Service Nervous System (SNS) documentation](/docs/current/building-apps/governing-dapps/): Over the past few months, our documentation on SNSes has been greatly expanded. New docs include a pre-flight checklist, guidelines on integrating with the ledger and index canisters, and guides for testing your SNS before deploying it.
