...
- [Developer Liftoff level 0](/tutorials/developer-liftoff/level-0/): Start the Developer Liftoff at the very beginning by following the level 0 module. In level 0, we cover the fundamentals of what the Internet Computer is, what terms you should be familiar with, and what tools we'll be using throughout our journey.

- [Developer Liftoff level 1](/tutorials/developer-liftoff/level-1/): In the next stage of the Developer Liftoff, become a space cadet by getting comfortable creating your first dapp, managing your canisters, and acquiring and using cycles.

- [Pulling canister dependencies](/building-apps/advanced/using-third-party-canisters): Learn how to use the new `dfx deps` feature to pull third-party canister dependencies.

- [Service Nervous System (SNS) documentation](https://learn.internetcomputer.org/hc/en-us/articles/34084394684564-SNS-Service-Nervous-System): Over the past few months, our documentation on SNSes has been greatly expanded. New docs include a pre-flight checklist, guidelines on integrating with the ledger and index canisters, and guides for testing your SNS before deploying it.
