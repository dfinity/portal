...
- [Developer journey level 0](/docs/current/tutorials/developer-journey/level-0/index): Start your developer journey at the very beginning by following the level 0 module. In level 0, we cover the fundamentals of what the Internet Computer is, what terms you should be familiar with, and what tools we'll be using throughout our journey. 

- [Developer journey level 1](/docs/current/tutorials/developer-journey/level-1/index): In the next stage of the developer journey, become a space cadet by getting comfortable creating your first dapp, managing your canisters, and acquiring and using cycles.
