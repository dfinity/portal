...
description: In this issue, we're excited to announce a new developer video series, developer workshop, along with providing some information about the upcoming proposal that would enable the 1-proposal SNS feature, plus how to enter the Internet Computer Devpost hackathon.
tags: [Devs]
...
Hello developers and welcome to this week's developer weekly update! In this issue, we're excited to announce a new developer video series, Developer Workshop, along with providing some information about the upcoming proposal that would enable the 1-proposal SNS feature, plus how to enter the Internet Computer Devpost hackathon. Let's dive in! 

## Internet Computer developer workshop series

Today we're excited to introduce a new, on-going video series called developer workshop! In the first video of this series, David Dal Busco who is a software engineer at DFINITY, showcases how to build an Internet Computer dapp using Juno. This workshop teaches developers how to implement authentication into their dapp, save images and other data on-chain, and then launch their first smart contract onto the IC without needing to write a single line of backend code! 
