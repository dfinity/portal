...
description: In this week's update, we talk about ICP's third anniversary celebration, several new documentation pages on using the Rosetta 2.0 implementation, and we check out the latest developer ladder video.
tags: [Devs]
...
## Developer ladder 3.4: Introduction to agents

In the latest episode of the ICP developer ladder series, developers learn about what an agent is and how it can be used within their project. This video covers:
