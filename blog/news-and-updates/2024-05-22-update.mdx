...
description: In this week's update, we talk about ICP's third anniversary celebration, several new documentation pages on using the Rosetta 2.0 implementation, and we check out the latest Developer Journey video.
tags: [Devs]
...
The new [ICP Rosetta implementation](https://internetcomputer.org/docs/current/developer-docs/defi/rosetta/icp_rosetta/) offers two APIs: the Data API and the Construction API for interacting with ICP tokens.

The ICP [Rosetta Data API](https://internetcomputer.org/docs/current/developer-docs/defi/rosetta/icp_rosetta/data_api/) can be used to:
...
The [ICP Rosetta Construction API](https://internetcomputer.org/docs/current/developer-docs/defi/rosetta/icp_rosetta/construction_api/) can be used to:
...
The [ICRC Rosetta implementation](https://internetcomputer.org/docs/current/developer-docs/defi/rosetta/icrc_rosetta/) also offers similar APIs for interacting with ICRC tokens instead of ICP tokens. The APIs have the same names, Data and Construction, but have different endpoints and capabilities.
...
Check out the ICP [developer docs](https://internetcomputer.org/docs/current/developer-docs/defi/rosetta/icp_rosetta/) for more info!

## Developer journey 3.4: Introduction to agents

In the latest episode of the ICP developer journey series, developers learn about what an agent is and how it can be used within their project. This video covers:
...
Check out the [video tutorial on Youtube](https://www.youtube.com/watch?v=8Z_w_JQkxfk) or follow the written tutorial on the [developer docs](/docs/current/tutorials/developer-journey/level-3/3.4-intro-to-agents).
