...
<head>
  <meta property="og:image" content={require('blog/_assets/candlestick.png').default}/>
  <meta property="twitter:image" content={require('blog/_assets/candlestick.png').default}/>
</head>
...
![Header image](blog/_assets/candlestick.png)
...
## ic0
![Header image](blog/_assets/balloons.png)
