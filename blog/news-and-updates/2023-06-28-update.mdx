...
- A new [resource limits and constraints documentation](/building-apps/canister-management/resource-limits) page that details ICP’s resource constraints and limits for things such as canister queue limit, instruction limit query calls, Wasm stable memory, and subnet capacity.
- New [SNS documentation](https://learn.internetcomputer.org/hc/en-us/articles/34084394684564-SNS-Service-Nervous-System), which includes updated instructions for developing, testing, and launching an SNS, including a page dedicated to [SNS asset canisters](/building-apps/governing-apps/managing/sns-asset-canister) and a new [SNS launch checklist](/building-apps/governing-apps/tokenomics/sns-checklist).
