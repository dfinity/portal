...
- New [SNS documentation](https://learn.internetcomputer.org/hc/en-us/articles/34084394684564-SNS-Service-Nervous-System), which includes updated instructions for developing, testing, and launching an SNS, including a page dedicated to [SNS asset canisters](/docs/building-apps/governing-apps/managing/sns-asset-canister) and a new [SNS launch checklist](/docs/building-apps/governing-apps/tokenomics/sns-checklist).
