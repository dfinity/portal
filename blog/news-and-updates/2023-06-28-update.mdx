...
- New HTTPS outcalls tutorials, such as:
    ...
    - [How to use HTTPS outcalls: Intro:](https://internetcomputer.org/docs/current/building-dapps/using-network-features/using-http/https-outcalls/overview) this page provides a high-level overview of the API used to send HTTPS outcalls.
...
- A new [resource limits and constraints documentation](https://internetcomputer.org/docs/current/building-dapps/creating-dapps/resource-limits) page that details ICP’s resource constraints and limits for things such as canister queue limit, instruction limit query calls, Wasm stable memory, and subnet capacity.
