...
Last week, a [new post here](../features/deperecating-the-service-worker.md) on the Dev Blog announced a proposal to deprecate the Service Worker in favor of replacing it with the ICX Proxy hosted on the boundary nodes. The benefits of this proposal include:
