...
Ed25519 signatures are now available for production use on the mainnet! Ed25519 signatures have been enabled as part of the [threshold Schnorr API method](/docs/references/ic-interface-spec#ic-sign_with_schnorr), and allow ICP canisters to interact with other chains that use an Ed25519 algorithm, such as Solana, Cardano, and Polkadot.
