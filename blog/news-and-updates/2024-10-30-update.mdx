...
SNS proposal voting is critical for SNSs to apply important changes or add new features. Each SNS can define custom proposal types to fit the needs of their community. If some SNSs have hundreds of proposal types, it can be hard for SNS users to setup proposal following for each proposal type.
