...
- [ic-js](https://github.com/dfinity/ic-js?tab=readme-ov-file)

- [Hardware wallet CLI tool](/defi/overview)

- [Token integration](/defi/token-integrations/)

- [Ethereum dev workflow](/building-apps/chain-fusion/ethereum/using-eth/eth-dev-workflow)

- [Bitcoin dev workflow](/build-on-btc/btc-dev-workflow)
