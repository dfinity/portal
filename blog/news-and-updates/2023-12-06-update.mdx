...
- [5.2 Developing a dapp using the IC Ethereum integration](/tutorials/developer-liftoff/level-5/5.2-ICP-ETH-tutorial): In this tutorial, you'll use the DFINITY IC ETH starter project to deploy a boilerplate dapp that showcases how the IC can query information from the Ethereum network using HTTPS outcalls:
...
- [5.4 Creating NFTs on the IC](/tutorials/developer-liftoff/level-5/5.4-NFT-tutorial): A **non-fungible token**, commonly referred to as an NFT, is a type of tokenized asset that is assigned a unique identifier that is used to distinguish one NFT from another:
    - How do NFTs work?
    - NFT standards.
        - DIP721.
        - ICRC-7.
...
- [5.6 Next steps](/tutorials/developer-liftoff/level-5/5.6-next-steps): In this final tutorial, you'll learn about some of the different resources to help guide you further in your personal Developer Liftoff:
    - Developer grants.
    - Developer bounties.
    - Hackathons.
    - ICP.Hubs.
