...
- [How to use HTTP outcalls: Intro](https://internetcomputer.org/docs/current/developer-docs/web-apps/on-chain-backend/https-outcalls/https-outcalls-how-to-use): this page provides a high-level overview of the API used to send HTTP outcalls.
