...
Another new page of documentation added this week details ICP’s [resource constraints and limits](/docs/building-apps/canister-management/resource-limits) for things such as canister queue limit, instruction limit query calls, Wasm stable memory, and subnet capacity. Check out the full chart below:
...
You can read the full list [here](/docs/building-apps/canister-management/resource-limits).
