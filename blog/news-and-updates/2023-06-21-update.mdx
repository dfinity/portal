...
Another new page of documentation added this week details ICP’s [resource constraints and limits](https://internetcomputer.org/docs/current/building-dapps/managing-dapps/resource-limits) for things such as canister queue limit, instruction limit query calls, Wasm stable memory, and subnet capacity. Check out the full chart below:
...
You can read the full list [here](https://internetcomputer.org/docs/current/building-dapps/managing-dapps/resource-limits).
