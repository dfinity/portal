...
- Warnings regarding using an unencrypted identity on the mainnet can now be suppressed using the form:  can disable the warnings about using an unencrypted identity on mainnet
