...
description: This week, we're excited to talk about the upcoming 'Zero to Dapp' hackathon, introduce a new node metrics API, and the latest episode of the developer ladder video series!
tags: [Devs]
...
Hello developers and welcome back to developer weekly! This week, we're excited to talk about the upcoming 'Zero to Dapp' hackathon, introduce a new node metrics API, and the latest episode of the developer ladder video series! Let's get started.
...
## Developer ladder episode 1.1: Exploring a live demo

In this episode of the ICP developer ladder, developers will learn how to explore a live, deployed canister that utilizes the playground  through the `dfx deploy --playground` command to get a feel for deploying canisters on the IC before developing and deploying their own.

The documentation for this episode can be found [here](/docs/current/tutorials/developer-liftoff/level-1/1.1-live-demo), and you can watch the full video on the DFINITY YouTube channel [here](https://www.youtube.com/watch?v=-se6Se9z-aM).
