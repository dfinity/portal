...
*The boundary node team is in charge of the “edge” of the [Internet Computer](https://learn.internetcomputer.org/hc/en-us/articles/33152818663444-What-is-ICP). Any request going to the Internet Computer is handled by code and infrastructure we are responsible for. At the moment, our biggest project is the new boundary node architecture. This entails a complete revamp of the services making up the “edge” and is a big undertaking. Besides that, we maintain the custom domains service and provide insights through logs and metrics to other teams.*
