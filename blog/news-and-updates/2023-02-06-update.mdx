...
<head>
  <meta property="og:image" content={require('../_assets/motoko-sentinel.png').default}/>
  <meta property="twitter:image" content={require('../_assets/motoko-sentinel.png').default}/>
</head>
