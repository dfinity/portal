...
![Header image](blog/_assets/motoko-sentinel.png)

<head>
  <meta property="og:image" content={require('blog/_assets/motoko-sentinel.png').default}/>
  <meta property="twitter:image" content={require('blog/_assets/motoko-sentinel.png').default}/>
</head>
