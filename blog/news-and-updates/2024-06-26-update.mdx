...
- [Wallet overview](/docs/current/rosetta-defi/overview): Learn about types of asset wallets on ICP.

- [NFTs overview](/docs/current/rosetta-defi/overview): Learn about ICP's NFT standards, ICRC-7 and ICRC-37.

- [NFT collections](/docs/current/rosetta-defi/overview): A tutorial using ICRC-7 to deploy your own NFT collection.

- [NFT marketplaces](/docs/current/rosetta-defi/overview): A list of dapps on ICP that support buying and selling NFTs.
