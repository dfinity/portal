...
You can learn more in the [Motoko v0.11.0 migration guide](/docs/current/developer-docs/backend/motoko/0.11.0-migration-guide).

## Juno + OpenAI demo

This week, a new Juno demo has been shared on the forum! This demo showcases how to use Juno's serverless functions to query the OpenAI API by leveraging HTTP outcalls.
