...
Hey devs and welcome to this edition of the IC team spotlight! In this issue, we sat down with the SDK team to talk all things IC SDK and the upcoming Cycles Ledger feature! For most IC devs, the IC SDK is at the center of their workflow, so I'm sure many of you have been looking forward to this team spotlight! With that, let's dive into the interview. 
...
*The SDK team has seven members. The engineers on the SDK team are Eric Swanson, Linwei Shang, Kyle Peacock, Severin Siffert, Marcin Nowak-Liebiediew,  and Adam Spofford. The team also includes Jessie Mongeon, a technical writer, Thomas Locher, a visiting member from the research team, and Jason Ibrahim, the team’s engineering manager.*
...
**It sounds like the SDK is definitely designed to set up devs with everything they need to get started! How does the IC SDK fit into the IC’s stack? What layer does it primarily operate on?**
...
*SDK team code runs in every IC website, inside the service worker, in all the Rust canisters running on the IC, and in most Continuous Integration jobs. We depend on builds of the replica, new releases of the Motoko compiler, and any new updates to the internet computer specification.*
...
*We also occasionally work with other teams when there is a cross-functional initiative going on. One example was when we developed the Service Nervous System. We worked closely with the SNS team to ensure that the tooling we provided met all of the specifications.*
