...
description: In this issue, we sat down with the SDK team to talk all things IC SDK and the upcoming Cycles Ledger feature! For most IC devs, IC SDK is at the center of their workflow, so I'm sure many of you have been looking forward to this team spotlight!
tags: [Team spotlight]
image: /img/blog/dev-update-blog-SDK.jpg
---

Hey devs and welcome to this edition of ICP team spotlight! In this issue, we sat down with the SDK team to talk all things IC SDK and the upcoming Cycles Ledger feature! For most IC devs, IC SDK is at the center of their workflow, so I'm sure many of you have been looking forward to this team spotlight! With that, let's dive into the interview. 
...
**On a fundamental level, what is IC SDK? What are the components of it?**
...
**It sounds like the SDK is definitely designed to set up devs with everything they need to get started! How does IC SDK fit into ICP’s stack? What layer does it primarily operate on?**
...
**What is the process of creating a project using IC SDK?**

*Once IC SDK has been downloaded and installed, the process of creating a project is simple. You can use the `dfx new` command to guide you through the process of bootstrapping a new project. You can decide on the language you’d like to use, whether or not you’d like to incorporate a frontend (UI), and add a number of supported integrations using the `dfx deps` feature.**
...
**I'm sure that since IC SDK is such a fundamental part of the developer experience, the SDK team must interact with other teams quite frequently. How does the SDK team work with other teams?**
...
**What feature of IC SDK do developers benefit from the most? What features are solely quality of life features for developers?**
...
**What is one feature or aspect of IC SDK that the team is the most proud of?**
...
A huge thank you to the SDK team for chatting with us today and giving us some great insight into IC SDK! Be sure to tune in next time for another team spotlight post! 
