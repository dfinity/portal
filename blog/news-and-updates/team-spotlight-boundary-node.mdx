...
*For more details on the internals of a boundary nodes, take a look at [the Learn Hub page](https://learn.internetcomputer.org/hc/en-us/articles/34212818609684-ICP-Edge-Infrastructure).*
