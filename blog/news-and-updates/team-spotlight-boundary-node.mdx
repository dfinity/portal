...
*But maybe one thing we would like developers to be aware of is our custom domains feature, which allows developers to host their dapp under their own domain without the need for any additional infrastructure. For more information, you can check the respective [developer docs](/docs/current/developer-docs/web-apps/custom-domains/using-custom-domains).*
