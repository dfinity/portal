...
- [Decentralized exchange (DEX).](https://internetcomputer.org/docs/current/references/samples/motoko/defi/)
- [Deploying your first Bitcoin dapp.](https://internetcomputer.org/docs/current/samples/deploying-your-first-bitcoin-dapp)
- [Game of Life.](https://internetcomputer.org/docs/current/references/samples/motoko/life/)
