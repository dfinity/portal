...
New documentation pages have been created for each piece of sample code that exists in the `dfinity/examples` repository. For most of these examples, README documentation existed previously, but proper developer documentation pages didn’t. These new pages can be found [here](/docs/current/samples/overview), but some notable examples are:

- [Decentralized exchange (DEX).](/docs/current/samples/dex)
- [Deploying your first Bitcoin dapp.](/docs/current/samples/deploying-your-first-bitcoin-dapp)
- [Game of Life.](/docs/current/samples/game-of-life)
