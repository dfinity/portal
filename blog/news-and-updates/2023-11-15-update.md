...
- A breaking change where values of type `Principal` are now constrained to contain at most 29 bytes. This matches the IC's notion of a principal. In this change specifically:
