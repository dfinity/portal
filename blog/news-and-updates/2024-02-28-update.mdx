...
description: This week, we have a new episode of the developer ladder, a new benchmarking framework for canisters, and SNS ledger support for ICRC-2 tokens.
tags: [Devs]
...
Hello developers, and welcome to this week's developer weekly update! This week, we have a new episode of the developer ladder, a new benchmarking framework for canisters, and SNS ledger support for ICRC-2 tokens. Let's dive in!

## Developer ladder episode 2.1: Canister upgrades, storage, and persistence

Catch up on the latest episode of the ICP developer ladder tutorial series! In this episode, "2.1: Canister upgrades, storage, and persistence", you'll learn about:
