...
**To kick off the series, we sat down with Linwei, a software engineer from the SDK team. The SDK team has a fundamental role at DFINITY, as they create tooling such as `dfx` that developers use on a regular basis.**
