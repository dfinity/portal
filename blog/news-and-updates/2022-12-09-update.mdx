...
![Motoko](blog/_assets/motoko-1.png)

<head>
  <meta property="og:image" content={require('blog/_assets/motoko-1.png').default}/>
  <meta property="twitter:image" content={require('blog/_assets/motoko-1.png').default}/>
</head>
...
![Async / Await](blog/_assets/asyncawait.png)
