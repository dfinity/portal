...
This canister validates the authentication payload as an identity provider and generates a delegate identity for the user. This works in the same way that Internet Identity does. 
...
Sign-ups are open until April 8th and anyone can participate. There is over $70,000 of ICP in prizes available to participates!
