...
- [Candid tools](/docs/current/building-dapps/calling-dapps/candid/candid-tools): Learn about how to use `didc`, Candid UI, and `ip-repl`.
...
- [Learn how to use GitHub codespaces to deploy canisters](/docs/current/building-dapps/developer-tools/ide/icp-ninja).
