...
- [Candid tools](/docs/current/building-apps/calling-dapps/candid/candid-tools): Learn about how to use `didc`, Candid UI, and `ip-repl`.

- [CanBench](/docs/current/building-apps/developer-tools/canbench): Learn how to benchmark your canister's memory and instruction usage using the `canbench` crate.

- Want to take a deep dive into the ETH integration? Check out these new pages on the EVM RPC Canister:

    - [Overview](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/overview): Learn what the EVM RPC canister is and what purpose it serves for ETH development on ICP.

    - [How it works](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/how-it-works): Learn how the EVM RPC canister works.

    - [Costs](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/costs): View cost information associated with using the EVM RPC canister.

    - [Sample projects](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/samples): Get inspired by viewing some projects using the EVM RPC canister.

- [Learn how to use GitHub codespaces to deploy canisters](/docs/current/building-apps/developer-tools/ide/icp-ninja).

- [Learn how to use developer containers](/docs/current/building-apps/developer-tools/ide/dev-containers).
