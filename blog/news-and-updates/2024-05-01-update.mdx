...
- [CanBench](/docs/building-apps/developer-tools/canbench): Learn how to benchmark your canister's memory and instruction usage using the `canbench` crate.
...
- Want to take a deep dive into the ETH integration? Check out these new pages on the EVM RPC Canister:
    ...
    - [Sample projects](/docs/building-apps/chain-fusion/ethereum/evm-rpc/samples): Get inspired by viewing some projects using the EVM RPC canister.

- [Learn how to use GitHub codespaces to deploy canisters](/docs/building-apps/developer-tools/ide/icp-ninja).

- [Learn how to use developer containers](/docs/building-apps/developer-tools/ide/dev-containers).
