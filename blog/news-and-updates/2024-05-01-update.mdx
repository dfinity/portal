...
- [Candid tools](/building-apps/interact-with-canisters/candid/candid-tools): Learn about how to use `didc`, Candid UI, and `ip-repl`.

- [CanBench](/building-apps/advanced/benchmarking): Learn how to benchmark your canister's memory and instruction usage using the `canbench` crate.

- Want to take a deep dive into the ETH integration? Check out these new pages on the EVM RPC Canister:

    - [Overview](/building-apps/chain-fusion/ethereum/evm-rpc/overview): Learn what the EVM RPC canister is and what purpose it serves for ETH development on ICP.

    - [How it works](/building-apps/chain-fusion/ethereum/evm-rpc/how-it-works): Learn how the EVM RPC canister works.

    - [Costs](/building-apps/chain-fusion/ethereum/evm-rpc/costs): View cost information associated with using the EVM RPC canister.

    - [Sample projects](/building-apps/chain-fusion/ethereum/evm-rpc/evm-rpc-canister): Get inspired by viewing some projects using the EVM RPC canister.

- [Learn how to use GitHub codespaces to deploy canisters](/building-apps/developer-tools/icp-ninja).

- [Learn how to use developer containers](/building-apps/developer-tools/icp-ninja).
