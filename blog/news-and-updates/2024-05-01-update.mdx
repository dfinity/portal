...
description: In this week's update, we have several new developer docs pages to share, a new blog post on extending HTTP outcalls, and an update on the dfx dashboard GUI project.
tags: [Devs]
