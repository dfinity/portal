...
You can learn more about the [EVM RPC canister in the documentation](https://internetcomputer.org/docs/current/building-dapps/chain-fusion/ethereum/evm-rpc/evm-rpc-canister), including how to use it in your project!
