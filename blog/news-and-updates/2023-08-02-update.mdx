...
**Description:** In the BTC on ICP working group, the goal is to work together as an ecosystem to improve the Bitcoin experience on the [Internet Computer](https://learn.internetcomputer.org/hc/en-us/articles/33152818663444-What-is-ICP). To accomplish this, the group will work closely with the Ordinals and Bitcoin ecosystems, work on building decentralized Bitcoin solutions within the application layer of the ICP, and work with the protocol layer to support different Bitcoin use cases.
