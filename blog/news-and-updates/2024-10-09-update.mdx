...
- [Smart contract testing overview](/docs/current/building-apps/creating-dapps/test/overview)

- [Canpack developer tool](/docs/current/building-apps/developer-tools/canpack)
...
- [ICP dashboard APIs](/docs/current/specifications/dashboard-apis)

- [Cycles pricing calculator](/docs/current/concepts/cost-estimations-and-examples)

Check out all of the [ICP developer documentation](/docs/current/concepts/network-overview).
