...
- [2.2: Advanced canister calls.](/docs/tutorials/developer-liftoff/level-2/2.2-advanced-canister-calls): Now that we've covered the core functionalities of canisters and using them, let's take a look at advanced canister calls. This module covers:
...
Want to start at the beginning? You can get started with the Developer Liftoff [here](/docs/tutorials/developer-liftoff/).
...
- [Independently verifying Internet Computer signatures](/docs/building-apps/authentication/independently-verifying-ic-signatures).
