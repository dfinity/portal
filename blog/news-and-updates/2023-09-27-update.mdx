...
Hello IC developers and welcome to this edition of developer weekly! This week, we're going to talk all things new documentation, including level 2 of the developer journey series, plus the new workflow for requesting a cycles coupon. Let's get into it!
...
- [2.1: Canister upgrades, storage, and persistence.](/docs/tutorials/developer-journey/level-2/2.1-storage-persistence.md): When a canister's code needs to have changes made, the canister must be upgraded. This module covers:
...
- [2.2: Advanced canister calls.](/docs/tutorials/developer-journey/level-2/2.2-advanced-canister-calls.md): Now that we've covered the core functionalities of canisters and using them, let's take a look at advanced canister calls. This module covers:
...
- [2.3: Using third-party canisters.](/docs/tutorials/developer-journey/level-2/2.3-third-party-canisters.md): For certain workflows, using third-party canisters and integrating them with a dapp is important to provide functionalities such as authentication. This module covers:
    - Pulling third-party canister dependencies.
	    - Prerequisites.
	    - Creating a new project.
	    - Using `dfx deps`.

- [2.4: Introduction to Candid.](/docs/tutorials/developer-journey/level-2/2.4-intro-candid.md): Candid is an interface description language that has unique support for IC features. This module covers:
...
- [2.5: Unit, integration, and end2end testing](/docs/tutorials/developer-journey/level-2/2.5-unit-testing.md): Testing code prior to setting it live in production is an important step in the development process. This module covers:
    - Motoko unit testing.
...
- [2.6: Motoko: level 2.](/docs/tutorials/developer-journey/level-2/2.6-motoko-lvl2.md): This module covers:
    - Actor types.
...
Want to start at the beginning? You can get started with your developer journey [here](/docs/tutorials/developer-journey/index.md).
...
Want to check out the updated instructions? Read the documentation [here](/docs/developer-docs/setup/cycles/cycles-faucet.md).
...
- [ICRC-1 ledger setup](https://internetcomputer.org/docs/current/developer-docs/integrations/icrc-1/icrc1-ledger-setup).

- [ICRC-1 index local setup](https://internetcomputer.org/docs/current/developer-docs/integrations/icrc-1/icrc1-index-setup).
...
Have a request for some documentation? Let us know on the developer [forum](https://forum.dfinity.org/) or on our [Discord community](https://discord.gg/jnjVVQaE2C). 
