...
Want to check out the updated instructions? Read the documentation [here](/docs/current/building-apps/getting-started/tokens-and-cycles).
...
- [Independently verifying Internet Computer signatures](/docs/current/building-apps/using-network-features/signatures/independently-verifying-ic-signatures).

- [ICRC-1 ledger setup](/docs/current/defi/token-ledgers/setup/icrc1_ledger_setup).

- [ICRC-1 index local setup](/docs/current/defi/token-indexes/).

- [Generating Candid files for Rust canisters](/docs/current/building-apps/developer-tools/cdks/rust/generating-candid).
