...
Want to check out the updated instructions? Read the documentation [here](/docs/current/building-dapps/getting-started/tokens-and-cycles).
...
- [Independently verifying Internet Computer signatures](/docs/current/building-dapps/using-network-features/signatures/independently-verifying-ic-signatures).
...
- [Generating Candid files for Rust canisters](/docs/current/building-dapps/developer-tools/cdks/rust/generating-candid).
