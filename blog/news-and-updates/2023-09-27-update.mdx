...
- [2.1: Canister upgrades, storage, and persistence.](/docs/current/tutorials/developer-journey/level-2/2.1-storage-persistence.md): When a canister's code needs to have changes made, the canister must be upgraded. This module covers:
...
- [2.2: Advanced canister calls.](/docs/current/tutorials/developer-journey/level-2/2.2-advanced-canister-calls.md): Now that we've covered the core functionalities of canisters and using them, let's take a look at advanced canister calls. This module covers:
...
- [2.3: Using third-party canisters.](/docs/current/tutorials/developer-journey/level-2/2.3-third-party-canisters.md): For certain workflows, using third-party canisters and integrating them with a dapp is important to provide functionalities such as authentication. This module covers:
    - Pulling third-party canister dependencies.
	    - Prerequisites.
	    - Creating a new project.
	    - Using `dfx deps`.

- [2.4: Introduction to Candid.](/docs/current/tutorials/developer-journey/level-2/2.4-intro-candid.md): Candid is an interface description language that has unique support for IC features. This module covers:
...
- [2.5: Unit, integration, and end2end testing](/docs/current/tutorials/developer-journey/level-2/2.5-unit-testing.md): Testing code prior to setting it live in production is an important step in the development process. This module covers:
    - Motoko unit testing.
...
- [2.6: Motoko: level 2.](/docs/current/tutorials/developer-journey/level-2/2.6-motoko-lvl2.md): This module covers:
    - Actor types.
...
Want to start at the beginning? You can get started with your developer journey [here](/docs/current/tutorials/developer-journey/index.md).
...
Want to check out the updated instructions? Read the documentation [here](/docs/current/developer-docs/setup/cycles/cycles-faucet.md).
...
- [Independently verifying Internet Computer signatures](/docs/current/developer-docs/integrations/independently-verifying-ic-signatures).
