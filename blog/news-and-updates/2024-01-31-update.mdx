...
- [PocketIC](/docs/current/developer-docs/smart-contracts/test/pocket-ic) for unit testing, allowing you to simulate deployment on the mainnet for an enhanced developer workflow.
...
- [Hello, world! Getting started guide](/docs/current/building-dapps/getting-started/write-smart-contracts).

- [Creating a developer account](/docs/current/building-dapps/getting-started/identities).
