...
- [PocketIC](/docs/building-apps/advanced/test/pocket-ic) for unit testing, allowing you to simulate deployment on the mainnet for an enhanced developer workflow.
...
- [Hello, world! Getting started guide](/docs/building-apps/developing-canisters/write).

- [Creating a developer account](/docs/building-apps/getting-started/identities).
