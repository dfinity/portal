...
- [PocketIC](/docs/current/building-dapps/launching-a-dapp/test/pocket-ic) for unit testing, allowing you to simulate deployment on the mainnet for an enhanced developer workflow.
...
- [Hello, world! Getting started guide](/docs/current/building-dapps/getting-started/write-canister-code).
