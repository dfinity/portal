...
- [PocketIC](/docs/current/building-apps/creating-dapps/test/pocket-ic) for unit testing, allowing you to simulate deployment on the mainnet for an enhanced developer workflow.
...
- [Hello, world! Getting started guide](/docs/current/building-apps/getting-started/write-canister-code).

- [Creating a developer account](/docs/current/building-apps/getting-started/identities).
