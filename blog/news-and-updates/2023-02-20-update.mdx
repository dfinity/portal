...
![Header image](blog/_assets/motoko-3.png)

<head>
  <meta property="og:image" content={require('blog/_assets/motoko-3.png').default}/>
  <meta property="twitter:image" content={require('blog/_assets/motoko-3.png').default}/>
</head>
...
![Header image](blog/_assets/garbage-truck.png)
...
![Header image](blog/_assets/looneytunes.png)
