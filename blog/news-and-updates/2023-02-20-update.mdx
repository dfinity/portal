---
title: Motoko Biweekly Update Part 7
...
<head>
  <meta property="og:image" content={require('../_assets/motoko-3.png').default} />
  <meta property="twitter:image" content={require('../_assets/motoko-3.png').default} />
</head>
