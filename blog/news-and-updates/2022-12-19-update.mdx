...
![DFINITY](blog/_assets/astronaut.png)

<head>
  <meta property="og:image" content={require('../_assets/astronaut.png').default}/>
  <meta property="twitter:image" content={require('../_assets/astronaut.png').default}/>
</head>
...
![Header image](blog/_assets/medium.png)
...
![Header image](blog/_assets/react-native.png)
...
![Header image](blog/_assets/github-prs.png)
...
## App of the week: Fig
![Header image](blog/_assets/fig.png)
