---
title: Motoko Biweekly Update Part 9
...
<head>
  <meta property="og:image" content={require('../_assets/motoko-logo-white.webp').default}/>
  <meta property="twitter:image" content={require('../_assets/motoko-logo-white.webp').default}/>
</head>
