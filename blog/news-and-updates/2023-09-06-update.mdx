...
- [1.1: Exploring a live demo](/tutorials/developer-liftoff/level-1/1.1-motoko-lvl1):
...
- [1.2: Motoko level 1](/tutorials/developer-liftoff/level-1/1.2-dev-env):
...
- [1.3: Developing your first dapp](/tutorials/developer-liftoff/level-1/1.3-intro-dfx):
...
- [1.4: Acquiring and using cycles](/tutorials/developer-liftoff/level-1/1.4-using-cycles):
...
- [1.5: Deploying canisters](/tutorials/developer-liftoff/level-1/1.5-deploying-canisters):

In this module, you can learn about deploying to the mainnet.

- [1.6: Managing canisters](/tutorials/developer-liftoff/level-1/1.6-managing-canisters):
...
You can learn more about the Developer Liftoff and get started with level 0 in the [tutorials section of our developer documentation](/tutorials/developer-liftoff/).
