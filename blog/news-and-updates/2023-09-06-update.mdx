...
- [1.1: Exploring a live demo](/docs/tutorials/developer-journey/level-1/1.1-live-demo.md):
...
- [1.2: Motoko level 1](/docs/tutorials/developer-journey/level-1/1.2-motoko-lvl1.md):
...
- [1.3: Developing your first dapp](/docs/tutorials/developer-journey/level-1/1.3-first-dapp.md): 
...
- [1.4: Acquiring and using cycles](/docs/tutorials/developer-journey/level-1/1.4-using-cycles.md):
...
- [1.5: Deploying canisters](/docs/tutorials/developer-journey/level-1/1.5-deploying-canisters.md): 

In this module, you can learn about deploying to the mainnet.

- [1.6: Managing canisters](/docs/tutorials/developer-journey/level-1/1.6-managing-canisters.md): 
...
You can learn more about the developer journey and get started with level 0 in the [tutorials section of our developer documentation](/docs/tutorials/developer-journey/index/md).
