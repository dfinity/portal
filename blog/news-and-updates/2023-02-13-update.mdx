...
<head>
  <meta property="og:image" content={require('blog/_assets/quill.png').default}/>
  <meta property="twitter:image" content={require('blog/_assets/quill.png').default}/>
</head>
...
![Header image](blog/_assets/quill.png)
...
![Header image](blog/_assets/broken-car.png)
...
![Header image](blog/_assets/chatgpt.png)
