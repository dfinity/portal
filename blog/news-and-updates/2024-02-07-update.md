...
You can learn more about the [EVM RPC canister in the documentation](https://internetcomputer.org/docs/current/developer-docs/integrations/ethereum/evm-rpc), including how to use it in your project!
