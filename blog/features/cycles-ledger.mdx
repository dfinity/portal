...
A huge thank you to the cycles ledger team for sitting down and giving us the inside scoop on this exciting project! We're looking forward to hearing what the community thinks about the cycles ledger on our [developer forum](https://forum.dfinity.org/) and on [Discord](httphttps://discord.internetcomputer.orgorg).
