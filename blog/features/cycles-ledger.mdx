...
*Since the cycles ledger complies with the IRCR-1, ICRC-2, and ICRC-3 standards, the cycles ledger can also be easily integrated into dapps, for example in the DeFi space.*
