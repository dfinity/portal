...
The `dfx deps` feature is available in dfx versions `0.14.1` and newer. You can learn more from our [developer documentation](/docs/current/building-dapps/creating-dapps/using-third-party-canisters), which includes an interactive example you can use to test the feature for yourself.
