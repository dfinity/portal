...
How important is trust / security to my users?
...
<!-- prettier-ignore-start -->
:::info
In the coming months, more tooling and improvements to the EVM RPC Canister are expected to land that will make it much easier to process raw Ethereum RPC data.
:::
<!-- prettier-ignore-end -->
