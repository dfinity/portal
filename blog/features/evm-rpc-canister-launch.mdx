...
<div className={"flex flex-row gap-2"}>
  ...
  <a
    ...
    href={"https://internetcomputer.org/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/evm-rpc-canister"}
  >
...
:::info
Please ensure you [install](/docs/current/building-apps/getting-started/install) `dfx` before proceeding with the steps below.
:::
<!-- prettier-ignore-end -->
