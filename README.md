...
The Developer Portal brings together all the resources needed for developers to build on the
Internet Computer.
...
2. a Pull Request is created from this branch to `master`. the preview is generated and the reviewers can directly check
   the preview website.
