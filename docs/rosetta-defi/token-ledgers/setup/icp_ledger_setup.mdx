...
If you want to deploy your own token, read the [guide on setting up an ICRC-1 ledger](/docs/current/rosetta-defi/tokens/ledger/setup/icrc1_ledger_setup).
:::
