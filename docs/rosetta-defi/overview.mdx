...
See the documentation on [how to interact with the ICP ledger for more info](/docs/current/rosetta-defi/tokens/ledger/usage/icp_ledger_usage).
...
See the documentation on [how to interact with the ICRC ledger for more info](/docs/current/rosetta-defi/tokens/ledger/setup/icrc1_ledger_setup).
...
- [Receiving ICP tokens as governance rewards](/docs/current/developer-docs/daos/nns/concepts/neurons/staking-voting-rewards/).
