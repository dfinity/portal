...
- Make sure to use the correct [`NetworkIdentifier`](/docs/rosetta-defi/rosetta/icrc_rosetta/data_api/network.mdx). For this example the following arbitrary `BlockIdentifier` is used:
```bash
"block_identifier": {
        "index": 1357691,
