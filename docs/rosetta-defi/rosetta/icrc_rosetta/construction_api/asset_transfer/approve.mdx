...
This section will show you how to use the ICRC Rosetta implementation to authorize a spender to spend your ICRC-1 tokens. Make sure you are familiar with the [flow of operations](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/index.mdx) for Rosetta.
...
### Prerequisites
- Make sure you are familiar with the [flow of operations](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/index.mdx) for Rosetta.
