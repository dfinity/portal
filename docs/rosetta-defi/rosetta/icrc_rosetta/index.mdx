...
This documentation covers the endpoints of the [Data-API](/docs/rosetta-defi/rosetta/icrc_rosetta/data_api/index.mdx) and the [Construction-API](/docs/rosetta-defi/rosetta/icrc_rosetta/construction_api/index.mdx).
