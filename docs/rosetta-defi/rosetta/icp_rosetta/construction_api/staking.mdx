...
The command has two forms: one form accepts an [ICP principal](/references/ic-interface-spec.md#principal) as a hotkey, and another form accepts a [public key](https://www.rosetta-api.org/docs/models/PublicKey.html).
