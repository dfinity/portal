...
After that, you can fetch the [neuron info](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/staking/neuron_info.mdx) and it should display that it is now in `DISSOLVING` state.
```json
{
