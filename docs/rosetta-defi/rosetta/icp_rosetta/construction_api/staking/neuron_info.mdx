...
There are a few variations to this that depend on whether you are the controller of the neuron or whether you are using a [hotkey](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/staking/hotkeys.mdx).
