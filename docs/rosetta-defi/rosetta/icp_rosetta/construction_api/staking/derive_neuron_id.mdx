...
To derive the account identifier of your public key you can look at how the [derive endpoint works](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/derive.mdx).
...
However, the governance canister must be notified of this transfer to activate the neuron. This process is done in the [next step of the guide](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/staking/stake_icp.mdx).
