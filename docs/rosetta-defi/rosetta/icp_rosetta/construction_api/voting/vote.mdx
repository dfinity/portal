...
First you will need to know which proposals currenty exist on the NNS. You can read up on how to do this [here](/docs/rosetta-defi/rosetta/icp_rosetta/data_api/get_pending_proposals.mdx).
