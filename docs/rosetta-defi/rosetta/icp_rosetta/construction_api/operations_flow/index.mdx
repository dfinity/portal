...
- [construction/derive](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/derive.mdx): Derive an `accountIdentifier` from your public key.
- [construction/preprocess](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/preprocess.mdx): Fetch transaction specific parameters to call the `construction/metadata` endpoint with.
- [construction/metadata](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/metadata.mdx): Fetch transaction specific metadata from the ICP ledger.
- [construction/payloads](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/payloads.mdx): Fetch signable payloads for the requested set of operations.
- [construction/combine](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/combine.mdx): Combine signatures and an unsigned transaction into a signed transaction.
- [construction/submit](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations_flow/submit.mdx): Send signed transactions to the ICP Ledger canister.