...
- [construction/combine](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations-flow): Combine signatures and an unsigned transaction into a signed transaction.
- [construction/derive](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations-flow): Derive an `accountIdentifier` from your public key.
- [construction/metadata](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations-flow): Fetch transaction specific metadata from the ICP ledger.
- [construction/payloads](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations-flow): Fetch signable payloads for the requested set of operations.
- [construction/preprocess](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations-flow): Fetch transaction specific parameters to call the `construction/metadata` endpoint with.
- [construction/submit](/docs/rosetta-defi/rosetta/icp_rosetta/construction_api/operations-flow): Send signed transactions to the ICP Ledger canister.
