...
    - `memo`: See the [section](/docs/current/rosetta-defi/token-standards/index) for `memo` for the ICP ledger.
    - `created_at_time`: See the [section](/docs/current/rosetta-defi/token-standards/index) for `created_at_time` for the ICP ledger.
