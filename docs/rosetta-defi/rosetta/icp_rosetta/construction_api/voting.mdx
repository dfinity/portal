...
You can get a [list](/docs/rosetta-defi/rosetta/icp_rosetta/data_api/list_known_neurons.mdx) of publicly known neurons through the `DATA-API`.
...
First you will need to know which proposals currently exist on the NNS. You can read up on how to do this [here](/docs/rosetta-defi/rosetta/icp_rosetta/data_api/get_pending_proposals.mdx).
If you already know the proposal id you want to vote on you can also [fetch](/docs/rosetta-defi/rosetta/icp_rosetta/data_api/get_proposal_info.mdx) the information about the proposal to check that what your are voting on is what you expected.
