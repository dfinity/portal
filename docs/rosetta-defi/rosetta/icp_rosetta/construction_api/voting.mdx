...
If you already know the proposal ID you want to vote on, you can also [fetch](/docs/current/rosetta-defi/rosetta/icp_rosetta/data_api/get_proposal_info) the information about the proposal to check that what you are voting on is what you expected.
