...
You can get a [list](/docs/current/rosetta-defi/rosetta/icp_rosetta/data_api/) of publicly known neurons through the `DATA-API`.
...
First you will need to know which proposals currently exist on the NNS. You can read up on how to do this [here](/docs/current/rosetta-defi/rosetta/icp_rosetta/data_api/).
If you already know the proposal ID you want to vote on, you can also [fetch](/docs/current/rosetta-defi/rosetta/icp_rosetta/data_api/) the information about the proposal to check that what you are voting on is what you expected.
