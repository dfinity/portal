...
Your token has been created locally. To interact with your token, [learn how to interact with the ICRC-1 ledger](/docs/current/rosetta-defi/token-indexes/).
...
- [ICRC-1 indexes](/docs/current/rosetta-defi/token-indexes/).
