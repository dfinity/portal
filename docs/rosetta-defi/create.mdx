...
To create a new ICRC-1 token, you will need to first download and configure a local project for the ICRC-1 <GlossaryTooltip>ledger</GlossaryTooltip> <GlossaryTooltip>canister</GlossaryTooltip>. This is because each token will need its own ledger canister to record the token's balances and transactions. [Follow the ICRC-1 ledger documentation for instructions](/docs/current/rosetta-defi/token-ledgers/setup/icrc1_ledger_setup).
...
The [controller <GlossaryTooltip>principal</GlossaryTooltip>](/docs/current/rosetta-defi/cycles/cycles-wallet#controller-and-custodian-roles) of the archive canisters.
...
Alternatively, you can pass these init arguments to the canister through the command line. [Learn more about canister init arguments](/docs/current/building-dapps/developer-tools/advanced-dfx/init-args).
...
For additional details, you can learn more in the [ICRC-1 ledger documentation](/docs/current/rosetta-defi/token-ledgers/setup/icrc1_ledger_setup).

Your token has been created locally. To interact with your token, [learn how to interact with the ICRC-1 ledger](/docs/current/rosetta-defi/tokens/indexes).
...
[Learn how to interact with the ICRC-1 ledger](/docs/current/rosetta-defi/token-ledgers/usage/icrc1_ledger_usage)

## Resources

- [ICRC-1 ledger documentation](/docs/current/rosetta-defi/token-ledgers/setup/icrc1_ledger_setup).

- [ICRC-1 indexes](/docs/current/rosetta-defi/tokens/indexes).
