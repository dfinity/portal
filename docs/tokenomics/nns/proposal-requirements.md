...
* **Parameters:** The parameters that will be passed to the system function that will be invoked if the proposal is adopted, as determined by its type.
...
* **Balance**: The quantity of ICP assigned to the principal of the account.
