...
-   Deploy compiled programs as [canisters](/docs/current/concepts/glossary#c).
...
If you have questions that aren’t answered by the community, you might also want to check out [Troubleshooting](/docs/current/building-apps/getting-started/troubleshooting) topics for information about common issues, workarounds for known issues, or help troubleshooting warnings or errors.
