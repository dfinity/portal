...
-   Deploy compiled programs as [canisters](/references/glossary#c).
...
If you have questions that aren’t answered by the community, you might also want to check out [Troubleshooting](/building-apps/getting-started/troubleshooting) topics for information about common issues, workarounds for known issues, or help troubleshooting warnings or errors.
