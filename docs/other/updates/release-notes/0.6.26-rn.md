...
The most significant new feature included in this release is the publication of the [*Internet Computer Interface Specification*](/docs/current/specifications/ic-interface-spec).
