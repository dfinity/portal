...
-   New [Candid documentation](/docs/current/building-dapps/interacting-with-dapps/candid/candid-concepts) for
...
-   Motoko supports wrapping arithmetic and bit-wise operations on
    ...
    types](/docs/current/motoko/main/reference/language-manual).
