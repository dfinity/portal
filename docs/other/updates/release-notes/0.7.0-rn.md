...
-   Addition of wallet subcommands
    ...
    -   `dfx wallet list-addresses` displays the assigned controllers & custodians of the cycles wallet.
        ...
        For more information on `dfx wallet` see [dfx wallet](/building-apps/developer-tools/dfx/dfx-wallet).
...
-   You can now install the [IC SDK](/building-apps/getting-started/install) SDK on for M1 Macs running Darwin.
