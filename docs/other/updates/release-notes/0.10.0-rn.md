...
The local replica sets its parameters according to the [subnet type](/building-apps/developing-canisters/create#subnet-blockchains) defined in defaults.replica.subnet_type, defaulting to 'application' when none is specified.
...
Example how to specify the [subnet type](/building-apps/developing-canisters/create#subnet-blockchains):
```
{
  "defaults": {
    "replica": {
