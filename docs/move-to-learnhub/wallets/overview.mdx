...
The [NNS dapp](https://nns.ic0.app/) provides users the same functionality in addition to generating neurons to stake ICP and participate in governance. The Internet Identity integration is often referred to as the [NNS wallet](/docs/current/rosetta-defi/overview#nns-dapp).
