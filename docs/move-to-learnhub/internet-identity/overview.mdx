...
Check out [how to integrate Internet Identity into your dapp](/docs/current/building-dapps/using-network-features/authentication/integrate-internet-identity).

Check out [how to integrate Internet Identity on mobile devices](/docs/current/developer-education/security/iam#integrating-internet-identity-on-mobile-devices).
...
- [Internet Identity alternative frontend origins](/docs/current/building-dapps/using-network-features/authentication/alternative-origins).
- [Internet Identity integration](/docs/current/building-dapps/using-network-features/authentication/integrate-internet-identity).
