...
Check out [how to integrate Internet Identity into your dapp](/docs/building-apps/authentication/integrate-internet-identity).

Check out [how to integrate Internet Identity on mobile devices](/docs/building-apps/best-practices/security/iam#integrating-internet-identity-on-mobile-devices).
...
- [Internet Identity integration](/docs/building-apps/authentication/integrate-internet-identity).
