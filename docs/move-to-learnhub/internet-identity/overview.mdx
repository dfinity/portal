...
Check out [how to integrate Internet Identity into your dapp](/docs/current/building-dapps/authentication/integrate-internet-identity).
...
- [Internet Identity integration](/docs/current/building-dapps/authentication/integrate-internet-identity).
