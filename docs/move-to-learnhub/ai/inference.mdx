...
Check out the [image classification example](/ecosystem?tag=AI) to learn how it works.
...
Smart contracts running on ICP can make [HTTP requests through HTTP outcalls](/docs/building-apps/network-features/using-http/https-outcalls/overview) to Web2 services including OpenAI and Claude.
...
- [DeAI Coding Assistant](https://github.com/ICP-Hub-Kenya/DeAI/tree/main/rust-openai): A simple DeAI Coding assistant built on ICP (Tutorial example) [Try it here](https://github.com/ICP-Hub-Kenya/DeAI/tree/main/rust-openai#tutorial-building-deai-with-icp-http-outcalls).
