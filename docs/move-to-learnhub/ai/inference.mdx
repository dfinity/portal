...
Smart contracts running on ICP can make [HTTP requests through HTTP outcalls](/docs/current/building-apps/using-network-features/using-http/https-outcalls/overview) to Web2 services including OpenAI and Claude.
