...
Smart contracts running on ICP can make [HTTP requests through HTTP outcalls](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/overview) to Web2 services including OpenAI and Claude.
