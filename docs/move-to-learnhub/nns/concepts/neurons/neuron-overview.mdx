...
Hotkeys can be added or removed from a neuron using the [NNS dapp](https://nns.ic0.app/) or the [`quill neuron-manage`](/docs/building-apps/developer-tools/quill/quill-neuron-manage) command.
...
For more details on voting rewards and spawn maturity, refer to [voting rewards](/docs/move-to-learnhub/nns/concepts/neurons/staking-voting-rewards).
...
All [known neurons](/docs/move-to-learnhub/nns/concepts/neurons/becoming-a-known-neuron) are public.
