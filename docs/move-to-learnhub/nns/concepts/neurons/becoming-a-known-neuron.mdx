...
To install `dfx`, follow the [installation instructions](/docs/current/building-apps/getting-started/install#installing-dfx).
...
Run `dfx identity get-principal` to get the principal ID that corresponds to your current [developer identity](/docs/current/building-apps/getting-started/identities). The following steps will refer to this as your "dfx principal".
