...
within the NNS. This information can be used by other neurons to find known neurons and [follow](/docs/move-to-learnhub/nns/concepts/neurons/neuron-following) them.
...
* [Create the neuron on the NNS dapp](/docs/move-to-learnhub/nns/overview#stake-icp-utility-tokens-in-a-neuron).
...
[**hot key**](/docs/move-to-learnhub/nns/concepts/neurons/neuron-management#neuron-attributes)
