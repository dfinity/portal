...
For more information on how to submit a proposal, refer to [How to submit a proposal](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-submit).

### Proposal decision
After a proposal is submitted and added to the governance canister, other users who control neurons can [vote on the
proposal](/docs/current/move-to-learnhub/nns/concepts/proposals/direct-voting). The governance canister stores a
