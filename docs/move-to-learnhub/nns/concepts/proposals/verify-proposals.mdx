...
* For updates to the [Internet Identity (II)](/docs/current/building-apps/authentication/overview) canister, you can find the code in [the II repository](https://github.com/dfinity/internet-identity).
