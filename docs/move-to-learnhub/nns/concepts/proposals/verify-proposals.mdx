...
If you are looking to verify [protocol canister management proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`ProtocolCanisterManagement`), you
...
If you are looking to verify [IC OS version election proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`IcOsVersionElection`), you
...
If you are looking to verify [participant management proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`ParticipantManagement`),
...
If you are looking to verify [node admin proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`NodeAdmin`),
these are some steps you can consider for verification.
...
If you are looking to verify [subnet management proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`SubnetManagement`), these are some steps you can consider for verification.
...
If you are looking to verify [service nervous system management proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`ServiceNervousSystemManagement`),
...
If you are looking to verify [application canister management proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics#Topic:-`ApplicationCanisterManagement`), you can refer to this video that explains the process on the example of an NNS frontend dapp upgrade proposal:
