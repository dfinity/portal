...
For more information on what to consider when verifying the different kinds of proposals, please refer to [verifying proposals](/docs/current/developer-docs/daos/nns/concepts/proposals/proposal-topics).
...
This topic includes proposals that concern [SNS DAO launches](/docs/current/building-dapps/governing-dapps/launching/) and the [Neurons' Fund](/docs/current/developer-docs/daos/nns/concepts/neurons-fund) (formerly called Community Fund).
