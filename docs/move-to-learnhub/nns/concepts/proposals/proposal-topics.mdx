...
(/docs/current/move-to-learnhub/nns/concepts/neurons/neuron-following) and also determine some other details about
...
For more information on what to consider when verifying the different kinds of proposals, please refer to [verifying proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-topics).

### Topic: `ProtocolCanisterManagement`
All proposals to manage [protocol canisters](/docs/current/developer-education/system-canisters/index/), which are considered part of the Internet Computer protocol and are essential for its proper functioning.
...
* `AddSnsWasm`: Add a new SNS canister Wasm to SNS-W. All SNS DAOs can then upgrade to new versions along the upgrade path defined in [SNS-W](/docs/current/building-dapps/governing-dapps/overview#SNS-W).
...
This topic includes proposals that concern [SNS DAO launches](/docs/current/building-dapps/governing-dapps/launching/) and the [Neurons' Fund](/docs/current/move-to-learnhub/nns/concepts/neurons-fund) (formerly called Community Fund).
...
- **Neurons' Fund economics**: This includes all parameters related to the [Neurons' Fund](/docs/current/move-to-learnhub/nns/concepts/neurons-fund):
