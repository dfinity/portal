...
All proposals to manage [protocol canisters](/docs/current/developer-education/system-canisters//), which are considered part of the Internet Computer protocol and are essential for its proper functioning.
