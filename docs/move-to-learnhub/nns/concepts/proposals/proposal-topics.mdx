...
(/docs/move-to-learnhub/nns/concepts/neurons/neuron-following) and also determine some other details about
...
For more information on what to consider when verifying the different kinds of proposals, please refer to [verifying proposals](/docs/move-to-learnhub/nns/concepts/proposals/proposal-topics).
...
This topic includes proposals that concern [SNS DAO launches](/docs/building-apps/governing-apps/launching/) and the [Neurons' Fund](/docs/move-to-learnhub/nns/concepts/neurons-fund) (formerly called Community Fund).
...
- **Neurons' Fund economics**: This includes all parameters related to the [Neurons' Fund](/docs/move-to-learnhub/nns/concepts/neurons-fund):
