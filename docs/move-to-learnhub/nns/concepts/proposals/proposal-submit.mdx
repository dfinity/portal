...
(/docs/current/move-to-learnhub/nns/concepts/neurons/becoming-a-known-neuron).
...
[Install `dfx`](https://internetcomputer.org/docs/current/building-dapps/getting-started/install).
```
