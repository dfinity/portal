...
You can interact with the NNS through other tools, such as [quill](/docs/building-apps/developer-tools/quill/quill-parent)
...
[transfer tokens](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-send-and-receive-tokens),
[stake tokens and set up a neuron](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-staking-a-neuron),
and how to participate in voting either by [voting manually](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-voting-on-proposals)
 or by [following other neurons](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-following-other-neurons).
