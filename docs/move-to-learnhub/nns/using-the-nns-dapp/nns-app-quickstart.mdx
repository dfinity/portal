...
[transfer tokens](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-send-and-receive-tokens),
[stake tokens and set up a neuron](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-staking-a-neuron),
and how to participate in voting either by [voting manually](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-voting-on-proposals)
 or by [following other neurons](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-following-other-neurons).
