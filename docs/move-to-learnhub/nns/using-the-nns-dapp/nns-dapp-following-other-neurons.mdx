...
[Following](/docs/current/move-to-learnhub/nns/concepts/neurons/neuron-following). For information about how you
can become a neuron that can be followed, we refer to [Registering a known neuron](/docs/current/move-to-learnhub/nns/concepts/neurons/becoming-a-known-neuron).
