...
1. [Vote directly](https://internetcomputer.org/docs/developer-docs/daos/nns/using-the-nns-dapp/nns-dapp-voting-on-proposals).
2. [Set or edit following](https://internetcomputer.org/docs/developer-docs/daos/nns/using-the-nns-dapp/nns-dapp-following-other-neurons).
3. Confirm following.
