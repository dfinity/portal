...
You must have **cycles** available to create and manage [<GlossaryTooltip>canisters</GlossaryTooltip>](/docs/current/developer-education/glossary/index#canister).
