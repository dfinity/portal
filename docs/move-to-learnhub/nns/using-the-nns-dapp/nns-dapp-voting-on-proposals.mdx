...
This can be done by voting manually or by delegating your voting power to other neurons using [following](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-dapp-voting-on-proposals).
...
refer to [Proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/proposal-overview)
and [Verify proposals](/docs/current/move-to-learnhub/nns/concepts/proposals/verify-proposals).
:::
