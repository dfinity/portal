...
|-------------------------------------|----------|------------------------------------------------------------------------|
| [`Bool`](/motoko/official/base/Bool.md)           | L        | Boolean values `true` and `false` and logical operators                |
| [`Char`](/motoko/official/base/Char.md)           | O        | Unicode characters                                                     |
| [`Text`](/motoko/official/base/Text.md)           | T, O     | Unicode strings of characters with concatenation `_ # _` and iteration |
| [`Float`](/motoko/official/base/Float.md)         | A, O     | 64-bit floating point values                                           |
| [`Int`](/motoko/official/base/Int.md)             | A, O     | signed integer values with arithmetic (unbounded)                      |
| [`Int8`](/motoko/official/base/Int8.md)           | A, O     | signed 8-bit integer values with checked arithmetic                    |
| [`Int16`](/motoko/official/base/Int16.md)         | A, O     | signed 16-bit integer values with checked arithmetic                   |
| [`Int32`](/motoko/official/base/Int32.md)         | A, O     | signed 32-bit integer values with checked arithmetic                   |
| [`Int64`](/motoko/official/base/Int64.md)         | A, O     | signed 64-bit integer values with checked arithmetic                   |
| [`Nat`](/motoko/official/base/Nat.md)             | A, O     | non-negative integer values with arithmetic (unbounded)                |
| [`Nat8`](/motoko/official/base/Nat8.md)           | A, O     | non-negative 8-bit integer values with checked arithmetic              |
| [`Nat16`](/motoko/official/base/Nat16.md)         | A, O     | non-negative 16-bit integer values with checked arithmetic             |
| [`Nat32`](/motoko/official/base/Nat32.md)         | A, O     | non-negative 32-bit integer values with checked arithmetic             |
| [`Nat64`](/motoko/official/base/Nat64.md)         | A, O     | non-negative 64-bit integer values with checked arithmetic             |
| [`Blob`](/motoko/official/base/Blob.md)           | O        | binary blobs with iterators                                            |
| [`Principal`](/motoko/official/base/Principal.md) | O        | principals                                                             |
| [`Error`](/motoko/official/base/Error.md)         |          | (opaque) error values                                                  |

Although many of these types have linguistic support for literals and operators, each primitive type also has an eponymous base library providing related functions and values (see [Motoko Base Library](./base-intro.md)). For example, the [`Text`](/motoko/official/base/Text.md) library provides common functions on `Text` values.
