...
``` motoko name=counter file=../main/examples/Counter.mo
```
...
``` motoko include=counter file=../main/examples/factorial.mo#L9-L21
```
...
``` motoko file=../main/examples/tree.mo
```
...
``` motoko file=../main/examples/Registry.mo
```
