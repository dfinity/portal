---
keywords: [beginner, getting started, what is icp, icp overview, overview, what are subnets, what are threshold signatures, what are ]
---
...
1. It ensures that the hardware meets the high standards of ICP: 64 CPU cores, 512GiB of RAM, 30TiB of NVMe SSD.
