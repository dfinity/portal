...
[Learn more about writing canister code](/docs/current/building-dapps/launching-a-dapp/create-and-install).

## Create

A developer can create an empty canister on ICP by using [`dfx canister create`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-create) in the command line or the [<GlossaryTooltip>NNS</GlossaryTooltip> frontend dapp](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-app-quickstart#deploying-and-managing-canisters-from-the-nns-dapp) in the browser.
...
[Learn more about creating canisters](/docs/current/building-dapps/launching-a-dapp/create-and-install).
...
[Learn more about compiling code into Wasm](/docs/current/building-dapps/launching-a-dapp/create-and-install).
