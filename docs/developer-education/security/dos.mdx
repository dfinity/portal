...
Learn more about managing memory and compute resources in the [Storage](https://internetcomputer.org/docs/current/developer-education/developer-concepts/gas-cost#storage) and [Compute](https://internetcomputer.org/docs/current/developer-education/developer-concepts/gas-cost#execution) guides.
...
Some calls (update or query) might be expensive in terms of the memory or cycles they consume. For example, any function using chain-key signing or HTTPS outcalls are relatively expensive. See the [additional documentation](https://internetcomputer.org/docs/current/developer-education/developer-concepts/gas-cost#special-features) on cycles cost details and for other examples.
