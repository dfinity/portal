...
Learn more about managing memory and compute resources in the [storage](https://internetcomputer.org/docs/current/developer-education/developer-concepts/gas-cost) and [compute](https://internetcomputer.org/docs/current/developer-education/developer-concepts/gas-cost) guides.
