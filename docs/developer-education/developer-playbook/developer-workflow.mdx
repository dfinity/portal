...
3. Write an off-chain program that uses an [agent library](/docs/current/building-dapps/interacting-with-dapps/agents/overview) to send messages to the smart contract.
