...
It can be done using [`dfx canister create`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-create) in the command line or the [<GlossaryTooltip>NNS</GlossaryTooltip> frontend dapp](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-app-quickstart#deploying-and-managing-canisters-from-the-nns-dapp) in the browser.
