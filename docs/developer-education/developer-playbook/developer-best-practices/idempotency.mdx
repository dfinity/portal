...
Please read the [reference on ingress messaging](/docs/current/developer-education/message-execution/ingress-messages) to learn about the messaging basics and potential errors.
...
1. It requires no synchronization on the part of the user and supports use cases like multiple devices.
