...
To ensure that your canister is optimized, both for latency and cycles cost, be sure to follow the [canister general best practices](/docs/current/developer-education/developer-playbook/developer-best-practices/general), which include ways to implement efficient Motoko and Rust code.
