...
allow users to seamlessly access the [canister](#canisters) smart contracts
running on ICP.
...
ICP](#icp), whereby a certain amount of ICP is destroyed.
The main use case is purchasing [cycles](#cycles),
...
individual or organization [principal](#principal) that uses the
