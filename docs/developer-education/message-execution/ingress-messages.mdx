...
See also the introductory [call overview](/docs/current/developer-education/message-execution/types-of-canister-calls) to learn more about calling canisters.
...
[Learn more about query calls](/docs/current/building-dapps/interacting-with-dapps/query-calls).
...
[Learn more about update calls](/docs/current/building-dapps/interacting-with-dapps/update-calls).
