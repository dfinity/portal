...
To make a update call to a canister, use the [`dfx canister call`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-call) command with the `--update` flag:
...
To make a query call to a canister, use the [`dfx canister call`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-call) command with the `--query` flag:
...
[Learn more about the properties of ICP message executions.](/docs/current/developer-education/message-execution/execution-errors)
...
- [Method not found](/docs/current/developer-education/message-execution/execution-errors#method-not-found).

- [Calling a system API from the wrong mode](/docs/current/developer-education/message-execution/execution-errors#calling-a-system-api-from-the-wrong-mode).

- [Canister made a call with too large method name](/docs/current/developer-education/message-execution/execution-errors#canister-made-a-call-with-too-large-method-name).

- [Canister made a call with too large payload](/docs/current/developer-education/message-execution/execution-errors#canister-made-a-call-with-too-large-payload).

- [Canister made a call with too long timeout](/docs/current/developer-education/message-execution/execution-errors#canister-made-a-call-with-too-long-timeout).
