...
Run the following command to generate the correct [Candid](/docs/current/building-dapps/interacting-with-dapps/candid/candid-concepts) type definitions:
...
Or, you can deploy directly on the mainnet. Deploying to the mainnet will cost [cycles](/docs/current/building-dapps/getting-started/tokens-and-cycles).
