...
- Backend canisters that communicate with an external frontend application that isn't hosted on ICP. To facilitate this communication, [the ICP JavaScript agent](/docs/current/building-dapps/interacting-with-dapps/agents/javascript-agent) can be used. [Learn more about the JS request API](/docs/current/building-dapps/interacting-with-dapps/agents/javascript-agent).
...
[Learn more about the HTTP certification library](/docs/current/building-dapps/using-network-features/using-external-data/http-gateways-certification/serving-static-assets-over-http).
