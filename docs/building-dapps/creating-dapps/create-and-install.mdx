...
- [What are canisters?](/docs/current/developer-education/developer-concepts/what-are-canisters)

- [Canister components](/docs/current/developer-education/developer-concepts/inside-canisters).

- [Canister lifecycle](/docs/current/developer-education/developer-concepts/canister-lifecycle).
...
Having no frontend at all is also a valid option for canisters that don’t have a UI and are callable only by users or other canisters. [Learn more](/docs/current/building-dapps/dapp-frontends/using-an-asset-canister).
