...
- The mainnet, designed for production use. This deployment method will cost [cycles](/docs/current/developer-education/developer-concepts/gas-cost).
...
<input type="checkbox"/> <a href="/docs/current/building-dapps/creating-dapps/create-and-install">Write code.</a>
<div>
</div>
...
- `dfx deploy <canister-name> --network=playground`: Deploy a canister on the playground.

- `dfx deploy <canister-name> --network=ic`: Deploy a canister on the mainnet.
