...
- JavaScript / TypeScript
  - [JavaScript/TypeScript agent by DFINITY](/docs/current/building-dapps/interacting-with-dapps/agents/javascript-agent)
- Rust
  - [Rust agent by DFINITY](/docs/current/building-dapps/interacting-with-dapps/agents/rust-agent)
