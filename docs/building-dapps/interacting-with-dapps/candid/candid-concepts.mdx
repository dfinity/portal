...
For examples of how to write Candid service descriptions for Rust programs, see the [Rust CDK examples](https://github.com/dfinity/cdk-rs/tree/next/examples) and the [Rust tutorials](/docs/current/building-dapps/developer-tools/cdks/rust/). [Learn how to generate Candid files for Rust canisters](/docs/current/building-dapps/developer-tools/cdks/rust/generating-candid).
