...
You can deploy the ICRC-1 ledger locally for testing. [Learn more in the ICRC-1 ledger setup documentation](/docs/current/developer-docs/defi/tokens/ledger/setup/icrc1_ledger_setup).
...
// Enable Candid export (see /docs/current/building-dapps/developer-tools/cdks/rust/generating-candid)
