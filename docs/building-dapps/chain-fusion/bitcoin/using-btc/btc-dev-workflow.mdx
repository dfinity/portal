...
Chain-key Bitcoin (ckBTC) is a digital twin token of Bitcoin that is backed 1:1 with Bitcoin held within an ICP smart contract. ckBTC tokens comply with the [ICRC token standard](/docs/current/developer-docs/multi-chain/chain-key-tokens/ckbtc/overview).
...
[Learn more about ckBTC](/docs/current/developer-docs/multi-chain/chain-key-tokens/ckbtc/overview).
