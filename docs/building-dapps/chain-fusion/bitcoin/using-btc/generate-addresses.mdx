...
An ECDSA public key can be retrieved using the [`ecdsa_public_key`](/docs/current/references/ic-interface-spec#ic-ecdsa_public_key) API. The [basic Bitcoin example](https://github.com/dfinity/examples/tree/master/motoko/basic_bitcoin)
