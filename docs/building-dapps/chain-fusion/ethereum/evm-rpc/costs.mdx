...
Each call made to the EVM RPC canister costs [cycles](/docs/current/building-dapps/getting-started/tokens-and-cycles).
...
The total cost for an RPC request (assuming a 1kB request, 1kB response, 34-node subnet, and 1 [XDR](https://internetcomputer.org/docs/current/developer-education/developer-concepts/gas-cost#units-and-fiat-value) = $1.336610 USD)
is ~ $0.00051 USD.
