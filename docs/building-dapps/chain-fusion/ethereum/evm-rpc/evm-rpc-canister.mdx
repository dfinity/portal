...
Then start the local replica and deploy the canister locally with a specified number of nodes (`31` for the [fiduciary subnet](/docs/current/building-dapps/launching-a-dapp/subnets/subnet-types)):
