...
**ICP**: Canisters can be written in any language that complies to [Wasm](https://webassembly.org/) or has an interpreter that can compile to Wasm including [Rust](/docs/current/building-dapps/developer-tools/cdks/rust/), [Typescript](https://demergent-labs.github.io/azle/), [Motoko](/docs/current/motoko/main/getting-started/motoko-introduction), and [Python](https://demergent-labs.github.io/kybra/).
