...
Chain-key Ethereum (ckETH) is a digital twin token of Ethereum that is backed 1:1 with Ethereum held within an ICP smart contract. ckETH tokens comply with the [ICRC token standard](/docs/current/building-dapps/chain-fusion/chain-key-tokens/cketh/overview).
...
[Learn more about ckETH](/docs/current/building-dapps/chain-fusion/chain-key-tokens/cketh/overview).
...
- [ckETH](/docs/current/building-dapps/chain-fusion/chain-key-tokens/cketh/overview).
