---
keywords: [advanced, ethereum, overview]
---
...
ICP implements a smart contract that uses threshold ECDSA and chain-key cryptography to provide a [**ckETH**](/docs/current/building-dapps/chain-fusion/chain-key-tokens/cketh/overview) token (chain-key ETH) that is backed 1:1 by ETH.
