...
- Full Web 2 integration allows canisters to both expose [HTTP interfaces](/docs/current/building-dapps/using-network-features/using-external-data/http-outcalls/overview) and call [HTTP APIs hosted on the web](/docs/current/building-dapps/using-network-features/using-external-data/http-outcalls/overview).
...
- **[HTTPS outcalls](/docs/current/building-dapps/using-network-features/using-external-data/http-outcalls/overview)**: Replicated calls into external web services.
