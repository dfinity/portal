...
- **Chain-key tokens**: Using the primitives described above, DFINITY has built canisters implementing the [ICRC-2](https://github.com/dfinity/ICRC) token standard to represent native Bitcoin, Ethereum, and ERC-20 tokens on ICP: [ckBTC](/docs/current/rosetta-defi/chain-key-tokens/ckbtc/overview), [ckETH](/docs/current/rosetta-defi/chain-key-tokens/cketh/overview), and [ckERC20](/docs/current/rosetta-defi/chain-key-tokens/ckerc20/overview). These tokens are digital twins of their corresponding native token and are backed 1:1 by the native assets which are managed 100% onchain through a canister smart contract without any intermediaries.
