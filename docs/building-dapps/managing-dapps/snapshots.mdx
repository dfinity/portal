...
To create a snapshot, first the canister must be stopped. Then, use the [`dfx canister snapshot create <canister-name>`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-snapshot-create) command:
...
The snapshot ID can be used to load the snapshot at a later time. To list all snapshots saved for a canister, use the command [`dfx canister snapshot list <canister-name>`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-snapshot-list):
...
To load a saved snapshot, first the canister must be stopped. Then, use the [`dfx canister snapshot load <canister-name> <snapshot-id>`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-snapshot-load) command:
...
To delete a saved snapshot, use the command [`dfx canister snapshot delete <canister-name> <snapshot-id>`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-snapshot-delete)
...
- [Canister snapshot not found](/docs/current/developer-education/message-execution/execution-errors#canister-snapshot-not-found).

- [Canister snapshot invalid ownership](/docs/current/developer-education/message-execution/execution-errors#canister-snapshot-invalid-ownership).

## Resources

- [`dfx canister snapshot` reference documentation](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-snapshot-create).
