...
To specify a different controller upon canister creation, use the [`dfx canister create --controller <controller>`](/docs/current/building-dapps/developer-tools/dfx/dfx-canister#dfx-canister-create) command.
