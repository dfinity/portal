...
The expiration time of an ingress message is specified by the [agent](/docs/current/building-dapps/calling-dapps/agents/overview) making the request and can be up to 5 minutes.
