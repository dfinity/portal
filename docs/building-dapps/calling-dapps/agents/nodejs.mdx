...
This test is written for the [default backend canister](/docs/current/building-dapps/creating-dapps/create-and-install).
...
- [ICP JavaScript agent developer docs](/docs/current/building-dapps/calling-dapps/agents/javascript-agent)
