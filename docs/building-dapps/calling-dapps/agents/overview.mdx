...
- JavaScript / TypeScript
    - [JavaScript/TypeScript agent by DFINITY](/docs/current/building-dapps/calling-dapps/agents/javascript-agent)
- Rust
    - [Rust agent by DFINITY](/docs/current/building-dapps/calling-dapps/agents/rust-agent)
