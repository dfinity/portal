...
This extra feature will add the **pullable** version of the Internet identity canister to your project. A pullable canister is a canister that provides a public service at a static canister ID. [Learn more about pullable canisters](/docs/current/building-dapps/interacting-with-dapps/using-third-party-canisters).
