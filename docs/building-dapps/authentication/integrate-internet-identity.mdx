...
First, use `dfx start` to start a [local instance of the replica](/docs/current/building-dapps/developer-tools/dfx/dfx-start) (if necessary) and [create a new project](/docs/current/building-dapps/developer-tools/dfx/dfx-new) or open an existing project.
...
This extra feature will add the **pullable** version of the Internet identity canister to your project. A pullable canister is a canister that provides a public service at a static canister ID. [Learn more about pullable canisters](/docs/current/building-dapps/creating-dapps/using-third-party-canisters).
...
- [Internet Identity alternative frontend origins](/docs/current/building-dapps/authentication/alternative-origins).
