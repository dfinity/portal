...
First, [start the local replica](/docs/current/building-dapps/developer-tools/dfx/dfx-start) if necessary and [create](/docs/current/building-dapps/developer-tools/dfx/dfx-new) or open a project.
