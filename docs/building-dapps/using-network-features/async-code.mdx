...
message executions can interleave](/docs/current/developer-education/message-execution/message-execution-properties) as these can lead to inconsistencies if they are not anticipated.
