...
Threshold Schnorr can be used by making calls to the threshold Schnorr API methods.

[Learn how to sign messages and transactions with threshold Schnorr](./signing-messages-t-schnorr.mdx).
...
- [Threshold Schnorr API](https://internetcomputer.org/docs/current/references/ic-interface-spec#ic-schnorr_public_key).
...
[Learn more about threshold Schnorr costs](/docs/current/developer-education/developer-concepts/gas-cost).
