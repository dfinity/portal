...
The `sign_with_schnorr` method requires cycles to be attached. [Learn more about threshold Schnorr costs](/docs/current/developer-education/developer-concepts/gas-cost).
