...
Threshold ECDSA can be used by making calls to the threshold ECDSA API methods.

[Learn how sign messages and transactions with threshold ECDSA](./signing-messages-t-ecdsa.mdx).
