...
For detailed information on how it works, please refer to the [HTTPS outcalls reference documentation](/docs/current/references/https-outcalls-how-it-works).
...
- [Minimal sample code of making a `GET` request](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/get).
- [Minimal sample code of making a `POST` request](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/post).