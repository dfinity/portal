...
- [GET request](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/https-outcalls-get)
- [POST request](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/https-outcalls-post)
...
Refer to the following examples of HTTPS outcall implementations in canisters:
...
- [Minimal sample code of making a `GET` request](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/https-outcalls-get).
- [Minimal sample code of making a `POST` request](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/https-outcalls-post).