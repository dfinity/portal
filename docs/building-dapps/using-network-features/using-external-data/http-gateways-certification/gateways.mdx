...
DFINITY exclusively controls the HTTP gateways that serve canisters on `ic0.app` and `icp0.io`. Developers can then also configure their own [custom domains](https://internetcomputer.org/docs/current/building-dapps/dapp-frontends/custom-domains/using-custom-domains) to point at the DFINITY controlled HTTP gateways.
...
8. If the response size [exceeds the maximum response size](/docs/current/building-dapps/launching-a-dapp/resource-limits), the HTTP gateway fetches additional response body data through query calls.
...
For outgoing HTTP requests, the [HTTPS outcalls](/docs/current/building-dapps/using-network-features/using-external-data//https-outcalls/overview) feature should be used.

- [How to use HTTPS outcalls](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls)

- [HTTPS outcalls: `GET`](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/https-outcalls-get)

- [HTTPS outcalls: `POST`](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/https-outcalls-post)
...
- [How to use HTTPS outcalls](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/overview)

- [HTTPS outcalls: `GET`](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/get)

- [HTTPS outcalls: `POST`](/docs/current/building-dapps/using-network-features/using-external-data/https-outcalls/post)
