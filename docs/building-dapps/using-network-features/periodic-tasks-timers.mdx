...
Yes, as the CDK timers library initiates a self-canister call to execute each task, normal [update message instruction limits](/docs/current/building-dapps/creating-dapps/resource-limits) apply with DTS enabled.
