...
- [Minimal sample code of making a `GET` request](/docs/current/building-dapps/using-network-features/using-http/https-outcalls/get).
- [Minimal sample code of making a `POST` request](/docs/current/building-dapps/using-network-features/using-http/https-outcalls/post).