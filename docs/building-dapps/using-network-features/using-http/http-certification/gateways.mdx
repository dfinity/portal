...
8. If the response size [exceeds the maximum response size](/docs/current/building-dapps/creating-dapps/resource-limits), the HTTP gateway fetches additional response body data through query calls.
...
For outgoing HTTP requests, the [HTTPS outcalls](/docs/current/building-dapps/using-network-features/using-http/https-outcalls/overview) feature should be used.
...
- [HTTPS outcalls: `GET`](/docs/current/building-dapps/using-network-features/using-http/https-outcalls/get)

- [HTTPS outcalls: `POST`](/docs/current/building-dapps/using-network-features/using-http/https-outcalls/post)
