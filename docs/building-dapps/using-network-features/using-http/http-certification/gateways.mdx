...
8. If the response size [exceeds the maximum response size](/docs/current/building-dapps/managing-dapps/resource-limits), the HTTP gateway fetches additional response body data through query calls.
