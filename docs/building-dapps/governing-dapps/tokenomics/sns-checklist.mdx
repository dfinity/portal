...
- [x] The init file that is planned to be used. You can start from a [template](https://github.com/dfinity/ic/blob/master/rs/sns/cli/test_sns_init_v2.yaml).
...
- [x] Explanation of the extent to which security reviews were considered relevant for the dapp and what kind of security reviews have been conducted for the dapp.
