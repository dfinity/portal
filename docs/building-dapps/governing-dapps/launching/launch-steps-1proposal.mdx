...
- [x] Install the IC SDK. See: [installing the IC SDK](/docs/current/building-dapps/getting-started/install).

- [x] Install `ic-admin`. See: [installing the `ic-admin`](/docs/current/building-dapps/developer-tools/ic-admin).
...
One example of a special permission might be the ability to change the frontend canister content on their own. You can review the [SNS asset canister](/docs/current/building-dapps/governing-dapps/managing/sns-asset-canister) documentation for more details.
