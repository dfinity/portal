...
<input type="checkbox"/> <a href="/docs/current/building-dapps/developer-tools/ic-admin">Download and install <code>ic-admin</code>.</a>
<div>
</div>
