...
The price of cycles is fixed against the price of [XDR](/docs/current/developer-education/glossary/index#xdr), where 1 trillion cycles equals 1 XDR.
...
- [x] [Writing smart contracts](/docs/current/building-dapps/getting-started/write-smart-contracts).