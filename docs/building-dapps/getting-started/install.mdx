...
If you followed the [quick start](/docs/current/building-dapps/getting-started/quickstart/first-smart-contract) guide, you can skip this step.
...
- [**Rust CDK**](/docs/current/building-dapps/developer-tools/cdks/rust/): A set of tools for developing Rust canisters.
