...
- Continue setting up your local development environment by creating a [developer identity](../identities.mdx) and [getting tokens](../tokens-and-cycles.mdx) for more dapp deployments.

- Learn more about [canister smart contracts](../write-canister-code.mdx) and how to [deploy and manage them](../deploy-and-manage.mdx).
