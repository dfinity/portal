...
- **Wasm memory limit:** The maximum size for a canister's Wasm memory. [Learn more about resource limits](/docs/current/building-dapps/managing-dapps/resource-limits).
