...
If you are using a [cycles wallet](/docs/current/rosetta-defi/cycles/cycles-wallet), be sure to deploy your cycles wallet to this custom network.
...
You can learn more about project-specific networks in the [custom testnet documentation](/docs/current/building-dapps/launching-a-dapp/deploy/custom-testnets).
