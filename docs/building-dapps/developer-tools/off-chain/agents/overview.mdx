...
You can talk to the canister using the v2 API using an **agent** that follows the interface specification, or you can use the canister's HTTPS interface.
...
- JavaScript / TypeScript
  - [JavaScript/TypeScript agent by DFINITY](/docs/current/building-dapps/developer-tools/off-chain/agents/javascript-agent)
- Rust
  - [Rust agent by DFINITY](/docs/current/building-dapps/developer-tools/off-chain/agents/rust-agent)
