...
[Learn how to configure a canister as `pullable`](https://internetcomputer.org/docs/current/building-dapps/calling-dapps/using-third-party-canisterss/using-third-party-canisters).
