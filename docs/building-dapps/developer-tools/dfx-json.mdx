...
- `main`: The primary source code file for the canister that serves as the canister's entry point. By default, for Motoko canisters, this file is `main.mo`. For Rust canisters,
...
[Learn more about custom network definitions and configurations](/docs/current/building-dapps/developer-tools/advanced-dfx/networks-json).
...
There are several workflow-specific `dfx.json` configuration options detailed in the full [`dfx.json` schema](/docs/current/building-dapps/developer-tools/dfx-json-reference).
