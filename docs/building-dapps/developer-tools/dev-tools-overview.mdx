...
- [JavaScript/TypeScript agent (@dfinity/agent)](/docs/current/building-dapps/calling-dapps/agents/javascript-agent)

- [Node.js, supported through the JavaScript agent](/docs/current/building-dapps/calling-dapps/agents/nodejs)

- [Rust agent (ic-agent)](/docs/current/building-dapps/calling-dapps/agents/rust-agent)
