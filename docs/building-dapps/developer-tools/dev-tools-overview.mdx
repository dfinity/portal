...
[`dfxvm`](/docs/current/building-dapps/developer-tools/dfxvm/dfxvm-default) is a CLI tool used for installing and switching between different versions of `dfx`. It enables developers to pivot between different projects that are built with different `dfx` versions.

- [Install `dfxvm`](/docs/current/building-dapps/getting-started/install#installing-dfx).

- [`dfxvm` documentation](/docs/current/building-dapps/developer-tools/dfxvm/dfxvm-default).
...
The [Rust CDK](/docs/current/building-dapps/developer-tools/cdks/rust/intro-to-rust) is developed and maintained by DFINITY for Rust development.
