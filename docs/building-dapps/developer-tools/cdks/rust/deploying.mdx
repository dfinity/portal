...
Before getting started, assure you have set up your developer environment according to the instructions in the [developer environment guide](/docs/current/building-dapps/developer-tools/cdks/rust/dev-env) and have created a [Rust project](/docs/current/building-dapps/developer-tools/cdks/rust/quickstart).
...
[PocketIC](/docs/current/building-dapps/launching-dapps/test/pocket-ic) is a lightweight, deterministic testing solution for programmatic testing of canisters that seamlessly integrates with existing testing infrastructure, such as `cargo test`.

You can learn more about PocketIC and how to install it [here](/docs/current/building-dapps/launching-dapps/test/pocket-ic).
...
[View additional PocketIC testing examples](/docs/current/building-dapps/launching-dapps/test/pocket-ic).
