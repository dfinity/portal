...
In this guide, you'll learn the steps required to write, compile, deploy, and interact with a Rust backend canister using a simple 'Hello, world!' example.
...
```rust ../../../../references/samples/rust/hello/src/hello_backend/src/lib.rs
```
