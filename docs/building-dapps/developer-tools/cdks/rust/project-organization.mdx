...
To see details about the Candid interface description language syntax, see the [*Candid Guide*](/docs/current/building-dapps/calling-dapps/candid/candid-concepts) or the [Candid crate documentation](https://docs.rs/candid/).
