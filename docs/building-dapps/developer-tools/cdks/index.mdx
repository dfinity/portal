---
keywords: [cdk, cdks, overview, azle, kybra, typescript, python, solidity, bitfinity]
---
...
The IC SDK includes a CDK for the Rust programming language, which is developed and maintained by DFINITY. This Rust CDK is installed automatically when the IC SDK is installed and can be used through the [`dfx`](/docs/current/building-dapps/getting-started/install) CLI tool.
...
- [Rustic](https://github.com/internet-computer-protocol/rustic)
