...
To install `ic-admin`, first determine the latest IC release version found in [the DFINITY/ic repo](https://github.com/dfinity/ic/releases/latest).
...
Examples of node provider proposals include proposals to add your node provider to the network, register your data center, and create a node operator record.