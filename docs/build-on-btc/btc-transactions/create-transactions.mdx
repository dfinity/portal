...
The following snippet shows a simplified version of how to build a transaction that sends `amount` satoshis to the `dst_address`, and returns the change to the `own_address`.
