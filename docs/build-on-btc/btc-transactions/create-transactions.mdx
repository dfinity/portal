...
To implement the following code snippets in your dapp, you will need to setup a [local development environment](/build-on-btc/btc-dev-env) and create a project.
