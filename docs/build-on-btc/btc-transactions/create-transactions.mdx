...
The following snippet shows how to get the available UTXOs corresponding to `own_address`. Note that an ICP smart contract can control many addresses and each of them can have multiple UTXOs associated with it.
