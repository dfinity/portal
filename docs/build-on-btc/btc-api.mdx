...
The Bitcoin API is hosted through a canister running on ICP. To make calls to the API, you must target the canister ID for either the Bitcoin mainnet or Bitcoin testnet:

- Mainnet: `ghsi2-tqaaa-aaaan-aaaca-cai`

- Testnet (v4): `g4xu7-jiaaa-aaaan-aaaaq-cai`
...
Each call to the API has a cost of [cycles](/docs/building-apps/getting-started/tokens-and-cycles); therefore, a sufficient amount of cycles must be sent with each call.
...
## Signature system API endpoints
