...
Each call to the Bitcoin API has a cost of [cycles](/building-apps/getting-started/tokens-and-cycles); therefore, a sufficient amount of cycles must be sent with each call.

Cycles costs vary between the Bitcoin testnet and mainnet. For a breakdown of the costs, see [Bitcoin API costs](/references/bitcoin-how-it-works).
