...
[Learn more about access control](/tutorials/hackathon-prep-course/managing-canisters/#access-control).
...
[Learn more](/docs/tutorials/developer-liftoff/level-3/3.3-certified-data).
