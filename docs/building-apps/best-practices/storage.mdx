...
[Learn more about canister storage](/building-apps/canister-management/storage).
...
6. Be mindful of calling an [actor class]((/motoko/actors-async), as the overhead is similar to that of installing a fresh canister.
