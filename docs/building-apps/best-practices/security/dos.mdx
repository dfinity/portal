...
Learn more about managing memory and compute resources in the [storage](https://internetcomputer.org/docs/building-apps/essentials/gas-cost) and [compute](https://internetcomputer.org/docs/building-apps/essentials/gas-cost) guides.
