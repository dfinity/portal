...
-   If you are using the IC SDK, note the version used. You can install arbitrary versions of the IC SDK using [`dfxvm`](/building-apps/developer-tools/dfxvm/dfxvm-install).
