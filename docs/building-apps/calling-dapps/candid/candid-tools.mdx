...
You can learn more about the Candid UI in [using Candid](/docs/current/building-apps/calling-dapps/candid/using-candid#interact-with-a-service-from-a-browser).
