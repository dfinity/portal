...
This test is written for the [default backend canister](/docs/current/building-apps/creating-dapps/create-and-install).
...
```js file=../../../specifications/samples/archive/motoko/dip721-nft-container/src/Main.mo
```

## Resources

- [ICP JavaScript agent developer docs](/docs/current/building-apps/calling-dapps/agents/javascript-agent)
