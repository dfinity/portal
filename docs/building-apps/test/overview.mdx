...
[PocketIC](/docs/building-apps/test/pocket-ic) is a comprehensive testing suite that can be used for testing canisters with custom environments, allowing you to test applications against real-world scenarios that your application may encounter once deployed on the mainnet.
...
For more information on end-to-end tests, check out the [Developer Liftoff module on testing](/docs/tutorials/developer-liftoff/level-2/2.5-unit-testing#end-to-end-e2e-testing).
