...
:::info
Other languages such as Rust are supported by installing a [separate canister development kit (CDK)](/docs/current/building-apps/developer-tools/cdks/rust/intro-to-rust).
:::
