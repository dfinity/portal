...
- `moc`: The [Motoko](/docs/current/motoko/main/getting-started/motoko-introduction) compiler to support Motoko canister development. Other languages such as Rust are supported by installing a [separate canister development kit (CDK)](/docs/current/building-apps/developer-tools/cdks/rust/intro-to-rust).
