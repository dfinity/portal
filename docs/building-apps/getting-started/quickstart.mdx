...
This generates a simple "Hello, [name]!" application that uses [Motoko](/motoko/home), React, and TypeScript.
...
- Continue setting up your local development environment by creating a [developer identity](/building-apps/getting-started/identities) and [getting tokens](/building-apps/getting-started/tokens-and-cycles) for more dapp deployments.

- Learn more about [canister smart contracts](/building-apps/developing-canisters/write) and how to [deploy and manage them](/building-apps/developing-canisters/deploy).
