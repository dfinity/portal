...
Creates a new Motoko project without a frontend user interface. Options are [motoko, rust, azle, kybra].
...
Open the URL that `dfx` returned after deploying your project.
