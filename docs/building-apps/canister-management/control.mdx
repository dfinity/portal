...
Developers can also add the NNS root canister as a controller of their canister to enable [recovery](/docs/building-apps/canister-management/recovery) of the canister by NNS proposal if other control methods are lost.
