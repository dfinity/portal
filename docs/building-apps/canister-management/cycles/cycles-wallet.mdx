...
There are dapps that can help you convert ICP to cycles and create a new cycles wallet, e.g., [NNS dapp](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-app-quickstart#_deploy_a_canister_with_cycles).
