---
keywords: [beginner, tutorial, cycles, converting icp, icp to cycles, converting to cycles, getting cycles, how to get cycles, obtain cycles, convert icp]
---
...
To convert ICP tokens into <GlossaryTooltip>cycles</GlossaryTooltip>, you first need to obtain some ICP and transfer it to the right account. You can get ICP tokens on exchanges or ask someone you know to send you some. To figure out which account to transfer the ICP tokens to, run the following:
