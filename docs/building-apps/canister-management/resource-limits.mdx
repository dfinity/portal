...
| ------------------------------------------------------------------------------------ | ----------- |
| Message queue limit, messages between a pair of <GlossaryTooltip>canister</GlossaryTooltip>s | 500         |
...
| ------------------------------------------------------------------------------------ | ----------- |
| Subnet capacity (total memory available per subnet)                                  | 2TiB        |
| Maximum number of snapshots per canister                                              | 10         |
...
| Wasm function name length                                                            | 1MiB        |
...
| Canister environment variables                                                       | Constraint  |
| ------------------------------------------------------------------------------------ | ----------- |
| Environment variables, per canister                                                  | 20          |
| Environment variable name length                                                     | 128         |
| Environment variable value length                                                    | 128         |
...
ICP currently targets a throughput of 2B instructions per thread per second.

## Additional notes

The expiration time of an ingress message is specified by the [agent](/building-apps/interact-with-canisters/agents/overview) making the request and can be up to 5 minutes.
...
More information regarding these restrictions can be found in the [Internet Computer interface specification](/references/ic-interface-spec#system-api-module).
