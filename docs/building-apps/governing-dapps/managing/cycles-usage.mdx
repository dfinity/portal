...
[Learn how to transfer cycles from a wallet to another canister](/docs/current/building-apps/managing-dapps/topping-up#option-2-if-you-have-cycles-on-your-cycles-wallet) (which can be a dapp or SNS canister).
