...
For instructions on how to install the ICRC-1 Ledger, follow [ICRC-1 Ledger Deployment](/docs/current/defi/token-ledgers/setup/icrc1_ledger_setup).
For instructions on how to interact with the ICRC-1 Ledger, follow [ICRC-1 Ledger Interaction](/docs/current/defi/token-indexes/).
