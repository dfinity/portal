...
<input type="checkbox"/> <a href="/docs/current/building-apps/developer-tools/ic-admin">Download and install <code>ic-admin</code>.</a>
<div>
</div>
...
One example of a special permission might be the ability to change the frontend canister content on their own. You can review the [SNS asset canister](/docs/current/building-apps/governing-dapps/managing/sns-asset-canister) documentation for more details.
