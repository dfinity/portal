...
- Moving from `<canister-id>.icp0.io` to a [custom domain](/docs/current/building-apps/dapp-frontends/custom-domains/using-custom-domains/).
...
For more information, see the [Internet Identity specification](/docs/current/specifications/ii-spec/#alternative-frontend-origins).
