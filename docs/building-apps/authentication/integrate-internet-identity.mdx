...
https://github.com/dfinity/examples/blob/arshavir/fix-ii-docs/motoko/who_am_i/dfx.json
```
...
https://github.com/dfinity/examples/blob/arshavir/fix-ii-docs/motoko/who_am_i/internet_identity_app_backend/app.mo
```
...
https://github.com/dfinity/examples/blob/arshavir/fix-ii-docs/motoko/who_am_i/internet_identity_app_frontend/src/App.jsx
```
