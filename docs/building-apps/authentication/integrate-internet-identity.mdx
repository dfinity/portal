...
https://github.com/dfinity/examples/tree/master/motoko/who_am_i/internet_identity_app_backend/app.mo
```
...
https://github.com/dfinity/examples/tree/master/motoko/who_am_i/internet_identity_app_frontend/src/App.jsx
```
