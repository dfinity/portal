...
You may either [create a new project](/docs/building-apps/developer-tools/dfx/dfx-new) or open an existing project.
...
:::info
To use a Rust backend canister, pass `--type=rust` instead.
:::
...
title="src/internet_identity_app_backend/main.mo"
...
title="src/internet_identity_app_frontend/src/App.jsx"
...
Make sure you have a [local development environment](/docs/building-apps/developer-tools/dfx/dfx-start):
