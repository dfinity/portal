...
Then a **service consumer** can pull the canister as a dependency directly from the mainnet using [`dfx deps`](/docs/current/building-apps/developer-tools/dfx/dfx-deps) and deploy the dependency locally.
