...
[Learn more about cycles wallets](/docs/current/defi/cycles/cycles-wallet).

:::

## Resources

- [Defining custom `dfx` networks](/docs/current/building-apps/developer-tools/advanced-dfx/networks-json).

- [Using the playground UI](/docs/current/building-apps/developer-tools/ide/icp-ninja).