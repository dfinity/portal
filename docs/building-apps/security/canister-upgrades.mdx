...
Global timers are deactivated upon changes to the canister's Wasm module. The [IC specification](/references/ic-interface-spec#global-timer) states this as follows:
