...
Verify in your CI pipeline that the endpoints a canister's WASM exports are legitimate and as intended. [ic-wasm can be used for that purpose](https://github.com/dfinity/ic-wasm/blob/main/README.md#check-endpoints).
