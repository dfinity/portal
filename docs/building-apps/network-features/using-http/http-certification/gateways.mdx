...
Additional details can be found in the [HTTP gateway specification](/docs/references/http-gateway-protocol-spec).
...
- [HTTP gateway specification](https://internetcomputer.org/docs/references/http-gateway-protocol-spec)
