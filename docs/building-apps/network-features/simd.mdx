...
ICP provides the `ic0.performance_counter` [system API call](https://internetcomputer.org/docs/references/ic-interface-spec#system-api-performance-counter) to measure a canister's performance.
