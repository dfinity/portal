...
Because of those limitations, in most cases, the CDK timers library for [Rust](https://crates.io/crates/ic-cdk-timers) or [Motoko](/docs/motoko/main/writing-motoko/timers) is a better option to schedule periodic tasks.
...
- **Motoko developer guide:** [Timers](/docs/motoko/main/writing-motoko/timers).
- **Motoko developer guide:** [Heartbeats](/docs/motoko/main/writing-motoko/heartbeats).

### Tutorials and examples using Rust

- **Backend tutorial:** [Using timers](/docs/building-apps/developer-tools/cdks/rust/intro-to-rust).
