...
```motoko no-repl reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/motoko/threshold-schnorr/src/schnorr_example_motoko/main.mo#L60-L83
```
...
```rust reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/rust/threshold-schnorr/src/schnorr_example_rust/src/wasm_only.rs#L94-L138
```
...
```js reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/motoko/threshold-schnorr/test.sh#L56-L104
```
...
```rust reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/rust/threshold-schnorr/src/schnorr_example_rust/src/wasm_only.rs#L141-L248
```
...
```js reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/motoko/threshold-schnorr/test.sh#L25-L44
```

</TabItem>
<TabItem value="rust" label="Rust">

```rust reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/rust/threshold-schnorr/src/schnorr_example_rust/src/wasm_only.rs#L141-L168
```
...
```motoko no-repl reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/motoko/threshold-schnorr/src/schnorr_example_motoko/main.mo#L44-L58
```
...
```rust reference https://github.com/dfinity/examples/blob/013d77e0e12aafaabb8137b910bbc1acce66f1f7/rust/threshold-schnorr/src/schnorr_example_rust/src/wasm_only.rs#L76-L91
```
