...
[Learn more about threshold ECDSA costs](/references/t-sigs-how-it-works).
...
For online derivation, ICP provides the `ecdsa_public_key` method to obtain public keys. This method uses the following Candid interface:
...
- [Chain-key ECDSA signatures: technology overview](/references/t-sigs-how-it-works/).
