...
The full specification of the vetKD APIs can be found in the [vetKD specification PR](https://internetcomputer.org/docs/references/ic-interface-spec#ic-vetkd_public_key).
