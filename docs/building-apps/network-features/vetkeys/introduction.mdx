...
- **Threshold**: vetKeys are derived in a distributed manner, requiring a contribution of a threshold of nodes in a subnet. No single node ever sees the derived vetKeys, ensuring that no central authority can derive or reconstruct them.
...
## [Externally verifiable randomness](/docs/building-apps/network-features/vetkeys/verifiable-randomness)
