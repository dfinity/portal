...
For reference, see the [default `KeyManager` canister implementation](https://github.com/dfinity/vetkd-devkit/blob/3b1de5d546dcc32daaf22b21baaa2b220bc857f3/backend/rs/canisters/ic_vetkeys_manager_canister/src/lib.rs).
...
For an example implementation, see [`DefaultKeyManagerClient`](https://github.com/dfinity/vetkd-devkit/blob/3b1de5d546dcc32daaf22b21baaa2b220bc857f3/frontend/ic_vetkeys/src/key_manager/key_manager_canister.ts), which connects the frontend logic to the canister APIs.
