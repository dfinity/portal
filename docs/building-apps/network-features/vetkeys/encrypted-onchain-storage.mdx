...
Encrypted onchain storage is an abstraction for data encryption using vetKeys. it builds on top of [decentralized key management service](/docs/building-apps/network-features/vetkeys/dkms).
...
https://github.com/dfinity/vetkeys/blob/3b1de5d546dcc32daaf22b21baaa2b220bc857f3/backend/rs/canisters/ic_vetkeys_encrypted_maps_canister/src/lib.rs#L1-L18
```
...
```rust no-repl reference
https://github.com/dfinity/vetkeys/blob/3b1de5d546dcc32daaf22b21baaa2b220bc857f3/backend/rs/canisters/ic_vetkeys_encrypted_maps_canister/src/lib.rs#L196-L208
```
...
https://github.com/dfinity/vetkeys/blob/3b1de5d546dcc32daaf22b21baaa2b220bc857f3/frontend/ic_vetkeys/src/encrypted_maps/encrypted_maps_canister.ts#L100-L107
```
