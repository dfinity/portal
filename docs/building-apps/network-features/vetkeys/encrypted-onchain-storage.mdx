...
Encrypted onchain storage is implemented in the `EncryptedMaps` library, which offers vetKey derivation and access control over vetKeys and encrypted data.
