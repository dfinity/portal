...
:::info
The returned derivation origin is subject to verification via `.well-known/ii-alternative-origins`, as described in the [feature description](https://internetcomputer.org/docs/references/ii-spec#alternative-frontend-origins).
:::
...
For example, when using [canister signatures](https://internetcomputer.org/docs/references/ic-interface-spec#canister-signatures)
