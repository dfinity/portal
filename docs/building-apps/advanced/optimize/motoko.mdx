...
Each optimization preserves the [Internet Computer](https://learn.internetcomputer.org/hc/en-us/articles/33152818663444-What-is-ICP) specific metadata sections of each canister.
