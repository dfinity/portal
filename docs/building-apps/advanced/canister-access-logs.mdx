...
| `request_type`         | Type of IC request: `query`, `call`, `sync_call`, or `read_state` (see the [interface spec](/references/ic-interface-spec#http-interface) for more information).                                  |
