...
For more information on end-to-end tests, check out the [developer liftoff module on testing](/docs/current/tutorials/developer-liftoff/level-2/2.5-unit-testing#end-to-end-e2e-testing).
...
[Learn more about PocketIC](/docs/building-apps/advanced/test/pocket-ic).
