...
[Internet Computer](https://learn.internetcomputer.org/hc/en-us/articles/33152818663444-What-is-ICP) or the local canister execution environment. In most cases, you use `dfx canister` subcommands after
