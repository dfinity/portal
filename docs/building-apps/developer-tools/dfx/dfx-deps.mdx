...
[Learn how to configure a canister as `pullable`](/docs/building-apps/interact-with-canisters/using-third-party-canisterss/using-third-party-canisters).
...
For testing, you may want to pull from local development environment, then run:
...
You can use the `dfx deps deploy` command to deploy dependencies on local development environment.
