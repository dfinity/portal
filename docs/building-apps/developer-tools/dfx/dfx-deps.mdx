...
[Learn how to configure a canister as `pullable`](https://internetcomputer.org/docs/building-apps/interact-with-canisters/using-third-party-canisterss/using-third-party-canisters).
