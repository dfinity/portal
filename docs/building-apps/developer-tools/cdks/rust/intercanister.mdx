...
:::note
The Internet Computer supports two types of calls: bounded- and unbounded-wait calls. We will demonstrate both in this tutorial, but in general, we recommend to use bounded-wait calls wherever possible for scalability and robustness reasons.
:::
