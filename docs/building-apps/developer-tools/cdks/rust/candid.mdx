...
For additional information on the type mapping between Candid and Rust, you can consult the [supported types](/docs/current/specifications/candid-ref) reference section.
