...
To see details about the Candid interface description language syntax, see the [*Candid Guide*](/docs/current/building-apps/calling-dapps/candid/candid-concepts) or the [Candid crate documentation](https://docs.rs/candid/).
...
For more information on Candid and to see the Rust equivalent of Candid types, please see the [Candid reference documentation](/docs/current/specifications/candid-ref).
