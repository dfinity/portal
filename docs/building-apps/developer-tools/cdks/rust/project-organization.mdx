...
To see details about the Candid interface description language syntax, see the [*Candid Guide*](/docs/building-apps/interact-with-canisters/candid/candid-concepts) or the [Candid crate documentation](https://docs.rs/candid/).
...
For more information on Candid and to see the Rust equivalent of Candid types, please see the [Candid reference documentation](/docs/references/candid-ref).
