...
Using the `canister_inspect_message` endpoint, the canister can invoke `ic0.accept_message : () → ()` to accept the message. You can learn more in the [IC interface specification](/references/ic-interface-spec#ingress-message-inspection).
