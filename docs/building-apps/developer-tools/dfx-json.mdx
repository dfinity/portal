...
[Learn more about custom network definitions and configurations](/docs/current/building-apps/developer-tools/advanced-dfx/networks-json).
...
There are several workflow-specific `dfx.json` configuration options detailed in the full [`dfx.json` schema](/docs/current/building-apps/developer-tools/dfx-json-reference).
