...
- [Canpack](/docs/building-apps/developer-tools/canpack): A tool used to facilitate communication between canisters written in different languages; currently supports calling Rust crates from Motoko canisters.
...
- [Developer container documentation](/docs/building-apps/developer-tools/ide/dev-containers).
...
- [VS Code documentation](/docs/building-apps/developer-tools/ide/vs-code).
