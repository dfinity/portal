...
The transaction fees in the Bitcoin network change dynamically based on the number of pending transactions. In order to get fee percentiles of the last 10,000 transactions mined into blocks, call `bitcoin_get_current_fee_percentiles`.
