---
keywords: [advanced, bitcoin, tutorial, btc]
---
...
- #### Step 2: Unpack the `.tar.gz` file: `tar -xf bitcoin-27.0-arm64-apple-darwin.tar.gz`. On MacOS, don't double click to unpack, use the command mentioned.
...
showcases how your canister can generate a P2PKH address using the [ecdsa_public_key](/docs/current/references/ic-interface-spec#ic-ecdsa_public_key) API.
