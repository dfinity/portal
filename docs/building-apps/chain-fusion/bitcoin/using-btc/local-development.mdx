...
For more details on how the `send_from_${type}` endpoints work, see the [deploying your first Bitcoin dapp](https://github.com/dfinity/examples/tree/master/rust/basic_bitcoin) tutorial.
