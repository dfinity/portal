...
the [Bitcoin API](/docs/references/ic-interface-spec#ic-bitcoin-api) so that you can locally test out your Bitcoin dapp before deploying it to the Internet Computer.
