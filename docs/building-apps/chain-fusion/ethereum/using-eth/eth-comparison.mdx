...
| Node           | Replica  |       |
| Account        | Principal |       |
| DAO            | SNS       | An SNS refers to a DAO using ICP's [unique framework](/docs/building-apps/governing-apps/overview) However, ICP DAOs can launch without using this framework.|
