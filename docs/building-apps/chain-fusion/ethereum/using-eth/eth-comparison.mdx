...
For a feature comparison between the two protocols, refer to the [quick comparison between ICP and Ethereum](/docs/concepts/network-overview#quick-comparison-with-ethereum).
...
| Node           | Replica  |       |
| Account        | Principal |       |
| DAO            | SNS       | An SNS refers to a DAO using ICP's [unique framework](/docs/building-apps/governing-apps/) However, ICP DAOs can launch without using this framework.|
