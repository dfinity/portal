...
Run the following command to generate the correct [Candid](/building-apps/interact-with-canisters/candid/candid-concepts) type definitions:
...
Or, you can deploy directly on the mainnet. Deploying to the mainnet will cost [cycles](/building-apps/getting-started/tokens-and-cycles).
