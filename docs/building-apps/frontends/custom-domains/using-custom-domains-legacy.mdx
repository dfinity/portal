...
# Deprecated: Using custom domains

:::caution

These docs are only meant as a reference for users of the previous custom domains service. For all new domain registrations, please follow the docs of the new, revamped custom domains service [here](./using-custom-domains.mdx).
