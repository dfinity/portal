...
```motoko no-repl file=../../../../specifications/samples/motoko/send_http_post/src/send_http_post_backend/main.mo
```

</TabItem>
<TabItem value="rust" label="Rust">

```rust file=../../../../specifications/samples/rust/send_http_post/src/send_http_post_backend/src/lib.rs
```


To use HTTPS outcalls, you must update the canister's Candid file:

```candid file=../../../../specifications/samples/rust/send_http_post/src/send_http_post_backend/send_http_post_backend.did
```

Update the `Cargo.toml` file to use the correct dependencies:

```toml file=../../../../specifications/samples/rust/send_http_post/src/send_http_post_backend/Cargo.toml
```
