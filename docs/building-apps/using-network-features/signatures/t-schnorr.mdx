...
The `sign_with_schnorr` method requires cycles to be attached. [Learn more about threshold Schnorr costs](/docs/current/concepts/gas-cost).
...
- [Threshold Schnorr API](https://internetcomputer.org/docs/current/specifications/ic-interface-spec#ic-schnorr_public_key).
