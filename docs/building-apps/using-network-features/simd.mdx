...
ICP provides the `ic0.performance_counter` [system API call](https://internetcomputer.org/docs/current/specifications/ic-interface-spec#system-api-performance-counter) to measure a canister's performance.
