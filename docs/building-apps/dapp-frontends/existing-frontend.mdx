...
Run the following command to generate the correct [Candid](/docs/current/building-apps/calling-dapps/candid/candid-concepts) type definitions:
...
Or, you can deploy directly on the mainnet. Deploying to the mainnet will cost [cycles](/docs/current/building-apps/getting-started/tokens-and-cycles).
