...
In addition to testing the launch, before requesting an SNS launch in production, developers are strongly encouraged to ensure that all operations for maintaining and evolving the dapp can be done via SNS proposals.
