...
Use the [SNS Tokenomics Analyzer](https://dashboard.internetcomputer.org/sns/tokenomics) to analyze the tokenomics and the resulting voting power distribution.
...
Developers can choose to integrate a frontend for the SNS functionality in the dapp. A good example of a useful integration is SNS proposal voting. This allows neuron holders to vote on proposals directly in the dapp frontend. Integrations should be tested thoroughly, for example by [local testing](https://github.com/dfinity/sns-testing).
