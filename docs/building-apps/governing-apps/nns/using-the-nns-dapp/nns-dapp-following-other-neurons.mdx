...
[Following](https://learn.internetcomputer.org/hc/en-us/articles/34084120668692-NNS-Neurons). For information about how you
can become a neuron that can be followed, we refer to [Registering a known neuron](/building-apps/governing-apps/nns/concepts/neurons/becoming-a-known-neuron).
