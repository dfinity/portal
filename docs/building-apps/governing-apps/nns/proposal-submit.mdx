...
(/docs/building-apps/governing-apps/nns/concepts/neurons/becoming-a-known-neuron).
...
Neurons with at least 25 ICP and 6 months of dissolve delay can submit NNS proposals. Therefore, the first step is to create such a neuron.
...
You should send at least 25.001 in order to have enough ICP to create a neuron and pay for the ledger transaction fees.
...
// Note: you need to stake at LEAST 25 ICP to send proposals as $AMOUNT
