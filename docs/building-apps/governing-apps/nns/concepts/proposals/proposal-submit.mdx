...
You can find another example for how to submit a proposal on [registering a known neuron](/building-apps/governing-apps/nns/concepts/neurons/becoming-a-known-neuron).
...
[Learn more about dfx identities](/building-apps/getting-started/identities).
