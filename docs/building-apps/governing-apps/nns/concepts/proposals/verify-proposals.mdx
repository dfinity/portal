...
* For updates to the [Internet Identity (II)](/building-apps/authentication/overview) canister, you can find the code in [the II repository](https://github.com/dfinity/internet-identity).
