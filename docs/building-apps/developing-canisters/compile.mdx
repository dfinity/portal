...
After you have [created a canister](create.mdx), you need to compile its code into a WebAssembly module then [install it](install.mdx) into the canister before it can be deployed.
