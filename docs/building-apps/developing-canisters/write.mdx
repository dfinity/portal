...
The [HTTP Gateway protocol](/references/http-gateway-protocol-spec) of ICP allows browsers to load web assets, such as JS, HTML, and CSS, from a canister via HTTP.
This means that [web assets can be stored fully onchain](/building-apps/frontends/using-an-asset-canister).
...
Using a frontend stored off-chain or having no frontend at all are also valid options for applications. [Learn more](/building-apps/frontends/using-an-asset-canister).
