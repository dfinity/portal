...
[Learn more about cycles wallets](/docs/defi/cycles/cycles-wallet).

:::

## Resources

- [Defining custom `dfx` networks](/docs/building-apps/developer-tools/advanced-dfx/networks-json).

- [Using the playground UI](/docs/building-apps/developer-tools/ide/icp-ninja).