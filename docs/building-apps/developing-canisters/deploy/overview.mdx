...
<input type="checkbox"/> <a href="/docs/building-apps/developing-canisters/what-are-canisters">Write code.</a>
<div>
</div>
<input type="checkbox"/> <a href="/docs/building-apps/developing-canisters/what-are-canisters">Create your canister.</a> Optional: <code>dfx deploy</code> will execute this step if not already complete.
<div>
</div>
<input type="checkbox"/> <a href="/docs/building-apps/developing-canisters/what-are-canisters">Compile your canister code into Wasm.</a> Optional: <code>dfx deploy</code> will execute this step if not already complete.
<div>
</div>
<input type="checkbox"/> <a href="/docs/building-apps/developing-canisters/what-are-canisters">Install the Wasm module into your canister.</a> Optional: <code>dfx deploy</code> will execute this step if not already complete.
</TabItem>
</Tabs>
