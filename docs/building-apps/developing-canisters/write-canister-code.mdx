...
1. Onchain randomness will be used to generate a number between 133000 and 133255. This number will be used to select a recent [NNS proposal]((/docs/move-to-learnhub/nns/overview) at random.
