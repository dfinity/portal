...
| Cannot call other canisters | Can call canisters on another [subnet](https://learn.internetcomputer.org/hc/en-us/articles/34209955782420-Subnet-Creation) | Cannot call canisters on another subnet |
