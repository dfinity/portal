...
You can learn more about the Candid UI in [using Candid](/building-apps/interact-with-canisters/candid/using-candid#interact-with-a-service-from-a-browser).
