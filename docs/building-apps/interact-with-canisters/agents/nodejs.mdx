...
This test is written for the [default backend canister](/docs/building-apps/developing-canisters/what-is-a-canister).

To run this test, you will need to deploy your project and generate the necessary declarations for your canister. [Learn more about creating and deploying a project](https://internetcomputer.org/docs/tutorials/developer-journey/level-2/2.5-unit-testing#end-to-end-e2e-testing).
...
Learn more about [testing](/docs/tutorials/developer-journey/level-2/2.5-unit-testing) with an agent and [view a more complex test example](/docs/tutorials/developer-journey/level-2/2.5-unit-testing#end-to-end-e2e-testing).
...
- [End-to-end testing](https://internetcomputer.org/docs/tutorials/developer-journey/level-2/2.5-unit-testing#end-to-end-e2e-testing)