...
This test is written for the [default backend canister](/building-apps/essentials/canisters).

To run this test, you will need to deploy your project and generate the necessary declarations for your canister. [Learn more about creating and deploying a project](/tutorials/developer-liftoff/level-2/2.5-unit-testing#end-to-end-e2e-testing).
...
Learn more about [testing](/tutorials/developer-liftoff/level-2/2.5-unit-testing) with an agent and [view a more complex test example](/tutorials/developer-liftoff/level-2/2.5-unit-testing#end-to-end-e2e-testing).
...
- [ICP JavaScript agent developer docs](/building-apps/interact-with-canisters/agents/javascript-agent)
...
- [End-to-end testing](/tutorials/developer-liftoff/level-2/2.5-unit-testing#end-to-end-e2e-testing)
