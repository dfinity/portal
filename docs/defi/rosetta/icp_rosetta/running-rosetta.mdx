...
:::info
To get `TESTICP` tokens for testing, you can use the faucet [here](https://faucet.internetcomputer.org/). This provides test tokens without needing to use real ICP.
:::
