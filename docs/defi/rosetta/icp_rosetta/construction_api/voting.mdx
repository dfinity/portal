...
You can get a [list](/docs/current/defi/rosetta/icp_rosetta/data_api/) of publicly known neurons through the `DATA-API`.
...
First you will need to know which proposals [currently exist on the NNS](/docs/current/defi/rosetta/icp_rosetta/data_api/).
If you already know the proposal ID you want to vote on, you can also [fetch](/docs/current/defi/rosetta/icp_rosetta/data_api/) the information about the proposal to check that what you are voting on is what you expected.
