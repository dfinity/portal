...
For testing and development, you can connect to the TICRC1 test token (`3jkp5-oyaaa-aaaaj-azwqa-cai`) that runs on mainnet but uses test tokens. To get free TICRC1 for testing, you can use the faucet [here](https://faucet.internetcomputer.org).
...
- **TICRC1** tokens: [ICRC1 faucet](https://faucet.internetcomputer.org) for testing ICRC-1 functionality.
- **TESTICP** tokens: [ICP faucet](https://faucet.internetcomputer.org/) for testing ICP Rosetta.
