...
Use [the faucet](https://faucet.internetcomputer.org) to get test tokens. There are two test tokens available:

- **TICRC1** tokens for testing ICRC-1 functionality
- **TESTICP** tokens for testing ICP-specific functionality
