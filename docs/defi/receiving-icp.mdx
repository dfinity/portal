...
However, a canister can actually have upto 2^256 different accounts, each with their own balance!
This is especially useful in dapps to preserve privacy and to segregate funds of users.
