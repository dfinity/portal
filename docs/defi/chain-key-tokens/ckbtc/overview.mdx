...
Chain-key Bitcoin (ckBTC) is an [ICRC-1](https://github.com/dfinity/ICRC-1/blob/main/standards/ICRC-1/README.md) and [ICRC-2](https://github.com/dfinity/ICRC-1/blob/main/standards/ICRC-2/README.md) compliant synthetic twin token that is backed 1:1 by BTC.
...
| [Checker](https://github.com/dfinity/ic/tree/master/rs/bitcoin/checker)             | [oltsj-fqaaa-aaaar-qal5q-cai](https://dashboard.internetcomputer.org/canister/oltsj-fqaaa-aaaar-qal5q-cai) | [o6ude-eyaaa-aaaar-qal6a-cai](https://dashboard.internetcomputer.org/canister/o6ude-eyaaa-aaaar-qal6a-cai) |
...
| [Archive](https://github.com/dfinity/ic/tree/master/rs/ledger_suite/icrc1/archive)  | [nbsys-saaaa-aaaar-qaaga-cai](https://dashboard.internetcomputer.org/canister/nbsys-saaaa-aaaar-qaaga-cai) | [m62lf-ryaaa-aaaar-qaacq-cai](https://dashboard.internetcomputer.org/canister/m62lf-ryaaa-aaaar-qaacq-cai) |
...
To simplify access to the transaction history of the ledger, a dedicated [index canister](/defi/token-indexes) is deployed.
...
**Note:** Before ckBTC is is minted to the user, the ckBTC minter performs a check for the Bitcoin address which transferred the bitcoins. A detailed description of the whole process can be found on the [Wiki](https://wiki.internetcomputer.org/wiki/Chain-key_Bitcoin).
...
- [Archive](https://github.com/dfinity/ic/tree/master/rs/ledger_suite/icrc1/archive) Canister that holds archived ledger transactions.
...
- [ckBTC API reference](/references/ckbtc-reference)
- [Bitcoin integration: technology overview](/references/bitcoin-how-it-works)
- [Chain-key tokens](https://learn.internetcomputer.org/hc/en-us/articles/34211397080980-Chain-Key-Tokens)
- [Developer Liftoff: ckBTC and Bitcoin integration](/tutorials/developer-liftoff/level-4/4.3-ckbtc-and-bitcoin)
...
- [How ckBTC Solves the Dilemma of Blockchain Bridges](https://medium.com/dfinity/how-ckbtc-solves-the-dilemma-of-blockchain-bridges-ee8e0b72ee59)
...
- [ckBTC Sparks a New Era on the Internet Computer](https://medium.com/dfinity/ckbtc-sparks-a-new-era-on-the-internet-computer-86463a7be20f)

### Videos

- [Introduction to Bitcoin Integration](https://www.youtube.com/watch?v=TwOEEBtNjzU&t=2856s)
- [How to use ICP as a Bitcoin L2](https://www.youtube.com/watch?v=FKvpar9U6wM&t=2869s)
- [All about ckBTC](https://www.youtube.com/watch?v=cBZlTX818L8) DFINITY Twitter Space.