...
Learn more in the [Bitcoin integration technical overview](/docs/current/specifications/bitcoin-how-it-works).
...
- [Bitcoin point of sale app](/docs/current/specifications/samples/motoko/ic-pos/).

## Further reading

- [ckBTC API reference](/docs/current/specifications/ckbtc-reference).

- [Bitcoin integration: technology overview](/docs/current/specifications/bitcoin-how-it-works).
...
- [Local development workflow](/docs/current/building-apps/chain-fusion/bitcoin/using-btc/local-development).

- [Developer ladder: ckBTC and Bitcoin integration](/docs/current/tutorials/developer-journey/level-4/4.3-ckbtc-and-bitcoin).
