...
You can deploy the ICRC-1 ledger locally for testing. [Learn more in the ICRC-1 ledger setup documentation](/docs/current/defi/token-ledgers/setup/icrc1_ledger_setup).
