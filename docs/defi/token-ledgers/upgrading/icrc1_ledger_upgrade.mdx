...
Before performing the actual upgrade in production, consider taking a [snapshot](/current/developer-docs/smart-contracts/maintain/snapshots) of the canister so that it can be restored in case of issues.
