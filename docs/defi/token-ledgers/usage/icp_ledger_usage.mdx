...
View the [inter-canister call documentation] (/docs/building-apps/developer-tools/cdks/rust/intro-to-rust) to see how you can call one canister from within another.
