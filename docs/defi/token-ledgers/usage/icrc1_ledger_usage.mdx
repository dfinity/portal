...
View the [`dfx canister call` documentation](/docs/current/building-apps/developer-tools/dfx/dfx-canister#dfx-canister-call) for more information on calling canister methods.
