...
For detailed information about the exchange rate canister's API, supported assets, and advanced features, see the [reference documentation](/references/system-canisters/xrc.mdx).

## Quickstart

### 1. Deploy the example project

- Clone the [Fetching Exchange Rates](https://icp.ninja/projects/fetching-exchange-rates) project from ICP Ninja.
