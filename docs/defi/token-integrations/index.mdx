...
:::info
The Rosetta node should run within the trust domain of an integrator. [Validation Cloud](https://www.validationcloud.io/icp) offers managed ICP Rosetta endpoints that you can use for learning, development, and production.
:::
