...
The [controller <GlossaryTooltip>principal</GlossaryTooltip>](/docs/building-apps/canister-management/topping-up#controller-and-custodian-roles) of the archive canisters.
