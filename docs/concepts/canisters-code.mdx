---
keywords: [concept, canister, code, smart contracts]
---
...
For more detailed information about the Motoko programming language itself, including syntactical conventions and supported features, see the [**Motoko programming language guide**](/docs/current/motoko/getting-started/motoko-introduction).

For information about Canister Development Kits (CDKs) supporting other programming languages, see this [**overview**](/docs/current/developer-docs/smart-contracts/write/overview).
