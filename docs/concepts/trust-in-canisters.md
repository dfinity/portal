...
Additionally, developers can utilize the [canister history](/docs/current/production/canister-history.md) feature to track changes to the canister's Wasm module hash. 
