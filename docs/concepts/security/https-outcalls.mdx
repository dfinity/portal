...
[More information.](/docs/current/specifications/https-outcalls-how-it-works#compromised-replicas)

[Data confidentiality security recommendations.](/docs/current/concepts/security/misc#data-confidentiality-on-the-internet-computer)
...
[More information.](/docs/current/specifications/https-outcalls-how-it-works#rate-limiting-by-servers)
...
[More information.](/docs/current/specifications/https-outcalls-how-it-works#post-requests-must-be-idempotent)
...
[More information.](/docs/current/specifications/https-outcalls-how-it-works#responses-must-be-similar)

## Be aware of HTTP request and response sizes

### Security concern

The [pricing](/docs/current/specifications/https-outcalls-how-it-works#pricing) of HTTPS outcalls is determined by the size of the HTTP request and the maximal response size, among other variables. Thus, if big requests are made, this could quickly drain the canister’s cycles balance. This can be risky in scenarios where HTTPS outcalls are triggered by user actions (rather than a heartbeat or timer invocation).
...
[More information.](/docs/current/specifications/https-outcalls-how-it-works#recipe-for-coding-a-canister-http-call)
