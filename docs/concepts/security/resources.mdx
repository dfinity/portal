...
## Testing
These are some useful specifications for testing canisters which don't necessarily relate to security. However, having good test coverage is essential for developing secure applications.
...
* Consider [PocketIC](/docs/current/building-apps/creating-dapps/test/pocket-ic) for canister testing
