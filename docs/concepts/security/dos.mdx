...
Learn more about managing memory and compute resources in the [storage](https://internetcomputer.org/docs/current/concepts/gas-cost) and [compute](https://internetcomputer.org/docs/current/concepts/gas-cost) guides.
