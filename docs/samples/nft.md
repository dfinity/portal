...
The Internet Computer employs [Orthogonal Persistence](../motoko/official/motoko.md#orthogonal-persistence), so developers generally do not need to think a lot about storing their data.
