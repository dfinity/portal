...
- [Pending proposals](/docs/developer-docs/defi/rosetta/icp_rosetta/data_api/get_pending_proposals.md): Fetch a list of all currently pending proposals on the NNS.
