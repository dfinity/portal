...
```
Alternatively, a user can querd the `/block` or `block/transaction` endpoints to see whether the transaction has been included in the blockchain of the ICP ledger. 
