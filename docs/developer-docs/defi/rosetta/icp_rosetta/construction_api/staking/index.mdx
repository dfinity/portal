...
This tutorial also assumes that you are familiar with the concept of staking on the NNS in general. To read up on how staking conceptionally works on the Internet Computer Protocol
