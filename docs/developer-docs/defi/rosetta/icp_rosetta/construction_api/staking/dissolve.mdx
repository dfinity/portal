...
def main():
    ...
    start_dissolving_ops = start_dissolving_operation(client.construction_derive()["account_identifier"]["address"])
    neuron_info_ops = neuron_info_operation(client.construction_derive()["account_identifier"]["address"])
    print(json.dumps(client.make_and_submit_transaction([start_dissolving_ops]),indent=4))
    print(json.dumps(client.make_and_submit_transaction([neuron_info_ops]),indent=4))
    
    stop_dissolving_ops = stop_dissolving_operation(client.construction_derive()["account_identifier"]["address"])
    print(json.dumps(client.make_and_submit_transaction([stop_dissolving_ops]),indent=4))
    print(json.dumps(client.make_and_submit_transaction([neuron_info_ops]),indent=4))
