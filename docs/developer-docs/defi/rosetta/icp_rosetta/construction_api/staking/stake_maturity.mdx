...
ICP. To do the latter you will have to stake your maturity. You can set how much of the existing maturity you want to stake. In this example command we want to stake the entire maturity (100%). 
