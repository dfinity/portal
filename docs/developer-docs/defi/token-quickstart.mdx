...
To create a token, you will export several environmental variables. The full list can be found below:
...
Start by specifying the token name and symbol of your choice:
...
Set the identity you want to deploy the ledger:
...
To be able to interact and send some tokens you may want to mint some tokens when you deploy the ledger. This is optional.

You will mint some tokens for the default identity. You can also specify the transfer fee for transferring tokens.
...
The values used in this example are the recommended values. You may change them to fit your ICRC-1 ledger's needs.
