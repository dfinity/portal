...
To create an NFT collection, it is recommended to use the ICRC-7 and ICRC-37 standards.
...
- [ICRC-37](https://github.com/dfinity/ICRC/tree/main/ICRCs/ICRC-37): An extension of ICRC-7 that enables an `approve` workflow.
...
### Step 8: Query info about the minted tokens.
...
https://github.com/PanIndustrial-Org/icrc_nft.mo.git
