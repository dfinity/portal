...
For reference on the different standards for these ledger, you can find the relevant documentation [here](/docs/developer-docs/defi/tokens/token-standards.mdx). 
