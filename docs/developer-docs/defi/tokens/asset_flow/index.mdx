...
For reference on what an ICP and ICRC-1 ledgers are, please read the [documentation](/docs/current/developer-docs/defi/tokens/ledger/overview.mdx) on them. 
For reference on the different standards for these ledger, you can find the relevant documentation [here](/docs/current/developer-docs/defi/tokens/ledger/token-standards.mdx). 
