...
Go to the [releases overview](https://dashboard.internetcomputer.org/releases) and copy the latest <GlossaryTooltip>replica</GlossaryTooltip> binary revision (IC_VERSION). At the time of writing, this is `b9a0f18dd5d6019e3241f205de797bca0d9cc3f8`.
