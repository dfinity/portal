...
```
curl -o index.did "https://raw.githubusercontent.com/dfinity/ic/aba60ffbc46acfc8990bf4d5685c1360bd7026b9/rs/rosetta-api/icp_ledger/index/index.did"
```
...
The URL for the ICRC-1 index Candid file is `https://download.dfinity.systems/ic/aba60ffbc46acfc8990bf4d5685c1360bd7026b9/canisters/ic-icrc1-index-ng.wasm.gz`, so with the above revision it would be `https://raw.githubusercontent.com/dfinity/ic/aba60ffbc46acfc8990bf4d5685c1360bd7026b9/rs/rosetta-api/icrc1/index-ng/index-ng.did`.


To download this Candid file using curl, run the command:

```
curl -o index.did "https://raw.githubusercontent.com/dfinity/ic/aba60ffbc46acfc8990bf4d5685c1360bd7026b9/rs/rosetta-api/icrc1/index-ng/index-ng.did"
```
