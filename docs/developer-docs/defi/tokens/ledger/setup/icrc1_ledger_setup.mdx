...
If you don’t have the IC SDK installed, follow instructions on the [installing the IC SDK](/docs/developer-docs/getting-started/install/) section to install it.
