...
There are dapps that can help you convert ICP to cycles and create a new cycles wallet, e.g., [NNS dapp](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-app-quickstart#_deploy_a_canister_with_cycles).
...
For more details, see the [dfx wallet reference](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-wallet).
