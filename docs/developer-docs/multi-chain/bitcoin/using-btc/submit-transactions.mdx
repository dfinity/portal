...
Replace `CANISTER_NAME` with your canister's name and replace `ADDRESS` with the destination Bitcoin address. [Learn more about Bitcoin addresses.](/docs/current/developer-docs/multi-chain/generating-addresses)
