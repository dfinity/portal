...
Canisters can sign transactions form addresses using ECDSA by using the
`sign_with_ecdsa` API.
...
```
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/motoko/basic_bitcoin/src/basic_bitcoin/src/BitcoinWallet.mo#L161">
...
```
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/rust/basic_bitcoin/src/basic_bitcoin/src/bitcoin_wallet/p2pkh.rs#L165">
    <div align="center">View in the full example.</div>
</a>
</TabItem>
</Tabs>
...
```
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/rust/basic_bitcoin/src/basic_bitcoin/src/bitcoin_wallet/p2tr_raw_key_spend.rs#L155">
    <div align="center">View in the full example.</div>
</a>
</TabItem>
</Tabs>
...
```
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/rust/basic_bitcoin/src/basic_bitcoin/src/bitcoin_wallet/p2tr_script_spend.rs#L207">
    <div align="center">View in the full example.</div>
</a>
</TabItem>
</Tabs>
...
[Learn more about using the threshold ECDSA signing
API](/docs/current/developer-docs/smart-contracts/signatures/t-ecdsa).

[Learn more about using the threshold Schnorr signing
API](/docs/current/developer-docs/smart-contracts/signatures/t-schnorr).
