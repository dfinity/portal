...
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/motoko/basic_bitcoin/src/basic_bitcoin/src/BitcoinWallet.mo#L49">
...
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/rust/basic_bitcoin/src/basic_bitcoin/src/bitcoin_wallet/p2pkh.rs#L21">
    <div align="center">View in the full example.</div>
</a>
</TabItem>
</Tabs>
...
A Schnor public key can be retrieved using the
...
of both types of addresses, but not addresses that can use both key path and
script path, meaning that an address supporting the key path cannot spend with a
...
key or the signature verification and thus the Bitcoin transaction will fail.
Most libraries will automatically tweak the key when creating a taproot address
by default, so make sure to use the correct function to generate the address as,
for example, shown in the example below.
:::
...
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/rust/basic_bitcoin/src/basic_bitcoin/src/bitcoin_wallet/p2tr_raw_key_spend.rs#L18">
    <div align="center">View in the full example.</div>
</a>
</TabItem>
</Tabs>
...
<a href="https://github.com/dfinity/examples/blob/1d4b8a7d45529f30081d54dfc33a2dd1c39cb22f/rust/basic_bitcoin/src/basic_bitcoin/src/bitcoin_wallet/p2tr_script_spend.rs#L19">
    <div align="center">View in the full example.</div>
</a>
</TabItem>
</Tabs>
...
Learn more about Bitcoin addresses using Schnorr: taproot signatures
[BIP340](https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki),
taproot address construction
[BIP341](https://github.com/bitcoin/bips/blob/master/bip-0341.mediawiki),
spending from taproot addresses
