...
addresses. They encode the hash of a ECDSA public key.
...
SegWit addresses are newer address following the
...
The Basic Bitcoin example demonstrates how to generate a `P2PKH` address from a
