...
To integrate ckBTC into your dapp, you can write code that uses the [ICRC-1 standard](https://github.com/dfinity/ICRC-1/tree/main/standards/ICRC-1). For token transfers and account balances, ckBTC requests must be sent to ICRC-1 ledger canister with principal ID `mxzaz-hqaaa-aaaar-qaada-cai`.
...
You can configure your project to use the ICRC-1 ledger and deploy it locally for local development and testing. [Learn more in the ICRC-1 ledger setup documentation](/docs/current/developer-docs/defi/icrc-1/icrc1-ledger-setup).

Once you have your project configured to use the ICRC-1 ledger by following the [ICRC-1 ledger setup documentation](/docs/current/developer-docs/defi/icrc-1/icrc1-ledger-setup), you can interact with it for workflows such as transferring tokens:
