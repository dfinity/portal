...
Multi-chain is possible through the unique features of ICP: [threshold ECDSA signatures](/docs/current/references/t-ecdsa-how-it-works), chain-key cryptography, and [HTTPS outcalls](/docs/current/references/https-outcalls-how-it-works).
