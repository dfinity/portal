...
a single trusted intermediary, such as a bridge. This is possible through (1) decentralized bi-directional communication of the Internet Computer
with other chains and (2) the ability of ICP smart contracts to sign and submit
...
canister smart contracts, which depend on the honesty of a supermajority of
subnet
...
In the case of direct chain integration, the only trust assumption needed is that a
...
- **[tECDSA signing](/docs/current/references/t-sigs-how-it-works//)**: An ICP
