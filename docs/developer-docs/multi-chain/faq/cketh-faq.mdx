...
1. ckETH complies with the [ICRC-1 ledger token standard](https://internetcomputer.org/docs/current/developer-docs/defi/overview/#icrc-1-ledgers). 
...
Like many ICP canisters, the 

The development and governance of ckETH, the digital twin of ETH on the Internet Computer (ICP), is managed by the ICP ecosystem. 
