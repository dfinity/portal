...
7. **Serve web content**: Canister smart contracts can process HTTPS requests, enabling them to host frontends of dapps, making them directly accessible through web browsers.
