...
1. [ckBTC developer documentation page](https://internetcomputer.org/docs/current/developer-docs/multi-chain/bitcoin/ckbtc/overview): This page provides detailed information about ckBTC, including its functionality and how it works.
...
- [Local development workflow](https://internetcomputer.org/docs/current/developer-docs/integrations/bitcoin/local-development): This page provides a guide on how to set up a local development environment for Bitcoin integration.
