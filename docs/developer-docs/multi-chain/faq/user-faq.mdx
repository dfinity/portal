...
2. You can also check out the [Code ckETH](https://github.com/dfinity/ic/tree/master/rs/ethereum/cketh) and [Code ckBTC](/docs/current/developer-docs/multi-chain/bitcoin/ckbtc/overview) for code samples on how to use these features.
