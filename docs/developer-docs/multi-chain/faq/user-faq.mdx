...
1. ICP canister smart contracts have a lot of functionality that other blockchain smart contracts do not, so this allows developers of other blockchains have access to ICP smart contracts while still writing contracts for some other token or blockchain.
