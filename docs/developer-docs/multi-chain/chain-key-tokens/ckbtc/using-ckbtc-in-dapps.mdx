...
You can deploy the ICRC-1 ledger locally for testing. [Learn more in the ICRC-1 ledger setup documentation](/docs/current/developer-docs/defi/icrc-1/icrc1-ledger-setup).
...
- [Ckbtc Payments & Hrms App](https://ilcnp-myaaa-aaaal-qjdxa-cai.icp0.io/).
