...
Call the [minter helper](https://etherscan.io/address/0x7574eB42cA208A4f6960ECCAfDF186D627dCC175#writeContract) contract's `icrc1_balance_of` function with your principal ID encoded and the amount to convert into ckETH as arguments:
