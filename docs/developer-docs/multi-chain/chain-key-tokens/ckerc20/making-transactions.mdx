...
- Converting ckERC20 to ERC-20
- Converting ERC-20 to ckERC20 tokens
- Receiving ckERC20 tokens
- Sending ckERC20 tokens
- Viewing ckERC20 token transactions
- Integrate ckERC20 tokens into your smart contract
...
If the ckERC20 token is listed, the first step is to create an Ethereum transaction that calls the `approve` function on the corresponding ERC-20 contract address, allowing the helper smart contract


To convert an to ckETH, you will need to make a call to a smart contract on Ethereum and pass in your encoded developer identity principal ID. To encode your developer identity, first get your identity's ID:
