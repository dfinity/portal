...
To convert ETH to ckETH, you will need to make a call to a smart contract on Ethereum and pass in your encoded developer identity principal ID. [Learn more about how to get this principal ID and encode it](generating-addresses.mdx).
