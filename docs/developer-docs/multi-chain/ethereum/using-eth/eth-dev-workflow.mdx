...
Chain-key Ethereum (ckETH) is a digital twin token of Ethereum that is backed 1:1 with Ethereum held within an ICP smart contract. ckETH tokens comply with the [ICRC token standard](/docs/current/developer-docs/multi-chain/chain-key-tokens/cketh/overview).
...
[Learn more about ckETH](/docs/current/developer-docs/multi-chain/chain-key-tokens/cketh/overview).
...
- [ckETH](/docs/current/developer-docs/multi-chain/chain-key-tokens/cketh/overview).
