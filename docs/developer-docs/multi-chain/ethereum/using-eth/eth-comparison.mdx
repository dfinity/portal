...
***ICP**: The IC consensus protocol provides cryptographically guaranteed finality. The approach on ICP avoids the drawbacks of probabilistic finality used in Bitcoin-like protocols, which include the weak notion and increased time to finality. The consensus mechanism of ICP ensures faster and more secure transaction finality.
