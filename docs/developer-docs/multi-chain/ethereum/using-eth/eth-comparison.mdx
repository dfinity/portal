...
Both Ethereum and ICP allow developers to deploy programs that run on the blockchain. These programs are referred to as smart contracts in Ethereum and canister smart contracts, or simply just [canisters](/docs/current/developer-docs/smart-contracts/overview/) on ICP.
