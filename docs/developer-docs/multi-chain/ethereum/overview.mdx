...
You can [learn how to use the EVM RPC canister](evm-rpc.mdx).

## ckETH

ICP implements a smart contract that uses threshold ECDSA and chain-key cryptography to provide a [**ckETH**](/docs/current/developer-docs/multi-chain/ethereum/cketh/overview) token (chain-key ETH) that is backed 1:1 by ETH.
...
[View the full list of Ethereum ecosystem examples](https://internetcomputer.org/ecosystem?tag=Bitcoin).