...
You can [learn how to use the EVM RPC canister](/docs/current/developer-docs/multi-chain/ethereum/evm-rpc/evm-rpc-canister).

## ckETH

ICP implements a smart contract that uses threshold ECDSA and chain-key cryptography to provide a [**ckETH**](/docs/current/developer-docs/multi-chain/chain-key-tokens/cketh/overview) token (chain-key ETH) that is backed 1:1 by ETH.
