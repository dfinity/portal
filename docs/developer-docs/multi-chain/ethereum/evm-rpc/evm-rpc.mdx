...
Below is a simple use case making a call to `eth_get_logs` using a piece of Rust code and the EVM RPC canister:

Rust method implementation:
...
```
dfx canister call dappcon_backend get_logs --candid src/dappcon_backend/dappcon_backend.did  '(
  record {
    fromBlock = opt variant { Number = 4_365_627 : nat };
    toBlock = opt variant { Latest };
    addresses = vec { "0xb59f67a8bff5d8cd03f6ac17265c550ed8f33907" };
    topics = opt vec {
      vec { "0xddf252ad1be2c89b69c2b068fc378daa952ba7f163c4a11628f55a4df523b3ef" };
        vec { "0x00000000000000000000000000b46c2526e227482e2ebb8f4c69e4674d262e75" };
        vec { "0x00000000000000000000000054a2d42a40f51259dedd1978f6c118a0f0eff078" };
      };
    };
  },
)'
