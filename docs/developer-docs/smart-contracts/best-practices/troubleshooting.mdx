...
On subnets with higher loads, your application may experience elevated latencies or reduced accessibility. To get more information on the subnet your canister is running on, view the canister's information on the [ICP dashboard](https://dashboard.internetcomputer.org/canisters).
...
:::info
Additional solutions and recommendations for dealing with network latencies are currently in progress. Stay up to date by participating in the [forum discussion on subnet latencies](https://forum.dfinity.org/t/subnets-with-heavy-compute-load-what-can-you-do-now-next-steps/35762).
:::
