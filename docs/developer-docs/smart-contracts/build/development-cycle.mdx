...
ICP runs arbitrary [WebAssembly modules in canisters](/docs/current/developer-docs/smart-contracts/overview). New canisters are created for each individual WebAssembly module that should be run. When a canister is created, it will be assigned a canister ID. There is no central registry of canisters, meaning developers (or more likely their [tools](/docs/current/developer-docs/developer-tools/overview)) have to keep track of their canister IDs. Once code is deployed to canisters, the canister IDs can be used to [call the functions](/docs/current/developer-docs/smart-contracts/call/overview) of other canisters.
...
- [Learn how to compile a Wasm module from your code](/docs/current/developer-docs/smart-contracts/build/development-cycle).