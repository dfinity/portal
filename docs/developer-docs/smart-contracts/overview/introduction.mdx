...
Operating system processes cannot directly modify their table of file descriptors or manipulate peripheral devices, similar to how canisters cannot directly modify their <Tooltip text="Currency unit used to pay for ICP gas fees.">cycles</Tooltip> balance.
