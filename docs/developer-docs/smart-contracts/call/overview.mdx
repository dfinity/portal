...
```motoko
# /submodules/motoko/counter/src/Main.mo#L10-L13
```
...
```rust
# /submodules/rust/counter/src/lib.rs#L14-L19
```
...
```motoko
# /submodules/motoko/counter/src/Main.mo#L5-L9
```
...
```rust
# /submodules/rust/counter/src/lib.rs#L8-L12
```
