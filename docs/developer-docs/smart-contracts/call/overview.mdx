...
To interact with a <GlossaryTooltip>canister's</GlossaryTooltip> methods, there are two primary types of calls that can be used: update calls and query calls.
