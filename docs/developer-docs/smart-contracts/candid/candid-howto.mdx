...
As discussed in the [Candid concepts](./candid-concepts.mdx) page, Candid provides a language-agnostic way to interact with <Tooltip text="A smart contract on ICP.">canisters</Tooltip>.
