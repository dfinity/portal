...
For detailed information on how to utilize this feature, please refer to the [HTTPS outcalls - How to use](/docs/current/developer-docs/web-apps/on-chain-backend/https-outcalls/https-outcalls-how-to-use) page.

The documentation includes examples demonstrating how to make the following types of requests:
- [GET Request](/docs/current/developer-docs/web-apps/on-chain-backend/https-outcalls/https-outcalls-get)
- [POST Request](/docs/current/developer-docs/web-apps/on-chain-backend/https-outcalls/https-outcalls-post)
