...
For outgoing HTTP requests, the [HTTP outcalls](./https-outcalls/https-outcalls-how-to-use.mdx) feature should be used.

- [Making HTTP requests](./http-outcalls/making-http-requests.mdx)

- [How to use HTTP outcalls](./http-outcalls/https-outcalls-how-to-use.mdx)

- [HTTP outcalls: `GET`](./http-outcalls/https-outcalls-get.mdx)

- [HTTP outcalls: `POST`](./http-outcalls/https-outcalls-post.mdx)
...
- [Making HTTP requests](./https-outcalls/making-http-requests.mdx)

- [How to use HTTP outcalls](./https-outcalls/https-outcalls-how-to-use.mdx)

- [HTTP outcalls: `GET`](./https-outcalls/https-outcalls-get.mdx)

- [HTTP outcalls: `POST`](./https-outcalls/https-outcalls-post.mdx)
