...
7. If the response size [exceeds the maximum response size](/docs/current/developer-docs/smart-contracts/maintain/resource-limits/), the HTTP gateway fetches additional response body data through query calls.
