...
<img src="/img/docs/wasm-module.svg" alt="Compile Wasm" width="600"/>
</div>
...
:::caution
Compiling a canister on the mainnet will cost [cycles](/docs/current/developer-docs/getting-started/cycles/cycles-faucet).
:::
