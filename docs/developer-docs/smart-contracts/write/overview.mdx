...
1. Users open the application in the browser by navigating to the URL `https://<canister-id>.icp0.app` or a custom domain that the developer has registered for the canister.
