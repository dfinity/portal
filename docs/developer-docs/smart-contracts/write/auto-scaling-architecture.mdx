...
This page describes an advanced workflow. It is recommended to use a single canister architecture when first getting started on ICP, as described in the [write overview page](/docs/current/developer-docs/smart-contracts/write/overview).
