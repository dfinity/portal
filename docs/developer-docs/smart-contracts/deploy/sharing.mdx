...
If you are sharing a link to a backend canisters, the [CandidUI](/docs/current/developer-docs/smart-contracts/candid/candid-conceptscandid-concepts) will be displayed.
:::
