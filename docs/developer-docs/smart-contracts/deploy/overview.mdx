...
[writing smart contracts](/docs/current/developer-docs/getting-started/write-smart-contracts) sample
page for an example project.

An example `dfx.json` file can be found in the
[default project template document](/docs/current/developer-docs/getting-started/write-smart-contracts).
:::
...
Deploying canisters to the mainnet will cost cycles. [Learn more about cycles and how to acquire them](/docs/developer-docs/getting-started/tokens-and-cycles.mdx).
