...
- [Creating each canister](/docs/current/developer-docs/smart-contracts/create) in the `dfx.json` file.

- [Compiling the code](/docs/current/developer-docs/smart-contracts/compile) for each canister into a Wasm module.

- [Installing that Wasm module](/docs/current/developer-docs/smart-contracts/install) into the canister. 

- Deploys that canister onto the deployment endpoint of choice (local, playground, mainnet).
:::
