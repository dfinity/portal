...
Deploying canisters to the mainnet will cost cycles. [Learn more about cycles and how to acquire them](/docs/developer-docs/getting-started/cycles/cycles-faucet).
