...
test their canister smart contracts locally or directly on mainnet. In order to
make test deployments to mainnet faster and even cheaper, you can deploy your
canister to the so-called playground. You need no cycles or tokens to deploy and
...
[Learn more](<(/docs/current/developer-docs/setup/deploy-locally)>) about
...
[Learn more](<(/docs/current/developer-docs/setup/deploy-mainnet)>) about
