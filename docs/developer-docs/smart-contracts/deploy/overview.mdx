...
[Playground](/docs/current/developer-docs/developer-tools/ide/playground) or
...
deployments from your production stack by using the Playground.
...
To deploy to the
[Playground](/docs/current/developer-docs/developer-tools/ide/playground), use
the command:
