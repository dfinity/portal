...
<input type="checkbox"/> <a href="/docs/current/developer-docs/smart-contracts/create">Create your canister.</a> [Optional; `dfx deploy` will execute this step if not already complete.]
<div>
</div>
<input type="checkbox"/> <a href="/docs/current/developer-docs/smart-contracts/compile">Compile your canister code into Wasm.</a> Optional; `dfx deploy` will execute this step if not already complete.]
<div>
</div>
<input type="checkbox"/> <a href="/docs/current/developer-docs/smart-contracts/install">Install the Wasm module into your canister.</a> Optional; `dfx deploy` will execute this step if not already complete.]
</TabItem>
</Tabs>
