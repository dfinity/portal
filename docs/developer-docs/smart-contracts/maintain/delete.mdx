...
If you want to permanently delete a specific <Tooltip text="A smart contract on ICP.">canister</Tooltip> or all canisters for a specific project on a given deployment (either local, or remote), you can do so by running the command:
