...
To specify controllers upon canister creation, the [`dfx canister create --controller <controller>`](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-canister#dfx-canister-create) command can be used.
