...
2. Use [`dfx build <canister-name>`](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-build) to compile the code into a new Wasm module.

3. Use [`dfx canister install <canister-name> --mode upgrade`](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-canister#dfx-canister-install) to install the new Wasm module.
