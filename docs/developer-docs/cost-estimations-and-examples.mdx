...
The calculator below estimates costs in USD. You will need to top up your project with [cycles](gas-cost.mdx) by converting ICP tokens into cycles. [Learn more about how to obtain cycles](/docs/current/developer-docs/defi/cycles/converting_icp_tokens_into_cycles).
