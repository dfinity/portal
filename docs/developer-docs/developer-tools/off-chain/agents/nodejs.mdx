...
You can configure an authentication identity for Node.JS through `agent-js`'s default ECDSA private key. [Learn more in the agent-js docs](https://internetcomputer.org/docs/current/developer-docs/developer-tools/off-chain/agents/javascript-agent).
...
- [Agent JS developer docs](/docs/current/developer-docs/developer-tools/off-chain/agents/javascript-agent)

- [agent-js](https://www.npmjs.com/package/@dfinity/agent)
