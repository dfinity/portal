...
[`dfx`](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/) is the primary tool used by developers to create, build, deploy, manage, and call canisters. `dfx` is also referred to as the IC SDK, or the Internet Computer Software Development Kit.

`dfx` supports [local development](/docs/current/developer-docs/getting-started/deploy/local) and deployment through the [`dfx start`](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-start) command, which runs a local instance of the ICP replica that can be used to deploy and test canisters on your local machine.
...
- [Install `dfx`](/docs/current/developer-docs/getting-started/install/).
...
[`dfxvm`](/docs/current/developer-docs/developer-tools/cli-tools/dfxvm/docs/cli-reference/dfx/) is a command-line tool used to install and switch between different versions of `dfx`. It enables developers to pivot between different projects that are built with different `dfx` versions.

- [Install `dfxvm`](/docs/current/developer-docs/getting-started/install#installing-dfx).

- [`dfxvm` documentation](/docs/current/developer-docs/developer-tools/cli-tools/dfxvm/docs/cli-reference/dfx/).

- [`dfxvm` GitHub repo](https://github.com/dfinity/dfxvm).

### `quill`

[`quill`](/docs/current/developer-docs/developer-tools/cli-tools/quill-cli-reference/) is a command-line ledger and governance toolkit designed for interacting with the [Network Nervous System (NNS)](/docs/current/developer-docs/daos/nns/overview) canisters through the use of self-custody keys. It supports using keys in an air-gapped computer, which is a computer that has never been connected to the internet. To support this workflow, `quill` first generates and signs messages based on the user input, then the signed messages are transported to a computer with internet connection (via a USB flash drive or QR code), where they are submitted to ICP to be executed.

- [Install `quill`](https://github.com/dfinity/quill?tab=readme-ov-file#download--install).

- [`quill` documentation](/docs/current/developer-docs/developer-tools/cli-tools/quill-cli-reference/).
...
- [JavaScript/TypeScript agent (@dfinity/agent)](/docs/current/developer-docs/developer-tools/off-chain/agents/javascript-agent)

- [Node.js, supported through the JavaScript agent](/docs/current/developer-docs/developer-tools/off-chain/agents/nodejs)

- [Rust agent (ic-agent)](/docs/current/developer-docs/developer-tools/off-chain/agents/rust-agent)
...
The [Rust CDK](/docs/current/developer-docs/backend/rust/) is developed and maintained by DFINITY for Rust development.
...
- [Developer container documentation](/docs/current/developer-docs/developer-tools/ide/dev-containers).
...
- [Playground documentation](/docs/current/developer-docs/developer-tools/ide/playground).
...
- [VS Code documentation](/docs/current/developer-docs/developer-tools/ide/vs-code).
