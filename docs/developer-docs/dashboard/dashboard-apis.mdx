...
The ICRC API can be used to pull data about any ICRC token as long as you have the token's ledger canister ID. This API's endpoint is: https://icrc-api.internetcomputer.org/
...
The ledger API can be used to obtain data about ICP tokens. For tokens other than ICP, such as ICRC-1 or ICRC-2 tokens, use the [ICRC API](#icrc-api). This API's endpoint is: https://ledger-api.internetcomputer.org/
