...
Before you can build the `rust_profile` project, you need to connect to the local <GlossaryTooltip>replica</GlossaryTooltip> running in your development environment or the Internet Computer blockchain mainnet.
...
Next, you'll cover [access control](./13-access-control.mdx) in Rust canisters.
