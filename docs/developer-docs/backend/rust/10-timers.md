...
To see details about the Candid interface description language syntax, see the [**Candid guide**](/docs/developer-docs/backend/candid/index.md) or the [Candid crate documentation](https://docs.rs/candid/).
...
## Next steps
For the next step, let's dive into Rust [stable structures](/docs/developer-docs/backend/rust/11-stable-structures.md).
