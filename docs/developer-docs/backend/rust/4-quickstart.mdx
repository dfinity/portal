...
After testing the application, you can stop the local replicaso that it doesn’t continue running in the background.

To stop the local replicarunning on your computer, run the following command:
