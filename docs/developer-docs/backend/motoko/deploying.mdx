---
keywords: [beginner, motoko, tutorial, deploying, canisters]
---
...
This guide covers the basics of writing and deploying Motoko canisters. For detailed information about Motoko's fundamentals, check out the [Motoko fundamentals](/docs/current/developer-docs/backend/motoko/infrastructure) page.
...
For more information on deploying, deleting or managing canisters, view the [managing canisters documentation](/docs/current/developer-docs/setup/manage-canisters).

For the next step in this guide, check out the [upgrading canisters guide](/docs/current/developer-docs/backend/motoko/upgrading)