---
keywords: [beginner, motoko, tutorial, natural numbers]
---
...
After you connect to the local replica running in your development environment, you can register, build, and deploy your dapp locally.
