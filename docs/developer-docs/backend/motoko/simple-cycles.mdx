---
keywords: [intermediate, motoko, tutorial, cycles]
---
...
```bash
dfx new cycles_hello --no-frontend
```
...
cycles_hello_backend: http://127.0.0.1:4943/?canisterId=bd3sg-teaaa-aaaaa-qaaba-cai&id=bkyz2-fmaaa-aaaaa-qaaaq-cai
```
...
-   [Tokens and cycles (overview)](/docs/current/concepts/tokens-cycles).

## Next steps

In the next step, you'll learn about [querying using an actor](define-an-actor.mdx).