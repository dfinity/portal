---
keywords: [beginner, motoko, tutorial, libraries, library modules, mops, vessel]
---
...
To test your code, follow the instructions [here](/docs/current/developer-docs/backend/motoko/candid-ui).
...
Next, let's take a look at [using integers in calculator functions](calculator.mdx)
