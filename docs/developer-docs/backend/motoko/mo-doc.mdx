---
keywords: [beginner, motoko, tutorial, generating, documentation]
---
...
Download `mo-doc` from Motoko's [GitHub releases page](https://github.com/dfinity/motoko/releases) or simply use the binary included in your [dfx](/docs/current/developer-docs/setup/install) installation:
