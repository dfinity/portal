...
For details about the syntax to use for different data types, see the [*Candid Guide*](../candid-guide/candid-intro.xml) and [Candid specification](https://github.com/dfinity/candid/tree/master/spec).
