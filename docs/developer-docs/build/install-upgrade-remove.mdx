...
<h2 id="installing-wsl">Installing WSL</h2>
...
<h3 id="upgrade-to-wsl-2">Upgrade to WSL 2</h3>
...
<p>WSL 2 has node.js <code>10.x.x</code> installed by default. But the latest <code>dfx</code> requires node.js <code>16.0.0</code> or higher, please check <a href="hello10mins#nodejs">Node.js</a> for more information.</p>
