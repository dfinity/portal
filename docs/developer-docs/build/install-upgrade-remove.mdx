...
If you would like to compile dfx by yourself, head over to the [sdk repo](https://github.com/dfinity/sdk). The README contains the instructions how you can build it on your own.
