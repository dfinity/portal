...
<p>To learn more about the <code>wsl</code> command, check out the <a href="https://docs.microsoft.com/en-us/windows/wsl/basic-commands">command reference for WSL</a>.</p>
