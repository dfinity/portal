...
For details about the syntax to use for different data types, see the [*Candid Guide*](../candid/candid-intro.md) and [Candid specification](https://github.com/dfinity/candid/tree/master/spec).
