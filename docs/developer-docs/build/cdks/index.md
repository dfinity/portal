...
The two officially supported languages of the Internet Computer are [Motoko](../../../motoko/official/motoko.md) and [Rust](./cdk-rs-dfinity/index.md).
...
- Motoko
  - [Motoko by DFINITY](../../../motoko/official/motoko.md)
- Rust
