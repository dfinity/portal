...
3.  Copy and paste [this code](../_attachments/counter.mo) into the `increment_counter.mo` file.
    ...
    For more information about stable and flexible variables, see [Stable variables and upgrade methods](../../../motoko/upgrades.md) in the [*Motoko Programming Language Guide*](../../../motoko/about-this-guide.md).
