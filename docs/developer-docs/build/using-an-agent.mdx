...
<!-- TODO - link to list of agents -->
<!-- TODO - update ic-interface-spec caution with link to this page -->
...
A self-authenticating identity using one of the above curves will have a suffix of 2, while anonymous identities receive a suffix of 4. The default anonymous identity is derived from an empty byte array, apart from the suffix 4. It resolves to `"2vxsx-fae"`, in its textual encoding.
