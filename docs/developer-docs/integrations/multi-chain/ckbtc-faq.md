...
5. **Multi-block transactions**: ICP can stretch the execution of a single transaction across multiple blocks, allowing very-long running smart contract computations to be initiated.
