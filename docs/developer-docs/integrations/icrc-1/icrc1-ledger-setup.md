...
-   The `ARCHIVE_CONTROLLER` is the [controller principal](/developer-docs/getting-started/cycles/cycles-wallet.md#controller-and-custodian-roles) of the archive canisters.
