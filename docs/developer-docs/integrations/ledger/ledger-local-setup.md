...
2.  Make sure you use a recent version of `dfx`. If you don’t have `dfx` installed, follow instructions on the [Installing the IC SDK](/developer-docs/setup/install/index.mdx) section to install it.
