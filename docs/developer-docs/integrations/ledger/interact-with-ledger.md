...
`dfx` provides a convenience command to interact with the ICP ledger canister and related functionality. You can find the documentation [here](https://internetcomputer.org/docs/current/developer-tools/cli-tools/cli-reference/dfx-ledger.md) or just enter the following command into your console:
