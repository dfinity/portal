...
- [ICRC-1 ledger local setup](./icrc1-ledger-local-setup.md) explains how you can create your own token by deploying a custom ICRC-1 ledger canister locally, how to interact and test it and also how to deploy it to mainnet.
