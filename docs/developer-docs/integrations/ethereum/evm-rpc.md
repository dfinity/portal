...
To include the EVM RPC canister in a [dfx](https://internetcomputer.org/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-parent) project, add the following to your `dfx.json` file:
