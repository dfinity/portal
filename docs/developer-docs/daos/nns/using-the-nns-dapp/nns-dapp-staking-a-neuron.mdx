...
[Advanced neuron operations](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-dapp-advanced-neuron-operations).
...
### Change a neuron's visibility
A neuron can be public or