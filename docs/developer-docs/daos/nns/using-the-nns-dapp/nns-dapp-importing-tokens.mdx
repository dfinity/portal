...
<iframe width="560" height="315" src="https://www.youtube.com/embed/zcXmarBk2L4?si=OIxq9LwY0DLzHvE1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
To extend wallet capabilities, users of the NNS dapp can now import any token that supports ICRC-1 no longer limited to ICP and SNS governance tokens. This includes all ICRC-2 and ICRC-3 tokens.

## How to find canister IDs
...
- [CoinMarketCap](https://coinmarketcap.com/): The ICRC tokens that are listed on CoinMarketCap provide their ledger canister ID under Contract.
- [CoinGecko](https://coingecko.com/): The ICRC tokens that are listed on CoinGecko provide their ledger canister ID under Contract.
...
:::info
If you don't want to see tokens you don't hold, you can click the settings button at the top right corner of the table, and enable **Hide zero balances**.
:::
...
- **Step 3**: Confirm that this is the token you want to import. By clicking the rightmost button, you can see the canister on the ICP dashboard.
