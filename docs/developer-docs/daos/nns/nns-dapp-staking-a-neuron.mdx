...
# Staking a neuron and setting it up
...
It's **dissolve delay** determines the time it takes for a neuron to be unlocked once it is but in the dissolving state.
...
After you transfer ICP utility tokens to the Network Nervous System dapp, you can use the Network Nervous System dapp to create and manage neurons,
...
These are some of the things you can start with when you created a neuron:
...
[Advanced neuron operations](/docs/current/developer-docs/daos/nns/nns-dapp-advanced-neuron-operations).
