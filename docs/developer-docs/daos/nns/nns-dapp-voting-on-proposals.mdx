...
Active participation in governance is an important factor in the long-term health of the Internet Computer and is the
activity for which governance participants receive voting rewards.

To maximize your rewards, you should vote on as many proposals as possible.
This can be done by voting manually or by delegating your voting power to other neurons using [following](/docs/current/developer-docs/daos/nns/nns-dapp-voting-on-proposals).
...
By default, the NNS dapp will show you all **actionable proposals** where you have have some neurons that can vote on.
This includes the proposals of all DAOs, NNS and SNSs, where you have neurons.
...
Moreover, you can use the filter on the top right to ony see proposals of a specific topic or in a specific status.
...
refer to [Proposals](/docs/current/developer-docs/daos/nns/proposal-overview)
and [Verify proposals](/docs/current/developer-docs/daos/nns/voting-verify-proposals).
:::
