...
NNS governance participants (owners of neurons) can vote on proposals in two ways. Either they can directly vote to adopt or reject a proposal or they can delegate their voting power in a **liquid democracy**. The latter is called **following** as a neuron chooses to follow the voting decision of a group of other neurons.
...
https://internetcomputer.org/docs/current/developer-docs/daos/nns/nns-app-quickstart#neuron-following
