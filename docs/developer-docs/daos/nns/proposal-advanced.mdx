...
# Proposal details and verification
...
To submit a proposal, it is recommended to use a neuron that can be controlled with a command line tool. Find more inforam
