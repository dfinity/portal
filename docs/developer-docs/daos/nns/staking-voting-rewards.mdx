...
In return for participation in governance, the Internet Computer Procotol provides voting rewards.
...
### Maturity
TODO: remove https://wiki.internetcomputer.org/wiki/Maturity
