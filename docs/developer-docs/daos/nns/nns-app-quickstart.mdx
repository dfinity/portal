...
It might be better to follow fewer neuron and it can be beneficial to follow an odd number of neurons than even numbers.
:::
...
However, the catch-all follow rule does not include SNS & neuron's fund or governance proposals.
...
The catch-all follow rule does not apply for SNS & neuron's fund or governance proposals.
