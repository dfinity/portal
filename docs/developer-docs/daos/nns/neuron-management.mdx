...
The new neuron will inherit the parent neuron's hot keys and followees.
Note that the maturity is not affected and the new neuron will start with no maturity.
