...
When you log into the NNS dapp for the first time, you can go to the its wallet but you will not yet own any tokens.
...
If you already have ICP tokens on an exchange, you can transfer some of them to your NNS dapp account as explained in the video above.
To find the right address to send the tokens to, open one of your accounts

![Send ICP](../_attachments/copy-subaccount.png)

You can find the address to send the tokens to in the top right corner and can copy it by clicking on the symbol next to the number.

Using this, you can send tokens from any exchange that supports sending ICP to this account.
