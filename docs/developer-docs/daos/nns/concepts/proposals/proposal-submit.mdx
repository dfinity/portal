...
Each type of proposal belongs to a specific **proposal topic**. Topics are used for [following](/docs/current/developer-docs/daos/nns/nns-app-quickstart#neuron-following) and also determine some other details about how the proposal is processed.
