...
Based on the majority decision, a proposal is either adopted or rejected. If a proposal is adopted, it is automatically executed fully on-chain, without the need for manual intervention.
