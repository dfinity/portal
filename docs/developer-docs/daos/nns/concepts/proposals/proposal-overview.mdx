...
For more information on how to submit a proposal, refer to [How to submit a proposal](/docs/current/developer-docs/daos/nns/proposal-submit).

### Proposal decision and wait-for-quiet
After a proposal is submitted and added to the governance canister, other users who control neurons can [vote on the proposal](/docs/current/developer-docs/daos/nns/direct-voting).
