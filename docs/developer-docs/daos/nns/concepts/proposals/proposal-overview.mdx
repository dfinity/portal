---
keywords: [intermediate, governance, concept, nns, proposals]
---
...
### Proposal decision
After a proposal is submitted and added to the governance canister, other users who control neurons can [vote on the proposal](/docs/current/developer-docs/daos/nns/concepts/proposals/direct-voting).
