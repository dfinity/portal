---
keywords: [advanced, governance, concept, nns, voting, proposals]
---
...
All proposals to manage [protocol canisters](/docs/current/developer-docs/smart-contracts/advanced-features/system-canisters/), which are considered part of the Internet Computer protocol and are essential for its proper functioning.
