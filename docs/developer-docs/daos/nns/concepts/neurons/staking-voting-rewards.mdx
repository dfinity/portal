...
As explained in the [neuron overview](/docs/current/developer-docs/daos/nns/concepts/neurons/neuron-overview), maturity can then either be staked or spawned.
