...
For an explanation video how following works and more information how followoing can be set on the NNS dapp,
refer to [Configuring neuron following](/docs/current/developer-docs/daos/nns/concepts/using-the-nns-dapp/neuron
-following).
...
To learn more about how to set up your neuron to follow a group of other neurons on the NNS dapp, refer to [NNS dapp
quickstart for following](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/using-the-nns-dapp/neuron-following).
