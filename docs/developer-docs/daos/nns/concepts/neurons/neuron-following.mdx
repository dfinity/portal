...
To learn more about the follow rules and how to set up your neuron to follow a group of other neurons on the NNS dapp, refer to [NNS dapp quickstart for following](/docs/current/developer-docs/daos/nns/nns-app-quickstart#neuron-following).
