...
Concretely, proposals are grouped into different [**proposal topics**](/docs/current/developer-docs/daos/nns/concepts/proposals/direct-voting#proposal-topics-and-types) and following is done on a per-topic basis.
To learn more about the follow rules and how to set up your neuron to follow a group of other neurons on the NNS dapp, refer to [NNS dapp quickstart for following](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-app-quickstart#neuron-following).
