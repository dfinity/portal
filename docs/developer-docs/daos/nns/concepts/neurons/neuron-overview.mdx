...
A neuron can have multiple hotkeys, at most 15. One common workflow using hotkeys is to set the controller of the neuron as a hardware wallet, then vote or view neuron information through a software wallet set as a hotkey.
