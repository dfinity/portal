...
A neuron can have multiple hotkeys. One common workflow using hotkeys is to set the primary controller of the neuron as a hardware wallet, then vote or view neuron information through a software wallet set as a hotkey.
