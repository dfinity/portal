---
keywords: [advanced, governance, concept, nns, neurons]
---
...
:::info
It is important to understand that a neuron's vote is only cast if the majority of the followed neurons agree on a decision. Find [here](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-app-quickstart#neuron-following) more information and examples regarding the following-rules.
