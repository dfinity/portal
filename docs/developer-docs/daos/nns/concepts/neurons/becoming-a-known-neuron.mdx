...
Run `dfx identity get-principal` to get the principal ID that corresponds to your current [developer identity](/docs/current/developer-docs/getting-started/identities). The following steps will refer to this as your "dfx principal".
