---
keywords: [intermediate, governance, concept, nns, neurons fund]
---
...
Neurons can join or leave the NF using a checkbox in the NNS frontend application. This action can be taken at any time, even during ongoing voting on SNS proposals. Joining the NF means neurons expose their maturity to the risks associated with participating in SNSs.
