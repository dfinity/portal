...
You can find [here](/docs/current/developer-docs/smart-contracts/topping-up/topping-up-canister#option-2-if-you-have-cycles-on-your-cycles-wallet) how to transfer cycles from a wallet to any other canister (which can be a dapp or SNS canister).
