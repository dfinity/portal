...
Since all SNSs are upgraded along the same upgrade path, this is what allows SNSs to nevertheless customise the rules of their governance, the tokenomics, etc to meet their needs.
