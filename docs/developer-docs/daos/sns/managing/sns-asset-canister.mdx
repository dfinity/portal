...
The evidence and batch bytes must be Candid-encoded bytes. These are the arguments you will submit with the `ExecuteGenericNervousSystemFunction` proposal.
