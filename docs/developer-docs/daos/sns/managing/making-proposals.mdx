...
The rate that funds can be transferred from the treasury is limited. To explain how this works,
first, define T to be the value of the tokens in the treasury in units of [XDR]. T can fall within
three size regimes:
