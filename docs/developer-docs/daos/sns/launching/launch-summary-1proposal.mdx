...
thereby the dapp (see [here](../introduction/sns-launch.mdx)).
...
### 1. Dapp developers choose the initial parameters of the SNS for a dapp.
  ...
  * The conditions for the decentralization swap, including the swap's start date and
  ...
  community engagement already (see [here](../tokenomics/sns-checklist.mdx) for
  more information).
...
SNS creation, [SNS-W](../introduction/sns-architecture.mdx#SNS-W)
...
Once the SNS canisters are deployed, [SNS-W](../introduction/sns-architecture.mdx#SNS-W)
