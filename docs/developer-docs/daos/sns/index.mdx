...
You will find
* [SNS introduction](./introduction/sns-intro-high-level.mdx) giving a quick introduction.
* [SNS architecture](./introduction/sns-architecture.mdx) explaining how SNSs are deployed and upgraded and what canisters are involved.
* [Alternative DAOs](./introduction/dao-alternatives.mdx) presenting alternative ways how to get a DAO.
...
* [SNS tokenomics](./tokenomics/tokenomics-intro.mdx) providing and introduction to tokenomics that can be considered when designing an SNS's tokenomics.
* [SNS rewards](./tokenomics/rewards.mdx) providing and introduction to SNS rewards that can be considered when planning an SNS's tokenomics.
* A (technical) introduction how to convert the configurations into [SNS parameters](./tokenomics/preparation.mdx).
...
It includes
* [An introduction to SNS integration](./integrating/index.mdx).
* [Guidelines how to integrate with the ledger canister](./integrating/ledger-integration.mdx).
* [Guidelines how to integrate with the index canister](./integrating/index-integration.mdx).
