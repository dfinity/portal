...
is maintained by the Internet Computer Protocol. ([Learn about alternative ways to use the SNS code or how to create a DAO.](dao-alternatives.mdx))
...
[this section](../launching/launch-summary-1proposal.mdx) for the detailed, technical stages of an SNS launch.
