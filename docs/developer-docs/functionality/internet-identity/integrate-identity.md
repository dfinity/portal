...
This is a standalone project that you can copy to your own project. You can find the demo code [here](https://github.com/dfinity/internet-identity/tree/main/demos/using-dev-build).
