...
To learn how to create and use Identity Anchors step-by-step, see [How to use Internet Identity](https://sdk.dfinity.org/docs/ic-identity-guide/auth-how-to.html). This also describes how to set up recovery mechanisms for Identity Anchors.
