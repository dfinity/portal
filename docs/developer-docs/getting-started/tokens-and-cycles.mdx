...
ICP tokens are important because they can be converted to cycles and used to pay for resource consumption. Cycles reflect the real cost of operations for applications hosted on the Internet Computer, including resources such as physical hardware, rack space, energy, storage devices, and bandwidth.
...
To confirm that your ICP was successfully converted into cycles, check your cycles balance:
