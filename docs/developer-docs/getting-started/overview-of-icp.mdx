...
The rest of this page walks through the core concepts and features of ICP to show why that's the case.
...
In order to simplify the experience of users browsing Web3 applications, ICP employs a “reverse gas model”, where <Tooltip text="A smart contract on ICP.">canisters</Tooltip> pay for consumed resources by burning **cycles**.
