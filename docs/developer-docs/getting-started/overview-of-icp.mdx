...
Smart contracts on ICP can host web assets and serve HTTPS requests from users, thus fulfilling the promise of Web3.
They can also interact with RPC nodes of other blockchains and Web2 servers through secure HTTPS requests.
...
A unique feature of ICP is that smart contracts can handle HTTPS requests and serve web assets such as HTML, JS, CSS.
...
<tr>
  <td> HTTPS calls to Web2 from smart contracts </td>
  <td> - </td>
  <td> Yes </td>
</tr>
