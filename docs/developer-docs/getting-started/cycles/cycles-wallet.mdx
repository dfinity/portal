...
In a production environment, however, you need to explicitly register and transfer cycles to new canisters, specify the principals that can act as custodians, and manage the principals with ownership rights. You can perform some of these tasks using the default cycles wallet dapp running in a web browser. Depending on the specific action you want to take, you can also perform these cycle and canister management tasks by running `dfx wallet` commands in a terminal or by calling methods in the default cycles wallet canister directly. You can learn more about how to use `dfx wallet` [here](https://internetcomputer.org/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet).
...
- [`add-controller`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-add-controller): add a controller using the selected identity's principal.
- [`addresses`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-addresses): displays the address book of the cycles wallet.
- [`authorize`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-authorize): authorize a custodian by principal for the selected identity's cycles wallet
- [`balance`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-balance): displays the cycles wallet balance of the selected identity.
- [`controllers`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-controllers): displays a list of the selected identity's cycles wallet controllers.
- [`custodians`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-custodians):	displays a list of the selected identity's cycles wallet custodians.
- [`deauthorize`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-deauthorize): deauthorize a cycles wallet custodian using the custodian's principal.
- [`help`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-help): displays a usage message and the help of the given subcommand(s).
- [`name`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-name): returns the name of the cycles wallet if you've used the dfx wallet set-name command.
- [`redeem-faucet-coupon`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#dfx-wallet-redeem-faucet-coupon): redeem a code at the cycles faucet.
- [`remove-controller`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#remove-controller): removes a specified controller from the selected identity's cycles wallet.
- [`send`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#send): sends a specified amount of cycles from the selected identity's cycles wallet to another cycles wallet using the destination wallet canister ID.
- [`set-name`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#set-name): specify a name for your cycles wallet.
- [`upgrade`](/docs/current/developer-tools/cli-tools/cli-reference/dfx-wallet#upgrade): upgrade the cycles wallet's Wasm module to the current Wasm bundled with DFX.
