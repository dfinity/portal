...
:::caution
The cycles wallet will be deprecated in the future. We recommend using the cycles ledger feature instead, which simplifies the cycles management workflow.
:::
