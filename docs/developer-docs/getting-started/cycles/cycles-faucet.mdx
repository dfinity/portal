...
You will need to put in a request for cycles on the [DFINITY developer Discord](https://discord.gg/jnjVVQaE2C) server. You can click on the **REQUEST CYCLES** button on the faucet page to join the Discord server.
