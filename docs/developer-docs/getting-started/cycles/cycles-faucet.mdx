...
You will need to put in a request for cycles on the [Discord](https://discord.inhttps://discord.internetcomputer.orgou can click on the **REQUEST CYCLES** button on the faucet page to join the Discord server.
