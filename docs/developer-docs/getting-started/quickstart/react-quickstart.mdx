...
To create your own dapp, you can either:

- Edit the default template created by `dfx`, which provides a framework for a backend canister and frontend canister.

- Use an example or boilerplate project repository
...
You can view [the template's GitHub repo](https://github.com/rvanasa/vite-react-motoko/tree/main/src).
...
```javascript title="src/declarations/my_project_frontend/index.js"
...
```js title="src/my_project_frontend/src/index.js"
