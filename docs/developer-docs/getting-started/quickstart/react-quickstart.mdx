...
When developing frontend UIs, there are several frontend frameworks that can be used, such as [JavaScript](/docs/current/developer-docs/frontend/javascript-frontend), [Svelte](/docs/current/developer-docs/frontend/svelte-frontend), and [Vue](/docs/current/developer-docs/frontend/vue-frontend).
