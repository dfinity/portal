...
To customize your IC SDK installation, you can use the interactive installation prompt or set [environment variables](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/dfx-envars) for a session.
