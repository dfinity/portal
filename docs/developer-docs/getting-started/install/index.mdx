...
The [IC SDK](https://github.com/dfinity/sdk) is a **software development kit** used for creating and managing canister smart contracts on the ICP blockchain. The IC SDK supports [Motoko](/docs/current/developer-docs/smart-contracts/choosing-language) and [Rust](/docs/current/developer-docs/smart-contracts/choosing-language) programming languages by default, but [developers can use other languages as well](/docs/current/developer-docs/smart-contracts/choosing-language).
