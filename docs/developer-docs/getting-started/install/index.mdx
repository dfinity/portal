...
The TypeScript and JavaScript CDK, known as Azle, is supported by `dfx`. Learn more about how to [install and use Azle](https://internetcomputer.org/docs/current/developer-docs/backend/typescript/).
...
The Python CDK, known as Kybra, is supported by `dfx`. Learn more about how to [install and use Kybra](https://internetcomputer.org/docs/current/developer-docs/backend/python/).
