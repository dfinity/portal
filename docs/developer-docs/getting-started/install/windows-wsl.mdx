...
WSL 2 has Node.js `10.x.x` installed by default. But the latest `dfx` requires Node.js `16.0.0` or higher, please check [0.3: Developer environment setup](/docs/current/tutorials/developer-journey/level-0/dev-env) developer ladder tutorial for more information.
