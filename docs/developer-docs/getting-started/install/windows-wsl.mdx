---
keywords: [beginner, tutorial, getting started, windows]
---
...
Once you have WSL installed, you can install `dfx` within your WSL Linux terminal as described in [Installing the SDK](/docs/current/developer-docs/getting-started/install/).

## Troubleshooting

### Node.js is not properly installed

WSL 2 has node.js `10.x.x` installed by default. But the latest `dfx` requires node.js `16.0.0` or higher, please check [0.3: Developer environment setup](/docs/current/tutorials/developer-journey/level-0/dev-env) developer journey tutorial for more information.
