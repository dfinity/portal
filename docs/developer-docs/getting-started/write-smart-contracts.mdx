...
Each developer environment uses [`dfx`](/docs/current/developer-docs/getting-started/install), a command-line tool that is used for developing and deploying smart contracts on ICP. 
...
Download and install the latest version of [dfx](/docs/current/developer-docs/getting-started/install). `dfx` is a CLI tool used for developing and deploying ICP smart contracts:
...
- It signs the message with the private key of the [developer account](/docs/current/developer-docs/getting-started/identities).
...
- [Create a developer account](/docs/current/developer-docs/getting-started/identities).

- [Acquire cycles](/docs/current/developer-docs/getting-started/tokens-and-cycles).
