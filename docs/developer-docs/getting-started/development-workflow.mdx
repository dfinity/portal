...
ICP has its own ABI language called **[Candid](/docs/current/developer-docs/backend/candid/)**, which is similar to JSON or Protobuf, but tailored for ICP.
