...
By default, `dfx` generates a project structure consisting of two smart contracts: the **frontend <Tooltip text="A smart contract on ICP.">canister</Tooltip>** and the **backend <Tooltip text="A smart contract on ICP.">canister</Tooltip>**.
...
1. Use the browser to load the webpage hosted in the frontend <Tooltip text="A smart contract on ICP.">canister</Tooltip> and use the UI of the webpage to interact with the backend <Tooltip text="A smart contract on ICP.">canister</Tooltip>.
