...
It is recommended to follow the [creating your first canister](/docs/current/developer-docs/smart-contracts/write/default-template) guide to have a simple 'Hello, world!' canister ready to deploy.
