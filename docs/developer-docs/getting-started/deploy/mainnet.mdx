...
For information about how to get ICP tokens, see [how you can get ICP tokens](../getting-started/cycles/converting_icp_tokens_into_cycles.md).
...
For information about using your default cycles wallet after you have created it, see [use the default cycles wallet](/developer-docs/getting-started/cycles/cycles-wallet.md).
:::
