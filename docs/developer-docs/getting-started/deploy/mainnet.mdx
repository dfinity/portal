...
To make your <Tooltip text="A smart contract on ICP.">canister</Tooltip> available to others, you must deploy it to the mainnet.
...
-   [x] You have ICP tokens or <Tooltip text="Currency unit used to pay for ICP gas fees.">cycles</Tooltip> available for you to use.
