...
For information about using your default cycles wallet after you have created it, see [use the default cycles wallet](/developer-docs/getting-started/cycles/cycles).
:::
