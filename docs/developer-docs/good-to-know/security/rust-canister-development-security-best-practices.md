...
-   For context: [IC interface spec on message execution](../../references/ic-protocol-spec.md#rule-message-execution)
...
Make canister builds reproducible. See this [recommendation](https://mmapped.blog/posts/01-effective-rust-canisters.html#reproducible-builds) (from [Effective Rust Canisters](https://mmapped.blog/posts/01-effective-rust-canisters.html)). See also [Developer docs on this](../build/tutorials/reproducible-builds.md).
...
The data sent in [query and update calls](../../references/ic-protocol-spec.md#http-interface) is generally untrusted. The message size limit is a few MB. This can e.g. lead the following issues:
