...
![Verifiable presentations](/img/docs/vcs-4.png)
...
The order of the credentials in the VP should match the order above, such that the `id_alias` credential linking with the relying party's principal should come first.
