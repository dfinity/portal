...
<div class="text--center">
  <img
    src={useBaseUrl("/docs/developer-docs/identity/internet-identity/_attachments/II_greet_1.png")}
...
<div class="text--center">
  <img
    src={useBaseUrl("/docs/developer-docs/identity/internet-identity/_attachments/II_1.png")}
    alt="Creating an Internet Identity"
  />
</div>
...
<div class="text--center">
  <img
    src={useBaseUrl("/docs/developer-docs/identity/internet-identity/_attachments/II_2.png")}
    alt="Creating an Internet Identity"
  />
</div>
...
<div class="text--center">
  <img
    src={useBaseUrl("/docs/developer-docs/identity/internet-identity/_attachments/II_3.png")}
    alt="Creating an Internet Identity"
  />
</div>
...
<div class="text--center">
  <img
    src={useBaseUrl("/docs/developer-docs/identity/internet-identity/_attachments/II_4.png")}
    alt="Creating an Internet Identity"
  />
</div>
...
<div class="text--center">
  <img
    src={useBaseUrl("/docs/developer-docs/identity/internet-identity/_attachments/II_greet_2.png")}
    alt="Creating an Internet Identity"
  />
</div>
