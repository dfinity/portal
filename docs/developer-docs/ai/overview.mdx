...
A technical working group dedicated to discussing decentralized AI and related projects meets bi-weekly on Thursdays at 5pm UTC. You can join via [Discord](https://discord.interhttps://discord.internetcomputer.org
