...
All ICP token transactions are recorded in a [ledger canister](../updates/glossary#ledger) running on the Internet Computer blockchain. The ledger canister consists of **account identifiers** and **balances** for all ICP token holders.
