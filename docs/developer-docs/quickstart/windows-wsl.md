...
WSL 2 has node.js `10.x.x` installed by default. But the latest `dfx` requires node.js `16.0.0` or higher, please download [Node.js](https://nodejs.org) and try again.
