...
- Using [Candid](../backend/motoko/hello-location.md#candid-ui) as a bare-bones interface to expose and test
  the functions in a canister.

- Using [raw HTML and JavaScript](../backend/motoko/explore-templates.md#default-frontend) to display a
