...
This sample is based on the default project created by running `dfx new` as described in the [Motoko](../quickstart/local-quickstart.xml) and [Rust](../rust-guide/rust-quickstart.xml) quickstart documents.
...
![hello frontend](images/hello.png)
