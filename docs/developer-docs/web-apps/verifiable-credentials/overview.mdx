...
- **Issuer**: An individual or app that issues verifiable credentials to a user.

- **Relying party**: An individual or app that requests users provide verifiable credentials.
