...
For outgoing HTTP requests, the [HTTP outcalls](/docs/current/developer-docs/smart-contracts/advanced-features/https-outcalls-how-to-use) feature should be used. 

- [Making HTTP requests](/docs/current/developer-docs/smart-contracts/advanced-features/making-http-requests)

- [How to use HTTP outcalls](/docs/current/developer-docs/smart-contracts/advanced-features/https-outcalls-how-to-use)

- [HTTP outcalls: `GET`](/docs/current/developer-docs/smart-contracts/advanced-features/https-outcalls-get)

- [HTTP outcalls: `POST`](/docs/current/developer-docs/smart-contracts/advanced-features/https-outcalls-post)
