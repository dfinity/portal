...
On ICP, there are several boilerplate dapp templates that use React, such as the [React frontend example](/docs/current/developer-docs/frontend/react-frontend). In this guide, you will explore two other boilerplate templates that can be used. 

## Installing the React framework

To install React, first install the React module with the command:
...
*****************************************
## `dfx`'s default frontend templates
