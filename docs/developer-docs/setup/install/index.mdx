...
1. **IC SDK** - This is the SDK created by DFINITY for creating and managing canisters. This is just one SDK in ICP community and a common entry point for developers.
