...
Upon installation, you will be prompted to select which version of dfx you'd like to install. Alternatively, you can pass the intended version using an environmental variable, such as:
