...
[TypeScript CDK](https://demergent-labs.github.io/azle/), etc... Since CDKs are components used by the SDK, some developers choose to use the CDK directly (without the IC SDK), 
