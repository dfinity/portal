...
<Tabs>
  <TabItem value="docs" label='Developer Docs' attributes={{className: styles.docs}}>
    ...
    <br></br>
    <a href="quickstart/hello10mins"> Quick Start</a> &rarr; <a href="build/index">Buidling on the IC </a> &rarr; <a href="functionality/index">Integrating Functionality</a> &rarr; <a href="updates/index">Updates </a>
  </TabItem>
