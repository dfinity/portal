...
<Tabs>
  <TabItem value="docs" label='Developer Docs' attributes={{className: styles.docs}}>
    ...
    <br></br>
    <a href="quickstart/hello10mins"> Quick Start</a> &rarr; <a href="build/">Buidling on the IC </a> &rarr; <a href="functionality/">Integrating Functionality</a> &rarr; <a href="updates/">Updates & Releases</a>
    </p>
    <h2> Quickstart </h2>
  ...
  <TabItem value="refs" label='References' attributes={{className: styles.refs}}>
    ...
    <a href='../references/ic-interface-spec'> IC Interface Specification </a></p>
  ...
  <TabItem value="concepts" label='Concepts' attributes={{className: styles.concepts}}>
    ...
    <p> The Concepts category will guide you through the more foundational story underlying core parts of the IC.
      ...
      <a href='../concepts/data-centres'> Data Centres </a> &rarr; 
      ...
      <p>The topics in this section introduce key components and terminology to help you understand the architecture and operation of the IC. The concepts here are not necessarily needed for dapp development, but rather knowledge development.
        Read an <a href="./what-is-IC.md">overview of the IC</a> and the <a href="./nodes-subnets.md">nodes</a> and <a href="./data-centers.md">data centres</a> that power it. 
        You can learn more about <a href="./canisters-code.md">canisters</a>, how and why they allow to build decentralized apps hosted fully on chain, and why we should place our <a href="./trust-in-canisters.md">trust</a> in them. 
        We can see more about how canisters are powered by <a href="tokens-cycles.md">tokens and cycles</a> and how the Internet Computer is <a href="./governance.md">governed</a> and developed in a decentralized manner. </p>
  </TabItem>
  <TabItem value="tokens" label='Tokenomics' attributes={{className: styles.tokens}}>
    ...
    <p><a href='../tokenomics/identity-auth'> Identity & Authentication </a> &rarr;
    ...
    <p> The <a href='../tokenomics/identity-auth'> Identity & Authentication </a> section is the best place to understand how to interact with the IC without the need for holding tokens. 
