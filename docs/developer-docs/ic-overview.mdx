...
<Tabs>
  ...
  <TabItem value="tokens" label='DAOs & Tokenomics' attributes={{className: styles.tokens}}>
    ...
    <p> The <a href='../tokenomics/nns/'> NNS section </a> is the best place to get an overview of the NNS and how to get involved in the governance of the IC, while the <a href='../tokenomics/sns/'> SNS section </a> explains the first steps to decentralizing your own dapp.
