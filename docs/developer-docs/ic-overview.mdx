...
<Tabs>
  ...
  <TabItem value="tokens" label='DAOs & Tokenomics' attributes={{className: styles.tokens}}>
    ...
    <p>The DAOs and tokenomics category is aimed at founders, developers and DAO communities, and gives a tour of the governance and tokenomics topics that can be used in development, or simply when engaging with the IC ecosystem.
  ...
  <TabItem value="samples" label='Sample Code' attributes={{className: styles.samples}}>
    <h2> Sample Code </h2>
    <p>Finally, you can find documentation relating to Sample dapps and community projects.  </p>
    ...
    <a href='../samples/t-ecdsa-samples'> signing with threshold ECDSA </a> &rarr;
