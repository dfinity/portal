...
If you’ve landed here, it's likely that you're interested in learning more about the Internet Computer and the process to develop decentralized applications therein. 
...
<Tabs
  defaultValue="docs"
  values={[
    {label: 'Developer Docs', value: 'docs'},
    {label: 'References', value: 'refs'},
    {label: 'Concepts', value: 'concepts'},
    {label: 'Tokenomics', value: 'tokens'},
  ]}>
  <TabItem value="docs">
    <h3> A tour through the docs </h3>

  Put my text 
  <code class="language-shell"> sh -ci "$(curl -fsSL https://sdk.dfinity.org/install.sh)" </code>

  And some more 

  And then I will see about links in html

  </TabItem>
  <TabItem value="refs">
    # References
  </TabItem>
  <TabItem value="concepts">Concepts</TabItem>
  <TabItem value="tokens">Tokenomics</TabItem>
</Tabs>
