...
The CMC is governed entirely by the [NNS (Network Nervous System)](https://learn.internetcomputer.org/hc/en-us/articles/33692645961236-Overview) and receives configuration updates through proposals.
...
#### Returns
    ```candid
    variant { Ok: nat; Err: NotifyError } // Number of cycles minted and deposited
    ```
