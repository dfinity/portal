...
For details about the syntax to use for different data types, see the [*Candid Guide*](/docs/current/building-dapps/interacting-with-dapps/candid/candid-concepts) and [Candid specification](https://github.com/dfinity/candid/tree/master/spec).
