...
The public node metrics feature enables any individual to scrape data about a node's health or metrics through the node's IPv6 address through HTTPS port 42372 at the following URLs:
...
If you selected virtual machine provisioning in the previous step, the virtual machine will be provisioned, K3s will be deployed, and an instance of Prometheus will be deployed.

If you selected remote machine provisioning, K3s will be deployed on the remote machine, and an instance of Prometheus will be deployed.
