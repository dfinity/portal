...
The [Bitcoin mainnet](/docs/build-on-btc/index) system canister is used to facilitate connection from the ICP mainnet to the Bitcoin mainnet.
...
The [Bitcoin testnet](/docs/build-on-btc/index) system canister is used to facilitate connection from the ICP mainnet to the Bitcoin testnet.
