...
The [cycles ledger](/docs/developer-docs/defi/cycles/cycles-ledger) canister is used for cycles management and has been developed as an alternative to the cycles wallet. The cycles ledger allows principals to hold cycles directly rather than requiring a separate cycles wallet canister to be used.
...
The [cycles ledger index](/docs/developer-docs/defi/cycles/cycles-ledger) canister is the corresponding index canister for the cycles ledger.
...
- [NNS governance](/docs/move-to-learnhub/nns/overview): Canister ID [`rrkah-fqaaa-aaaaa-aaaaq-cai`](https://dashboard.internetcomputer.org/canister/rrkah-fqaaa-aaaaa-aaaaq-cai)
- [NNS lifeline](/docs/move-to-learnhub/nns/overview): Canister ID [`rno2w-sqaaa-aaaaa-aaacq-cai`](https://dashboard.internetcomputer.org/canister/rno2w-sqaaa-aaaaa-aaacq-cai)
- [NNS registry](/docs/move-to-learnhub/nns/overview): Canister ID [`rwlgt-iiaaa-aaaaa-aaaaa-cai`](https://dashboard.internetcomputer.org/canister/rwlgt-iiaaa-aaaaa-aaaaa-cai)
- [NNS root](/docs/move-to-learnhub/nns/overview): Canister ID [`r7inp-6aaaa-aaaaa-aaabq-cai`](https://dashboard.internetcomputer.org/canister/r7inp-6aaaa-aaaaa-aaabq-cai)
- [NNS UI](/docs/move-to-learnhub/nns/overview): Canister ID [`qoctq-giaaa-aaaaa-aaaea-cai`](https://dashboard.internetcomputer.org/canister/qoctq-giaaa-aaaaa-aaaea-cai)
