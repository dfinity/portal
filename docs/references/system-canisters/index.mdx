...
The CMC converts ICP to [cycles](/docs/building-apps/essentials/gas-cost). Cycles are used up by canisters as they do work (simply storing data counts as doing work, even when no code in the canister is running). In this conversion, ICP is destroyed, and cycles are created. Thus, this operation is referred to as cycles "minting".

The CMC has canister ID [`rkp4c-7iaaa-aaaaa-aaaca-cai`](https://dashboard.internetcomputer.org/canister/rkp4c-7iaaa-aaaaa-aaaca-cai).
