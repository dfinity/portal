...
<input type="checkbox"/> <a href="/current/developer-docs/getting-started/install">Install the IC SDK.</a>
<div>
</div>
...
To test the XRC demo locally, first start the [local development environment](/building-apps/test/pocket-ic) with the command:
