...
[`dfxvm`](/docs/current/references/dfxvm/docs/cli-reference/dfxvm/dfxvm) is a command-line tool used to installing and switching between different versions of `dfx`. It enables developers to pivot between different projects that are built with different `dfx` versions. 

- [Install `dfxvm`](/docs/current/references/dfxvm/docs/cli-reference/dfxvm/dfxvm-install).

- [`dfxvm` documentation](/docs/current/references/dfxvm/docs/cli-reference/dfxvm/dfxvm).
...
- [JavaScript/TypeScript agent (@dfinity/agent)](/docs/current/developer-docs/agents/javascript-intro.md)

- [Node.js, supported through the JavaScript agent](/docs/current/developer-docs/agents/nodejs)
  
- [Rust agent (ic-agent)](/docs/current/developer-docs/agents/ic-agent-dfinity.md)
