...
For more information about parameter naming, see [Naming arguments and results](/building-apps/interact-with-canisters/candid/candid-concepts#service-naming).
...
#### Subtypes
The following modifications to a function type change it to a subtype as discussed in the rules for [service upgrades](/building-apps/interact-with-canisters/candid/candid-concepts#upgrades):
...
See [Candid service descriptions](/building-apps/interact-with-canisters/candid/candid-concepts#candid-service-descriptions) for more details on the syntax of a service type.
...
This is exactly the same principle as discussed for upgrade rules in [service upgrades](/building-apps/interact-with-canisters/candid/candid-concepts#upgrades).
