...
vetKeys stands for ‘**V**erifiable Encrypted Threshold Keys’. This feature enables a number of cryptographic functionalities on ICP, with the primary motivation of the feature being facilitating onchain encryption. There are many use cases and motivations for [building vetKD](https://youtu.be/baM6jHnmMq8).
