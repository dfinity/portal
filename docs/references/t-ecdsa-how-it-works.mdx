...
-   [`sign_with_schnorr`](/docs/current/references/ic-interface-spec#ic-ecdsa_public_key): Returns a new Schnorr signature of the given `message` that can be separately verified against a derived Schnorr public key. 
