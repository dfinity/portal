...
Signatures will have different encoding depending on the provided `key_id` algorithm. For `bip340secp256k1`, the signature will be encoded according to [BIP340](https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki), using 64 bytes.
