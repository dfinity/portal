...
This power is granted in advance through an NNS [proposals](#p) stored in the [registry canister](#r).
The proposal defines maximum NO capacity, and is scoped to a specific [node provider](#n), in a specific [data center](#d) with a specific IPv6 prefix.
