...
at a specific place in its state tree. Details can be found in the [Internet Computer interface specification](/docs/references/ic-interface-spec/).
...
[The Internet Computer interface specification](/docs/references/ic-interface-spec) has more
detail.
