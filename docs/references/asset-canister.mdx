...
[Learn more about the HTTP certification library](/docs/current/developer-docs/smart-contracts/advanced-features/http-compatible-canisters/serving-static-assets-over-http)
