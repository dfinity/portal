...
For more information about parameter naming, see [Naming arguments and results](../developer-docs/build/candid/candid-concepts#service-naming).
...
Subtypes  
The following modifications to a function type change it to a subtype as discussed in the rules for [Service upgrades](../developer-docs/build/candid/candid-concepts#upgrades):
...
See [Candid service descriptions](../developer-docs/build/candid/candid-concepts#candid-service-descriptions) for more details on the syntax of a service type.
...
This is exactly the same principle as discussed for upgrade rules in [Service upgrades](../developer-docs/build/candid/candid-concepts#upgrades).
