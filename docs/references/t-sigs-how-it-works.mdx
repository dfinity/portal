...
For the authoritative specification, the reader is referred to the corresponding part of the Internet Computer interface specification for [ECDSA](/docs/current/references/ic-interface-spec#ic-ecdsa_public_key) and [Schnorr](/docs/current/references/ic-interface-spec#ic-schnorr_public_key).
