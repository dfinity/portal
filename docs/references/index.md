...
Explore the IC SDK and its subcommands in the [dfx Commands and Envars](cli-reference/index.md) section and check our beloved [dfx.json](dfx-json-reference.md) schema. 
