...
For further information on calling canisters, see the [smart contract docs](../building-dapps/interacting-with-dapps/advanced-calls) and the [IC spec](./ic-interface-spec#system-api-requests).
