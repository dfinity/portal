...
You can learn more about subnets and how they work [here](/docs/references/subnets/overview).
...
Adjust the `--amount 0.5` to the number of ICP tokens that you want to send the new canister. More information can be found in the [documentation](/docs/building-apps/developer-tools/dfx/dfx-parent/dfx-ledger/#options).
