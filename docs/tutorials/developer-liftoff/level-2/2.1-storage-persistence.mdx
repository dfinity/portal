...
:::info
Upgrading canisters written in Rust and other languages uses a different workflow that incorporates serialization of the canister's data. [Learn more about Rust upgrades](/building-apps/developer-tools/cdks/rust/intro-to-rust).
:::
...
[Take a deeper dive into stable variables](/building-apps/canister-management/upgrade#declaring-stable-variables).
