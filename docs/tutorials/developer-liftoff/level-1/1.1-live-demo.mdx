...
In this tutorial, you'll deploy the `hello_world_backend` canister from [0.6: Introduction to dfx](/docs/current/tutorials/developer-liftoff/level-0/intro-dfx) to the Motoko playground.
...
This example works with the canister previously created in the [0.6: Introduction to dfx](/docs/current/tutorials/developer-liftoff/level-0/intro-dfx) module. It is recommended to complete that module before beginning the steps outlined here.
...
Then, navigate into the project that you created in the [0.6: Introduction to dfx](/docs/current/tutorials/developer-liftoff/level-0/intro-dfx) module. You can use a command such as:
...
For a review on the project's structure and our `main.mo` source code file, you can review the [0.6: Introduction to dfx](/docs/current/tutorials/developer-liftoff/level-0/intro-dfx) module.
...
If you recall from the [0.6: Introduction to dfx](/docs/current/tutorials/developer-liftoff/level-0/intro-dfx) module, our canister has a single method called `greet`, which you can call using a command such as:
