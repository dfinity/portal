...
You will be building off of the previous module [1.3: Intro to dfx](/tutorials/developer-liftoff/level-1/1.3-intro-dfx). You will need to have followed along and deployed the `hello_world_backend` canister locally to complete this tutorial.
...
- Using a third-party service such as [CycleOps](/building-apps/canister-management/topping-up).

Local development fabricates cycles as needed for canister deployment. To learn about topping up canisters on the mainnet, [read more about how to use ICP or cycles](/building-apps/developing-canisters/deploy#topping-up-canisters).
