...
When you open this URL in your web browser, you will see the app's frontend user interface. Your dapp is hosted 100% onchain, does not rely on your local <GlossaryTooltip>replica</GlossaryTooltip> to keep running, and you can send this URL to your friends and get them to use your app!
