...
This page introduces some of the most commonly used terminology that developers should be aware of when building on ICP. [View the full glossary of terms](/references/glossary).
