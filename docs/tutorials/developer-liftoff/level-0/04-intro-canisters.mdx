...
You'll dive further into Motoko and other languages in the next section, [introduction to languages](/docs/current/tutorials/developer-liftoff/level-0/intro-languages).
