...
The following is a list of the essential `dfx` subcommands that you'll be using throughout the developer liftoff series. For the full list of all possible subcommands, check out the [dfx reference documentation](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/).
...
Below are the essential options that you'll be referencing throughout the developer liftoff. For the full list of options, see the [reference documentation](/docs/current/developer-docs/developer-tools/cli-tools/cli-reference/).
