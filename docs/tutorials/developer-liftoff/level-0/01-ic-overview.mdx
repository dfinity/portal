...
The Internet Computer's utility token is **ICP**. It is used for network activities like token staking in return for voting power in the network's [governance](https://learn.internetcomputer.org/hc/en-us/articles/34574082263700-Tokenomics-Governance) or being converted into **cycles**, which are used to fund canisters deployed on the mainnet.
