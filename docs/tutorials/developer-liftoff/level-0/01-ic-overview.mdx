...
These terms will be explained a bit further in the next section, [Internet Computer terminology](/docs/current/tutorials/developer-liftoff/level-0/ic-terms).
