...
[Learn more about working with `Option` and `Result` types](/docs/motoko/fundamentals/error-handling#working-with-optionresult).
...
- [Motoko mutable state](/docs/motoko/fundamentals/state).

- [Motoko message inspection](/docs/motoko/fundamentals/messaging).

- [Local object classes](/docs/motoko/fundamentals/types/objects-classes).

- [Motoko error handling](/docs/motoko/fundamentals/error-handling).
