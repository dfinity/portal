---
keywords: [advanced, tutorial, developer liftoff, motoko]
---
...
In this final Motoko module of the developer liftoff series, you'll cover the following Motoko concepts and components:
...
That'll wrap up level 4 of the developer liftoff! Next, you'll dive into the final level, level 5:
