...
For additional information on the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](/building-apps/governing-apps/nns/using-the-nns-dapp/nns-app-quickstart) and the [NNS explained series](https://youtu.be/1uX-fRgvXjU?feature=shared).
...
- SNS [ledger](/building-apps/governing-apps/launching/integrating) and archive canisters.

- SNS [index](/building-apps/governing-apps/launching/integrating) canister.
...
* [SNS launch](/building-apps/governing-apps/launching/launch-summary-1proposal).

* [An introduction to SNS preparation](/building-apps/governing-apps/tokenomics/).

* [The SNS launch checklist](/building-apps/governing-apps/tokenomics/sns-checklist).

* [Pre-deployment considerations](/building-apps/governing-apps/tokenomics/predeployment-considerations).

* [SNS parameters](/building-apps/governing-apps/tokenomics/preparation).

* [Guidelines on how to test an SNS locally](/building-apps/governing-apps/testing/testing-locally).

* [Stages included in an SNS launch](/building-apps/governing-apps/launching/launch-summary-1proposal).

* [SNS proposals](/building-apps/governing-apps/managing/making-proposals).

* [Tips regarding cycles management for the canisters](/building-apps/governing-apps/managing/cycles-usage).

* [An introduction to how to use the asset canister with an SNS-controlled dapp](/building-apps/governing-apps/managing/sns-asset-canister).
