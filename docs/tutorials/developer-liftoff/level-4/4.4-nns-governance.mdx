...
[Learn more about neurons and their attributes](/docs/move-to-learnhub/nns/overview#neurons).
...
[View detailed information about different proposal types and topics](/docs/move-to-learnhub/nns/overview#topics).
...
* [Service Nervous System (SNS) developer docs](https://internetcomputer.org/docs/building-apps/governing-apps/).
...
If you scroll further, you can see advanced details and settings, such as when the neuron was created, its neuron account ID, and options to participate in the neurons' fund or split the neuron. [Learn more about these advanced options](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-app-quickstart).
...
For additional information on the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](/docs/move-to-learnhub/nns/using-the-nns-dapp/nns-app-quickstart) and the [NNS explained series](https://youtu.be/1uX-fRgvXjU?feature=shared).
