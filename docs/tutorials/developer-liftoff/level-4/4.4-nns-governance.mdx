...
For additional information on the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](/docs/building-apps/governing-apps/nns/using-the-nns-dapp/nns-dapp-quickstart) and the [NNS explained series](https://youtu.be/1uX-fRgvXjU?feature=shared).
