...
[Learn more about neurons and their attributes](https://internetcomputer.zendesk.com/hc/en-us/articles/34084120668692-NNS-Neurons).
...
[View detailed information about different proposal types and topics](https://internetcomputer.zendesk.com/hc/en-us/articles/34084120668692-NNS-Neurons).
...
For additional information on the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](https://internetcomputer.zendesk.com/hc/en-us/articles/33692645961236-NNS-Network-Nervous-System) and the [NNS explained series](https://youtu.be/1uX-fRgvXjU?feature=shared).
