...
The developer liftoff will dive deeper into threshold ECDSA in a future tutorial. You can also take a deep dive in the [technology overview to learn more](/docs/current/references/t-sigs-how-it-works/).
