...
The EVM RPC canister enables your dapp to sign and submit transactions to Ethereum and other EVM networks using [HTTPS outcalls](/building-apps/network-features/using-http/https-outcalls/overview) and [threshold ECDSA signatures](/building-apps/network-features/signatures/t-ecdsa).
