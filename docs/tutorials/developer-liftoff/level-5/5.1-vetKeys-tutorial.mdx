...
<<<<<<< HEAD
Need a reminder on how to create an Internet Identity? Review the [3.5 Identities and authentication](/docs/current/tutorials/developer-liftoff/level-3/3.5-identities-and-auth) level of the developer ladder.
=======
Need a reminder on how to create an Internet Identity? Review the [3.5 Identities and authentication](/docs/current/tutorials/developer-liftoff/level-3/3.5-identities-and-auth) level of the developer liftoff.
...
- [5.2 Deploying an ETH starter project on ICP](/docs/current/tutorials/developer-liftoff/level-5/5.2-ICP-ETH-tutorial)