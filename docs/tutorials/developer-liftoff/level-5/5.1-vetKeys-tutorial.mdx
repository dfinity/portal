...
This tutorial will not dive into the frontend's configuration, as it is focused on the vetKey implementation within the backend of the dapp. [Learn more about frontend canisters](/building-apps/frontends/using-an-asset-canister).
...
Need a reminder on how to create an Internet Identity? Review the [3.5 Identities and authentication](/tutorials/developer-liftoff/level-3/3.5-identities-and-auth) level of the Developer Liftoff.
...
- [vetKeys documentation](/building-apps/network-features/vetkeys/introduction).

- [vetKeys technology overview](/references/vetkeys-overview).

- [vetKeys example](/building-apps/network-features/vetkeys/demos/send_file_to_eth).
