...
This example will use ICRC-2 tokens. To learn more about ICRC tokens, refer to the previous module [4.2: ICRC tokens](/docs/current/tutorials/developer-liftoff/level-4/4.2-icrc-tokens).
