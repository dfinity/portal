...
```motoko
  ...
  public func fetchAndStoreOnThisDay(date : Text) : async Result.Result<Text, Text> {
    ...
    if (currentData.onThisDay == null) {
      ...
      // "transform" is used to specify how the HTTP response is processed before [consensus](https://learn.internetcomputer.org/hc/en-us/articles/34207558615956-Consensus) tries to agree on a response.
...
>>>>>>> f8b800c85744ad61560d86c63b85ad6dd07861e9
```
