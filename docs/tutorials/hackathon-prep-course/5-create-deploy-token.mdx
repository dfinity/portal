...
Open the [ICP Ninja Tokenmania](https://icp.ninja/projects/tokenmania) example to create your own ICRC-1 token.
...
You will be required to authenticate with [Internet Identity](/docs/building-apps/authentication/integrate-internet-identity). Once authenticated, you'll be prompted to input the configuration details for your new token:
