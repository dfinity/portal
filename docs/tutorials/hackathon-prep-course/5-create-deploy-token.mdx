...
Once you open the application, you will be required to authenticate with [Internet Identity](/building-apps/authentication/integrate-internet-identity). Then you'll be prompted to input the configuration details for your new token:
