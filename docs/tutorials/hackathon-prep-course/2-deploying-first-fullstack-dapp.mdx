...
- `mops.toml`: The package manager configuration file for the project, using the Mops package manager. You will learn more about Mops in the next module, [3: Exploring the backend](/docs/current/tutorials/hackathon-prep-course/3-exploring-the-backend).
...
You will learn how to obtain and use cycles in the upcoming module, [7: Obtaining cycles and deploying to the mainnet](/docs/current/tutorials/hackathon-prep-course/7-obtaining-cycles).
