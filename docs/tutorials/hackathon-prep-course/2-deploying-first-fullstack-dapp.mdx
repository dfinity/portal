...
- **Account identifier**: The identifier associated with your ICP ledger account, as specified in the [ledger specification](https://internetcomputer.org/docs/references/ledger#_accounts).
...
You can learn more about [identities and principals](/docs/current/tutorials/developer-liftoff/level-3/3.5-identities-and-auth).
