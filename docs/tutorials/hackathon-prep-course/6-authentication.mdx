...
You can learn more about Internet Identity and integrating it into a dapp in the tutorial [here](/docs/tutorials/developer-journey/level-3/3.5-identities-and-auth).
