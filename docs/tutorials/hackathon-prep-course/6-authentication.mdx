...
To integrate II into your dapp, you can **pull** the Internet Identity canister from the mainnet. This is an example of using the `dfx deps` functionality, which you covered briefly in the previous module, [3: Exploring the backend](/docs/current/tutorials/hackathon-prep-course/exploring-the-backend).
...
You can learn more about Internet Identity and integrating it into a dapp in the tutorial [here](/docs/current/tutorials/developer-liftoff/level-3/3.5-identities-and-auth).
