...
If such cycles faucet coupon was handed out to you, navigate to the website [https://faucet.dfinity.org](https://faucet.dfinity.org) and follow the instructions there.
