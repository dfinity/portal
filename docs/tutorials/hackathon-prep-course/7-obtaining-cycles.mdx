...
Now that you've obtained some cycles and created a cycles wallet, you can deploy your [`vite-motoko-react`](/docs/current/tutorials/hackathon-prep-course/deploying-first-fullstack-dapp) sample project to the mainnet.
