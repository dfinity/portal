...
[Learn more about agents](/building-apps/interact-with-canisters/agents/overview).
...
[Learn more about storage and data persistence](/tutorials/developer-liftoff/level-2/2.1-storage-persistence).
