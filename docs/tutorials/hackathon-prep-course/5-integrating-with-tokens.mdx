...
To interact with ICRC-2 locally, you will need to deploy the [ICRC-1 ledger canister locally](/docs/current/tutorials/developer-liftoff/level-4/4.2-icrc-tokens#deploying-a-icrc-1-ledger-locally).
...
:::info
This sample command references a [locally deployed ICRC-1 ledger canister](/docs/current/tutorials/developer-liftoff/level-4/4.2-icrc-tokens#deploying-a-icrc-1-ledger-locally).
:::
