...
:::info
This sample command specifications a [locally deployed ICRC-1 ledger canister](/docs/current/tutorials/developer-journey/level-4/4.2-icrc-tokens#deploying-a-icrc-1-ledger-locally).
This sample command specifications a [locally deployed ICRC-1 ledger canister](/docs/current/tutorials/developer-journey/level-4/4.2-icrc-tokens#deploying-a-icrc-1-ledger-locally).
:::
