...
The function runs on a single replica and does not go through consensus. Therefore, it should not be used for secure or definitive access control as it can be spoofed by a malicious boundary node.
