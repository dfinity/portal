...
- **Principals**: Generic identifiers that are used for users, canisters, and potentially other future concepts. You can learn more in the IC [specification](/docs/references/ic-interface-spec#principal).
