...
:::info
When creating new projects with `dfx`, only alphanumeric characters, underscores, and hyphens should be used. This is to ensure that project names are valid within Rust, JavaScript, and other contexts.
:::
