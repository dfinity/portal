...
To use stable structures in Rust, the [stable-structures library](https://github.com/dfinity/stable-structures#readme) provides simple, scalable tools and examples to help you get started.
