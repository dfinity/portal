...
- ** [Hackathon projects](/docs/current/tutorials/samples/hackathon-projects)**
- ** [Hosting a web game on the Internet Computer](/docs/current/tutorials/samples/host-a-webgame)**
- ** [Hosting a static website on the Internet Computer](../samples/host-a-website)**
- ** [ICP transfer sample code](/docs/current/tutorials/samples/token-transfer)**
- ** [IOS integration](../samples/ios-integration)**
- ** [NFT minting](/docs/current/tutorials/samples/nft)**
- ** [Threshold ECDSA signing code walkthrough](/docs/current/tutorials/samples/t-ecdsa-sample)**
