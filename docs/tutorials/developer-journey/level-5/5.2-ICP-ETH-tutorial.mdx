...
The EVM RPC canister enables your dapp to sign and submit transactions to Ethereum and other EVM networks using [HTTPS outcalls](/docs/current/building-apps/using-network-features/using-http/https-outcalls/overview) and [threshold ECDSA signatures](/docs/current/building-apps/using-network-features/signatures/t-ecdsa). The EVM RPC canister will eventually be replaced by an onchain Ethereum API on ICP, made possible by running full Ethereum nodes on each ICP replica.
...
- The EVM RPC canister, which is pulled into the project using [`dfx deps`](/docs/current/building-apps/creating-dapps/using-third-party-canisters).
...
This tutorial will not dive into the frontend's configuration. [Learn more about frontend canisters](/docs/current/building-apps/dapp-frontends/using-an-asset-canister).
...
- [How it works: EVM RPC canister](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/how-it-works).

- [Using the EVM RPC canister](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/evm-rpc-canister).

- [Costs of RPC requests](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/costs).

- [Samples using the EVM RPC canister](/docs/current/building-apps/chain-fusion/ethereum/evm-rpc/samples).
