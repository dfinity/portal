...
Each of these components of vetKeys are described further in the [vetKeys primer](/blog/features/vetkey-primer).
...
This tutorial will not dive into the frontend's configuration, as it is focused on the vetKey implementation within the backend of the dapp. [Learn more about frontend canisters](/docs/current/developer-docs/frontend/).
