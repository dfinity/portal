---
keywords: [advanced, tutorial, developer journey, vetkeys, vetkd]
---
...
shared({ caller = initializer }) actor class() {
    ...
    // You can learn more about upgrades in the Motoko docs: https://internetcomputer.org/docs/current/motoko/main/canister-maintenance/upgrades/
    ...
    // You can refer to the Motoko docs for more information: https://internetcomputer.org/docs/current/motoko/main/writing-motoko/actors-async
...
This tutorial will not dive into the frontend's configuration, as it is focused on the vetKey implementation within the backend of the dapp. [Learn more about frontend canisters](/docs/current/developer-docs/web-apps/application-frontends/overview).
...
Need a reminder on how to create an Internet Identity? Review the [3.5 Identities and authentication](/docs/current/tutorials/developer-journey/level-3/3.5-identities-and-auth) level of the developer journey.
...
- [vetKeys documentation](/docs/current/developer-docs/smart-contracts/encryption/vetkeys).

- [vetKeys technology overview](/docs/current/references/vetkeys-overview).

- [vetKeys example](/docs/current/developer-docs/smart-contracts/encryption/using-vetkeys).
...
- [5.2 Deploying an ETH starter project on ICP](/docs/current/tutorials/developer-journey/level-5/5.2-ICP-ETH-tutorial)
