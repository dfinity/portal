...
This tutorial will not dive into the frontend's configuration, as it is focused on the vetKey implementation within the backend of the dapp. [Learn more about frontend canisters](/docs/current/building-dapps/dapp-frontends/using-an-asset-canister).
...
- [vetKeys documentation](/docs/current/building-dapps/using-network-features/encryption/vetkeys).

- [vetKeys technology overview](/docs/current/references/vetkeys-overview).

- [vetKeys example](/docs/current/building-dapps/using-network-features/encryption/using-vetkeys).
