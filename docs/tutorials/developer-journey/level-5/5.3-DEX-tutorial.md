...
This tutorial will not dive into the frontend's configuration, as it is focused on the DeFi implementation within the backend of the dapp. If you want to learn more about frontend canisters, check out the documentation [here](/docs/current/developer-docs/frontend).
