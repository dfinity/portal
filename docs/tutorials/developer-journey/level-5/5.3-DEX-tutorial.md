...
:::caution
In this example, the token standard [DIP20](https://github.com/Psychedelic/DIP20) is used for the sample tokens on the decentralized exchange. DIP20 was designed to resemble the fungible token standard ERC20 on Ethereum. For creating new tokens on the IC, it is recommended to use the ICRC standard, covered in [4.2 ICRC tokens](../level-4/4.2-icrc-tokens.md).
:::

## Decentralized exchange architecture

In this project, the decentralized exchange is comprised of a backend canister that interacts with token canisters and a ledger canister. This example also includes a local instance of the Internet Identity canister to enable logging into the exchange using II. This example's functionality can be described using the following steps:
...
This tutorial will not dive into the frontend's configuration, as it is focused on the DeFi implementation within the backend of the dapp. If you want to learn more about frontend canisters, check out the documentation [here](/docs/current/developer-docs/frontend/index.md).
...
To place an order, select the plus (+) sign icon next to the heading 'Orders', then select the parameters for the order. These parameters include selecting a trading pair by choosing the 'From Account', the amount to trade, then the 'To Account' and the amount to trade. For this example, the order of '1000 AKI' to '1000 GLD' is placed. 
...
In your open terminal window, the DEX logs can be seen, which reflect these transactions:

```
2023-11-15 22:25:53.981824 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders...
2023-11-15 22:25:53.981824 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders on exchange be2us-64aaa-aaaaa-qaabq-cai/br5f7-7uaaa-aaaaa-qaaca-cai
2023-11-15 22:26:01.141544 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] Depositing Token: be2us-64aaa-aaaaa-qaabq-cai LEDGER: bkyz2-fmaaa-aaaaa-qaaaq-cai
2023-11-15 22:26:13.490900 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] 
2023-11-15 22:26:13.490900 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] Placing order 1 from user s43ze-xufdn-rdj7h-zz23m-nhvv5-5q4qk-sy5ro-b6tuy-czz4w-yjqoj-nae for selling 1000 tokens be2us-64aaa-aaaaa-qaabq-cai
2023-11-15 22:26:13.490900 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders on exchange be2us-64aaa-aaaaa-qaabq-cai/br5f7-7uaaa-aaaaa-qaaca-cai
2023-11-15 22:26:15.426832 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders...
2023-11-15 22:26:15.426832 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders on exchange be2us-64aaa-aaaaa-qaabq-cai/br5f7-7uaaa-aaaaa-qaaca-cai
2023-11-15 22:26:20.527115 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] 
2023-11-15 22:26:20.527115 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] Placing order 2 from user s43ze-xufdn-rdj7h-zz23m-nhvv5-5q4qk-sy5ro-b6tuy-czz4w-yjqoj-nae for selling 1000 tokens br5f7-7uaaa-aaaaa-qaaca-cai
2023-11-15 22:26:20.527115 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders on exchange be2us-64aaa-aaaaa-qaabq-cai/br5f7-7uaaa-aaaaa-qaaca-cai
2023-11-15 22:26:20.527115 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] Process trade between order 2 and order 1
2023-11-15 22:26:22.480823 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders...
2023-11-15 22:26:22.480823 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders on exchange be2us-64aaa-aaaaa-qaabq-cai/br5f7-7uaaa-aaaaa-qaaca-cai
2023-11-15 22:26:24.389091 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders...
2023-11-15 22:26:24.389091 UTC: [Canister b77ix-eeaaa-aaaaa-qaada-cai] List orders on exchange be2us-64aaa-aaaaa-qaabq-cai/br5f7-7uaaa-aaaaa-qaaca-cai
```
