...
[View the source code for the DIP721 standard](https://github.com/Psychedelic/DIP721), and read the full [standard specification document](https://github.com/Psychedelic/DIP721/blob/develop/spec.md).
...
Read more about the [ICRC-7 standard in the specification draft document](https://github.com/dfinity/ICRC/blob/icrc7-wg-draft/ICRCs/ICRC-7/ICRC-7.md).
