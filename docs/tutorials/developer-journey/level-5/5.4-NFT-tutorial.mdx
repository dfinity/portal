---
keywords: [advanced, tutorial, developer ladder, nfts]
---
...
      ?{
        symbol = ?"DEVS";
        name = ?"Developer Ladder Astronauts";
        description = ?"ICP Developer Ladder Astronauts";
...
(opt "ICP Developer Ladder Astronauts")
