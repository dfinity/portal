...
This tutorial will not dive into the frontend's configuration. If you want to learn more about frontend canisters, check out the documentation [here](/docs/current/developer-docs/frontend).
