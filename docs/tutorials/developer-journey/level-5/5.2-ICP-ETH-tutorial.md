...
Now that you have an Ethereum wallet with some SepoliaETH testnet tokens, it's time to deploy your IC ETH starter project. To do this, first assure that a local replica is running:
