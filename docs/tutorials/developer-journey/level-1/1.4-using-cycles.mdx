...
For new developers, a free cycles coupon can be obtained and redeemed for 10T free cycles that can be used to get started with dapp deployment. For this developer ladder, you'll be obtaining and using that free cycles coupon.
