...
You can learn more in the IC [specification](https://internetcomputer.org/docs/references/ic-interface-spec#principal).
:::
...
- **[Converting ICP tokens into cycles](/docs/defi/cycles/converting_icp_tokens_into_cycles)**.
