...
However, your developer identity principal is not the same as your account identifier that is specified in the [ledger](/docs/current/developer-docs/defi/tokens/token-standards). Your identity principal and your account identifier are related, but they use different formats.
...
To obtain a coupon code to use the cycles faucet, you need to put in a written request for the coupon via the [Discord](https://discord.interhttps://discord.internetcomputer.org
