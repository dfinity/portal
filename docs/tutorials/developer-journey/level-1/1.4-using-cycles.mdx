...
However, your developer identity principal is not the same as your account identifier that is specified in the [ledger](/docs/current/defi/token-standards/). Your identity principal and your account identifier are related, but they use different formats.
...
You can learn more in the IC [specification](https://internetcomputer.org/docs/current/specifications/ic-interface-spec#principal).
:::
...
- **[Converting ICP tokens into cycles](/docs/current/defi/cycles/converting_icp_tokens_into_cycles)**.
