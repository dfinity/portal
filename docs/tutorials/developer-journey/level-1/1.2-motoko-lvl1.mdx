---
keywords: [beginner, tutorial, developer journey, motoko]
---
...
Alternatively, if no space is used in the argument, it can be passed without quotes, since [Candid](/docs/current/developer-docs/smart-contracts/candid/candid-concepts) will infer the data type as `Text`, such as:
