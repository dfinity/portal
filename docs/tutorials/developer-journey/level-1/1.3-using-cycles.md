...
In this tutorial, we'll create a new identity with `dfx`, which we'll use to obtain cycles and deploy a cycles wallet. 
...
Once you have your ICP tokens ready, you will need to create a cycles wallet. This will require your identity principal, which you can obtain by running the command:
...
Replace the **PRINCIPAL_ID** with your identity's principal value, then replace **ICP_TOKENS** with the amount of tokens you'd like to convert into cycles. 
