...
Local development fabricates cycles as needed for canister deployment. To learn about topping up canisters on the mainnet, [read more about how to use ICP or cycles](/docs/current/building-dapps/getting-started/deploy-and-manage#topping-up-canisters)
