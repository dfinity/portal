...
Many of the DFINITY public repositories are hosted on Github, such as the `examples` repository used throughout this tutorial series. It is important to install `git` to assure that you can download the sample code and follow along.
