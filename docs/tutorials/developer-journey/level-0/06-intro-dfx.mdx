...
The following is a list of the essential `dfx` subcommands that you'll be using throughout the developer ladder series. For the full list of all possible subcommands, check out the [dfx reference documentation](/docs/building-apps/developer-tools/dfx/dfx-parent).
...
Below are the essential options that you'll be referencing throughout the developer ladder. For the full list of options, see the [reference documentation](/docs/building-apps/developer-tools/dfx/dfx-parent).
