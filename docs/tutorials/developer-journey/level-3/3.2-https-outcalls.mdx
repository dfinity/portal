...
    // See: https://internetcomputer.org/docs/references/ic-interface-spec#ic-http_request
...
- [3.3 Certified variables](/docs/tutorials/developer-journey/level-3/3.3-certified-data).