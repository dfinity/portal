...
```motoko no-repl file=../../../referencessamples/motoko/send_http_get/src/send_http_get_backend/main.mo#L1-L5
```
...
```motoko no-repl file=../../../referencessamples/motoko/send_http_get/src/send_http_get_backend/main.mo#L8-115
```
...
```motoko no-repl file=../../../referencessamples/motoko/send_http_get/src/send_http_get_backend/main.mo
```
...
```motoko no-repl file=../../../referencessamples/motoko/send_http_get/src/send_http_post_backend/main.mo#L1-4
```
...
```motoko no-repl file=../../../referencessamples/motoko/send_http_get/src/send_http_get_backend/main.mo#L6-106
```
