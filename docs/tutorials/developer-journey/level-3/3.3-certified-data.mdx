...
=======
- [Developer Discord community](https://discord.internetcomputer.org), which is a large chatroom for IC developers to ask questions, get help, or chat with other developers asynchronously via text chat.
>>>>>>> Stashed changes
