...
Upgrade your Node.js version to [v22.12.0](https://nodejs.org/en/download). Then, install the following packages with Mops:

```bash
mops install base@0.12.1
mops install sha2@0.1.0
mops install ic-certification@0.1.3
```
