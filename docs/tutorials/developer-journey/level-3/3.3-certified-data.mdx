---
keywords: [intermediate, tutorial, developer ladder, certified data, certified variables]
---
...
In a previous module, [2.2: Advanced canister calls](/docs/tutorials/developer-journey/level-2/2.2-advanced-canister-calls), you briefly touched on certified variables. In this guide, you'll dive deeper into certified data and take a look at an example that displays how to use certified data.
...
- [`ic0.certified_data_set : (src: i32, size : i32) -> ()`](https://internetcomputer.org/docs/references/ic-interface-spec#system-api-certified-data): This method can be used to update the canister's certified data. Data cannot be larger than 32 bytes.

- [`ic0.data_certificate_present : () -> i32`](https://internetcomputer.org/docs/references/ic-interface-spec#system-api-certified-data): This method returns a `1` if a certificate is present or a `0` if not.

- [`ic0.data_certificate_size : () -> i32`](https://internetcomputer.org/docs/references/ic-interface-spec#system-api-certified-data) and [`ic0.data_certificate_copy : (dst: i32, offset: i32, size: i32) -> ()`](https://internetcomputer.org/docs/references/ic-interface-spec#system-api-certified-data): These methods are used to copy the certificate for the current value of the certified data to the canister.
...
You will also need to install Mops, which was covered in the previous module [3.1: Motoko package managers](/docs/tutorials/developer-journey/level-3/3.1-package-managers).
