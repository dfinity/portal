...
```motoko no-repl file=../references/samples/archive/motoko/auth-client-demo/src/whoami/main.mo
```
...
```typescript file=../references/samples/archive/motoko/auth-client-demo/src/auth_client_demo_assets/vanilla/index.ts#L1-3
```


Then, you define some variables to define a day in nanoseconds:

```typescript file=../references/samples/archive/motoko/auth-client-demo/src/auth_client_demo_assets/vanilla/index.ts#L4-7
```
...
```typescript file=../references/samples/archive/motoko/auth-client-demo/src/auth_client_demo_assets/vanilla/index.ts#L9-23
```
...
```typescript file=../references/samples/archive/motoko/auth-client-demo/src/auth_client_demo_assets/vanilla/index.ts#L43-51
```

Lastly, you define a function that listens for the button on the frontend to be clicked and initialize the client:

```typescript file=../references/samples/archive/motoko/auth-client-demo/src/auth_client_demo_assets/vanilla/index.ts#L53-61
```
...
```json file=../references/samples/archive/motoko/auth-client-demo/dfx.json
```
