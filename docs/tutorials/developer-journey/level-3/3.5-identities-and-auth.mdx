...
- **Account identifier**: the identifier associated with your ICP ledger account, as specified in the [ledger](/docs/current/rosetta-defi/token-standards/index) specification.
