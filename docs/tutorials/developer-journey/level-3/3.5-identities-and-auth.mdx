...
- **Account identifier**: the identifier associated with your ICP ledger account, as specified in the [ledger](/docs/current/defi/token-standards/) specification.
...
For more details on how the Internet Identity architecture works, please refer to the [official Internet Identity Specification](https://internetcomputer.org/docs/current/specifications/ic-interface).
