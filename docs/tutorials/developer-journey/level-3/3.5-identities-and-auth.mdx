---
keywords: [intermediate, tutorial, developer ladder, identities, authentication]
---
...
```motoko no-repl file=../../../references/samples/archive/motoko/auth_client_demo/src/whoami/main.mo
```
...
```typescript file=../../../references/samples/archive/motoko/auth_client_demo/src/auth_client_demo_assets/vanilla/index.ts#L1-L3
```


Then, you define some variables to define a day in nanoseconds:

```typescript file=../../../references/samples/archive/motoko/auth_client_demo/src/auth_client_demo_assets/vanilla/index.ts#L4-L7
```
...
```typescript file=../../../references/samples/archive/motoko/auth_client_demo/src/auth_client_demo_assets/vanilla/index.ts#L9-L23
```
...
```typescript file=../../../references/samples/archive/motoko/auth_client_demo/src/auth_client_demo_assets/vanilla/index.ts#L43-L51
```

Lastly, you define a function that listens for the button on the frontend to be clicked and initialize the client:

```typescript file=../../../references/samples/archive/motoko/auth_client_demo/src/auth_client_demo_assets/vanilla/index.ts#L53-L61
```
...
```json file=../../../references/samples/archive/motoko/auth_client_demo/dfx.json
```
...
The Internet Identity canister requires an init argument. For more information, run the command `dfx deps init rdmx6-jaaaa-aaaaa-aaadq-cai`, which will provide an error message that includes more information:
