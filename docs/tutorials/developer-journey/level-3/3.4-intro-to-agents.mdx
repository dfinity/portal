...
Currently, there are two agents developed by DFINITY: the [JavaScript/TypeScript](/docs/current/building-apps/calling-dapps/agents/javascript-agent) agent and the [Rust](/docs/current/building-apps/calling-dapps/agents/overview) agent.
...
In JavaScript, type `Text` maps to type `String`. You can see a full mapping list of Candid types and their JavaScript equivalents in the [Candid types reference](/docs/current/specifications/candid-ref).
...
That'll wrap things up for this module! You can read more about agents, such as the [Node.js agent](/docs/current/building-apps/calling-dapps/agents/overview).
