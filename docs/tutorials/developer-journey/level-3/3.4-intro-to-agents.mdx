...
View the content of the `src/declarations/random_maze/index.js` file:

```javascript file=../../../references/samples/motoko/random_maze/src/declarations/random_maze/index.js
```
...
This example's code takes a variable size input and generates a random maze using that size. For example, if `6` is entered, a 6x6 maze will be generated. Generate the project's Candid files with the command:
