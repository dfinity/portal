...
Currently, there are two agents developed by DFINITY: the [JavaScript/TypeScript](/docs/current/developer-docs/developer-tools/off-chain/agents/javascript-agent) agent, and the [Rust](/docs/current/developer-docs/developer-tools/off-chain/agents/overviewic-agent-dfinity) agent.
