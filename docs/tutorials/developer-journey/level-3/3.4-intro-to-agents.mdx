...
Currently, there are two agents developed by DFINITY: the [JavaScript/TypeScript](/docs/current/building-dapps/interacting-with-dapps/agents/javascript-agent) agent and the [Rust](/docs/current/building-dapps/interacting-with-dapps/agents/overview) agent.
...
That'll wrap things up for this module! You can read more about agents, such as the [Node.js agent](/docs/current/building-dapps/interacting-with-dapps/agents/overview).
