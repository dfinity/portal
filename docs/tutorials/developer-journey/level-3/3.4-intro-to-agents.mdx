...
Currently, there are two agents developed by DFINITY: the [JavaScript/TypeScript](/docs/building-apps/interact-with-canisters/agents/javascript-agent) agent and the [Rust](/docs/building-apps/interact-with-canisters/agents/overview) agent.
