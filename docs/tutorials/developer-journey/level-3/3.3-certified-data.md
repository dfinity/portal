...
You will also need to install Mops, which was covered in the previous module [3.1: Motoko package managers](/docs/current/tutorials/developer-journey/level-3/3.1-package-managers).
