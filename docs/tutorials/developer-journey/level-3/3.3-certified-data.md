...
In a previous module, [2.2: Advanced canister calls](../level-2/2.2-advanced-canister-calls.md), you briefly touched on certified variables. In this guide, you'll dive deeper into certified data and take a look at an example that displays how to use certified data. 
...
You will also need to install Mops, which was covered in the previous module [3.1: Motoko package managers](3.1-package-managers.md).
