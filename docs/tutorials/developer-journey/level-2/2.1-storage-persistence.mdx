...
:::info
Upgrading canisters written in Rust and other languages uses a different workflow that incorporates serialization of the canister's data. [Learn more about Rust upgrades](/docs/current/building-apps/developer-tools/cdks/rust/upgrading).
:::
