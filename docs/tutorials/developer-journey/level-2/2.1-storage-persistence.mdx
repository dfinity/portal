...
:::info
Upgrading canisters written in Rust and other languages use a different workflow which incorporates serialization of the canister's data. [Learn more about Rust upgrades](/docs/current/building-dapps/developer-tools/cdks/rust/upgrading).
:::
