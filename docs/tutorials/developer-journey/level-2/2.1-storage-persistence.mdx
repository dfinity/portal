...
:::info
Upgrading canisters written in Rust and other languages use a different workflow which incorporates serialization of the canister's data. [Learn more about Rust upgrades](../../../developer-docs/backend/rust/upgrading.mdx).
:::
