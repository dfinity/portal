---
keywords: [intermediate, tutorial, developer journey, advanced canister calls, query calls, upgrade calls]
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/9BfDy3VNxu8?si=0FHL0c_CSGQzdfSQ" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
