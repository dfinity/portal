---
keywords: [advanced, tutorial, developer journey, nns, governance, sns]
---
...
- SNS [ledger](/docs/current/developer-docs/daos/sns/launching/integrating) and archive canisters.

- SNS [index](/docs/current/developer-docs/daos/sns/launching/integrating) canister.

- SNS root canister.

- SNS decentralization swap canister.

[Learn more about SNS architecture](/docs/current/developer-docs/daos/sns/overview).
...
* [SNS launch](/docs/current/developer-docs/daos/sns/launching/launch-summary-1proposal).
