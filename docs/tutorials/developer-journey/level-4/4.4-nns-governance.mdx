...
You will be prompted to log in with your Internet Identity. If you need to create one, check out the previous module [3.5 Identities and authentication](/docs/tutorials/developer-journey/level-3/3.5-identities-and-auth).
