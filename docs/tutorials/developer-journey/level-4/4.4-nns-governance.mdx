...
* [Service Nervous System (SNS) developer docs](https://internetcomputer.org/docs/current/building-apps/governing-dapps/).
...
- SNS [ledger](/docs/current/building-apps/governing-dapps/launching/integrating) and archive canisters.

- SNS [index](/docs/current/building-apps/governing-dapps/launching/integrating) canister.

- SNS root canister.

- SNS decentralization swap canister.

[Learn more about SNS architecture](/docs/current/building-apps/governing-dapps/overview).
...
* [SNS tokenomics](/docs/current/building-apps/governing-dapps/tokenomics/tokenomics-intro).

* [SNS rewards](/docs/current/building-apps/governing-dapps/tokenomics/rewards).

## SNS resources

To learn more about creating, launching, and managing an SNS, refer to the following resources:

* [SNS launch](/docs/current/building-apps/governing-dapps/launching/launch-summary-1proposal).

* [An introduction to SNS preparation](/docs/current/building-apps/governing-dapps/tokenomics/).

* [The SNS launch checklist](/docs/current/building-apps/governing-dapps/tokenomics/sns-checklist).

* [Pre-deployment considerations](/docs/current/building-apps/governing-dapps/tokenomics/predeployment-considerations).

* [SNS parameters](/docs/current/building-apps/governing-dapps/tokenomics/preparation).

* [Guidelines on how to test an SNS locally](/docs/current/building-apps/governing-dapps/testing/testing-locally).

* [Guidelines on how to test the operation of the dapp under SNS control](/docs/current/building-apps/governing-dapps/testing/testing-on-mainnet).

* [Stages included in an SNS launch](/docs/current/building-apps/governing-dapps/launching/launch-summary-1proposal).

* [SNS proposals](/docs/current/building-apps/governing-dapps/managing/making-proposals).

* [Tips regarding cycles management for the canisters](/docs/current/building-apps/governing-dapps/managing/cycles-usage).

* [An introduction to how to use the asset canister with an SNS-controlled dapp](/docs/current/building-apps/governing-dapps/managing/sns-asset-canister).
...
:::info
`MEMO` refers to a 64-bit numeric value as defined in the [IC specification](/docs/current/specifications/ledger#_transferring_tokens). It is used to generate unique hash values for transactions.
:::
