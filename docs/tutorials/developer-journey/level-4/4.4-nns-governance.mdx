...
[Learn more about neurons and their attributes](/docs/current/tokenomics/nns/nns-intro#neurons).
...
[View detailed information about different proposal types and topics](/docs/current/tokenomics/nns/nns-intro#topics).
