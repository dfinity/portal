---
keywords: [advanced, tutorial, developer ladder, nns, governance, sns]
---
...
[Learn more about neurons and their attributes](/docs/current/developer-docs/daos/nns/overview#neurons).
...
[View detailed information about different proposal types and topics](/docs/current/developer-docs/daos/nns/overview#topics).
...
* [Service Nervous System (SNS) developer docs](https://internetcomputer.org/docs/current/building-dapps/governing-dapps/).
...
- SNS [ledger](/docs/current/building-dapps/governing-dapps/launching/integrating) and archive canisters.

- SNS [index](/docs/current/building-dapps/governing-dapps/launching/integrating) canister.

- SNS root canister.

- SNS decentralization swap canister.

[Learn more about SNS architecture](/docs/current/building-dapps/governing-dapps/overview).
...
* [SNS tokenomics](/docs/current/building-dapps/governing-dapps/tokenomics/tokenomics-intro).

* [SNS rewards](/docs/current/building-dapps/governing-dapps/tokenomics/rewards).

## SNS resources

To learn more about creating, launching, and managing an SNS, refer to the following resources:

* [SNS launch](/docs/current/building-dapps/governing-dapps/launching/launch-summary-1proposal).

* [An introduction to SNS preparation](/docs/current/building-dapps/governing-dapps/tokenomics/).

* [The SNS launch checklist](/docs/current/building-dapps/governing-dapps/tokenomics/sns-checklist).

* [Pre-deployment considerations](/docs/current/building-dapps/governing-dapps/tokenomics/predeployment-considerations).

* [SNS parameters](/docs/current/building-dapps/governing-dapps/tokenomics/preparation).

* [Guidelines how to test an SNS locally](/docs/current/building-dapps/governing-dapps/testing/testing-locally).

* [Guidelines how to test the operation of the dapp under SNS control](/docs/current/building-dapps/governing-dapps/testing/testing-on-mainnet).

* [Stages included in an SNS launch](/docs/current/building-dapps/governing-dapps/launching/launch-summary-1proposal).

* [SNS proposals](/docs/current/building-dapps/governing-dapps/managing/making-proposals).

* [Tips regarding cycles management for the canisters](/docs/current/building-dapps/governing-dapps/managing/cycles-usage).

* [An introduction to how to use the asset canister with an SNS-controlled dapp](/docs/current/building-dapps/governing-dapps/managing/sns-asset-canister).
...
You will be prompted to log in with your Internet Identity. If you need to create one, check out the previous module [3.5 Identities and authentication](/docs/current/tutorials/developer-journey/level-3/3.5-identities-and-auth).
...
:::info
`MEMO` refers to a 64-bit numeric value as defined in the [IC specification](/docs/current/references/ledger#_transferring_tokens). It is used to generate unique hash values for transactions.
:::
...
If you scroll further, you can see advanced details and settings, such as when the neuron was created, its neuron account ID, and options to participate in the neurons' fund or split the neuron. [Learn more about these advanced options](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-app-quickstart).
...
For additional information the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](/docs/current/developer-docs/daos/nns/using-the-nns-dapp/nns-app-quickstart) and the [NNS explained series](https://youtu.be/1uX-fRgvXjU?feature=shared).
