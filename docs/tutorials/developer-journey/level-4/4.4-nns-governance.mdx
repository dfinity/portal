...
For additional information the NNS dapp, proposals, and neuron staking, check out the [NNS quick start guide](/docs/current/move-to-learnhub/nns/using-the-nns-dapp/nns-app-quickstart) and the [NNS explained series](https://youtu.be/1uX-fRgvXjU?feature=shared).
