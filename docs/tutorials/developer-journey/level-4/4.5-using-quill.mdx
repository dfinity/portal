...
[Read more about different types of self-custody wallet options in the documentation](/docs/current/defi/overview).
...
- [Quill CLI reference](/docs/current/building-apps/developer-tools/quill/)
