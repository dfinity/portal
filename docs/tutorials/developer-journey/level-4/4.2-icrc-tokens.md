...
There are several extensions of the ICRC-1 standard, such as the [ICRC-2](https://github.com/dfinity/ICRC-1/blob/main/standards/ICRC-2/README.md). Not all extensions of the ICRC standards must be extensions of the ICRC-1 standard, though. For this tutorial, we'll focus on the ICRC-1 standard, ICRC-1 ledger, and briefly look into the ICRC-2 standard. 
