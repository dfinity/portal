...
[Learn more about working with `Option` and `Result` types](/docs/motoko/main/writing-motoko/errors#working-with-optionresult).
...
- [Motoko mutable state](/docs/motoko/main/writing-motoko/mutable-state).

- [Motoko message inspection](/docs/motoko/main/writing-motoko/message-inspection).

- [Local object classes](/docs/motoko/main/writing-motoko/local-objects-classes).

- [Motoko error handling](/docs/motoko/main/writing-motoko/errors).
...
- [5.1 Developing an encrypted notes dapp with vetKD.](/docs/tutorials/developer-journey/level-5/5.1-vetKeys-tutorial)