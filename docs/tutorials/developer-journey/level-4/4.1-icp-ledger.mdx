---
keywords: [advanced, tutorial, developer ladder, icp tokens, icp ledger]
---
...
- Creating cycles by converting ICP into cycles, which are then used to pay for canister computation and resources. The developer ladder briefly covered converting ICP into cycles in [1.4 Acquiring and using cycles](/docs/current/tutorials/developer-journey/level-1/1.4-using-cycles).
