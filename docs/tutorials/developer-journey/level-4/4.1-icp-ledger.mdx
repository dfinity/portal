...
[Learn how to use `nns-js` to interact with the ledger from the web application](/docs/current/rosetta-defi/overview).

[Learn how to use the `ic-cdk` to make inter-canister calls to the ICP ledger](/docs/current/rosetta-defi/overview).
