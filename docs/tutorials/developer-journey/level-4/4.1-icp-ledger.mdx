...
- [Weekly developer office hours](https://discord.internetcomputer.org?event=1164114241893187655) to ask questions, get clarification, and chat with other developers live via voice chat. This is hosted on the [Discord](https://discord.internetcomputer.org) group.
