---
keywords: [advanced, tutorial, developer journey, icrc tokens, icrc ledger]
---
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/RDbt62tXXwk?si=x60WRf5977PYlGaA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
...
Then, use the following URL to download the Wasm module: `https://download.dfinity.systems/ic/<VERSION>/canisters/ic-icrc1-ledger.wasm.gz`. In this tutorial you'll use the URL https://download.dfinity.systems/ic/aba60ffbc46acfc8990bf4d5685c1360bd7026b9/canisters/ic-icrc1-ledger.wasm.gz.

Use the following URL can be used to download the Candid file: `https://raw.githubusercontent.com/dfinity/ic/<VERSION>/rs/ledger_suite/icrc1/ledger/ledger.did`. In this tutorial, you'll use the URL https://raw.githubusercontent.com/dfinity/ic/aba60ffbc46acfc8990bf4d5685c1360bd7026b9/rs/ledger_suite/icrc1/ledger/ledger.did.
...
Next, you'll use the `minter` identity you created in the last module, [4.1 Using the ICP ledger](/docs/current/tutorials/developer-journey/level-4/4.1-icp-ledger). If you need to export the `minter` identity's principal again, run the commands:
...
Then, set the identity that you want to use to deploy the ledger. In the previous module [4.1 Using the ICP ledger](/docs/current/tutorials/developer-journey/level-4/4.1-icp-ledger), you used the `DevJourney` identity, which you'll use again:
...
- [ic-cdk Rust crate](/docs/current/references/icrc1-standard).
