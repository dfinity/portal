...
This sample is based on the default project created by running `dfx new` as described in the [Motoko](../quickstart/local-quickstart) and [Rust](../build/languages/rust/rust-quickstart) quickstart documents.
