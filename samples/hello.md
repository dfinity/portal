...
This sample is based on the default project created by running `dfx new` as described in the [Motoko](../docs/developer-docs/quickstart/local-quickstart) and [Rust](../docs/developer-docs/build/languages/rust/rust-quickstart) quickstart documents.
