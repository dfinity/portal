...
const sliderData = [
...

  {
    ...
    image: "https://img.youtube.com/vi/t6gkEA0z0KQ/maxresdefault.jpg",
    link: "https://www.youtube.com/watch?v=t6gkEA0z0KQ",
  },
  {
    title:
      "Omnity Co-Founder Louis Liu on Bitcoin Integration & Cross-Chain Interoperability | ETH Denver",
    image: "https://img.youtube.com/vi/BBcenBf1yOo/maxresdefault.jpg",
    link: "https://www.youtube.com/watch?v=BBcenBf1yOo",
  },
  {
    title: "A Look into Oisy Wallet at BBW",
    image: "https://img.youtube.com/vi/iBZym_w-VY8/maxresdefault.jpg",
    link: "https://www.youtube.com/watch?v=iBZym_w-VY8",
  },
];
  ...
  return (
    <div className="slider-container">
      <aside className="gap-4 justify-end mb-6 hidden md:flex">
        <button
          className="bg-transparent w-12 h-12 p-0 inline-flex justify-center items-center rounded-full border border-white-20 border-solid outline-none"
          onClick={previous}
          aria-label="Previous"
        >
          <svg
        ...
        {sliderData.map((data, index) => (
          <div key={index} className="border-box pr-6">
            <CardWithImage href={data.link} image={data.image}>
              <div className="h-8">
                <h1 className="tw-heading-7 md:tw-heading-7 mb-0 line-clamp-1 text-black">
                  {data.title}
                </h1>
              </div>
            </CardWithImage>
