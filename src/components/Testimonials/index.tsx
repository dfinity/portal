...
const testimonials = [
  ...
  {
    testimonial:
      "maybe an unpopular opinion but i’m so long term bullish on the IC. one of the few L1s trying to be something more than “the most defi optimized chain”. still early days, but the IC could conceivably become an essential part of the web3 stack over the next few yrs",
    name: "Ben Perszyk",
  ...
  {
    testimonial:
      "The IC is one of the main reasons I chose to launch my web 3.0 career. The community and technology are forward thinking, and the blockchain platform has all I need to expand my music career, including my fave — Canistore. Most importantly, I am able to participate in governance, which allows all to have a say in the future direction of platform. In my opinion, the IC is going to play a pivotal role in the evolution of blockchain technology.",
    name: "An3ekah",
    ...
    <div className={styles.main}>
      ...
      >
        ...
        <p className={styles.title}>
          Who's talking about the Internet Computer
        </p>
        ...
        <div className={styles.infoContainer}>
          ...
          <img
            ...
            src={testimonials[testimonialIndex].portrait}
            alt=""
          />
        ...
        <div className={styles.testimonialIndexIndicator}>
          {testimonials.map((_testimonial, index) => {
            return index === testimonialIndex ? (
