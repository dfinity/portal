...
export const sampleItems: SampleItem[] = [
...

  {
    ...
    level: "advanced",
    contentType: ["community repo"],
    body: "Decentralized multichain, multi-owner wallet, supports major blockchains.",
    links: {
  ...
  },
  {
    ...
    domains: ["Asynchronous DeFi", "Multichain"],
    languages: ["motoko", "rust"],
    level: "advanced",
  ...
  },
  {
    ...
    domains: ["Asynchronous DeFi", "Website", "Multichain"],
    languages: ["motoko", "rust", "javascript"],
    level: "intermediate",
    contentType: [
      "code samples",
  ...
  },
  {
    ...
    domains: ["Global", "Asynchronous DeFi", "Multichain"],
    languages: ["motoko", "rust"],
    level: "intermediate",
    contentType: ["code samples", "documentation", "tutorial", "videos"],
