...
const SectionsLinks = [
    {text: "Start Coding", to: "#startCoding"},
...
export default function SectionsBar() {
    ...
    return (
        <div className={styles.container}>
            {
                isMobile ? <div className={styles.mobileContainer}>
                        {
                            displayMobileMenu ?
                                <>
                                    ...
                                    {SectionsLinks.map(({text, to}) =>
                                        <Link onClick={() => SetDisplayMobileMenu(!displayMobileMenu)}
                                              key={to} to={to}><span>{text}</span>
                                        </Link>)
                                    }
                                </> :
                            ...
                            >
                                <div className={styles.desktopContainer}>
                                    <div className={styles.grid}>
                                        ...
                                        {SectionsLinks.map(({text, to}) =>
                                            <Link key={to} to={to}><span>{text}</span></Link>
                                        )}
                                    </div>
