...
function Features() {
    ...
    return (
        <motion.div ref={ref}
            ...
            <a id="features"/>
            <motion.p variants={item} className={styles.title}>What's cool about
                the <br/> Internet Computer
            </motion.p>
            ...
            <div className={styles.cards}>
                {cardsContent.map((card) =>
                    <motion.a variants={item} href={card.link}
                              className={styles.card}>
                        <Card key={card.title} title={card.title}
                              body={card.body}
                        />
            ...
            <motion.div className={styles.actionButtonContainer}
                        variants={item}>
                <Link className={styles.actionButton}
                      to="https://dfinity.org/roadmap">
                    LEARN MORE
