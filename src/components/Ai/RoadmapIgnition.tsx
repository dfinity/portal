    ...
    <article id="Ignition"
      ...
      <div className="p-5 relative z-3 aspect-[7/2]">
        <div className="md:grid md:grid-cols-[6fr,10fr] gap-2">
          ...
          <div>
            <p className="text-black/60 tw-paragraph md:mr-9 line-clamp-4">
            ...
            <article className="flex flex-col justify-between px-6 pt-6 pb-6 bg-white rounded-lg text-black aspect-[1/0.5] md:aspect-[1/1.022222]">
              <div>
                ...
                <div className="basis-7 w-7 grow-0 shrink-0">
                  ...
                  <span
                  role="tooltip"
                  className="absolute z-50 -top-2 bg-black-60 py-1 px-4 rounded-lg tw-paragraph-sm opacity-0 text-white transition-opacity pointer-events-none group-hover:opacity-100 left-1/2 transform -translate-x-1/2 -translate-y-full text-nowrap text-center bg-black/75 rounded-lg whitespace-nowrap	">In
                  Progress</span><svg className="w-full block" viewBox="0 0 25 24" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <rect x="0.5" width="24" height="24" rx="12" fill="#FBB549"></rect>
                  <path
                ...
                <p className="tw-paragraph-sm ">Introducing canister that provides an API for processing LLM prompts</p>
              </div>
          ...
          <article className="flex flex-col justify-between px-6 pt-6 pb-6 bg-white rounded-lg text-black aspect-[1/0.5] md:aspect-[1/1.022222]">
            <div>
              <header className="flex gap-2 justify-between self-stretch">
                ...
                <div className="basis-7 w-7 grow-0 shrink-0"><span className="relative group cursor-pointer"><span
                  role="tooltip"
                  className="absolute z-50 -top-2 bg-black-60 py-1 px-4 rounded-lg tw-paragraph-sm opacity-0 text-white transition-opacity pointer-events-none group-hover:opacity-100 left-1/2 transform -translate-x-1/2 -translate-y-full text-nowrap text-center bg-black/75 rounded-lg whitespace-nowrap	">In
                  Progress</span><svg className="w-full block" viewBox="0 0 25 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="tw-paragraph-sm ">Tools and libraries to simplify the local development and the interaction with the LLM canister</p>
            </div>
            <div className="flex gap-2 pr-20 mt-2"></div>
          </article>
