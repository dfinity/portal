      ...
      <main className="overflow-hidden">
        ...
        <section className="mb-20 md:mb-40 container-12 flex flex-col gap-16 md:gap-40">
          ...
          >
            ...
            <p className="mb-0">
              <Link
                href="/docs/current/developer-education/developer-concepts/gas-cost"
          ...
          >
            ...
            <p className="text-black tw-lead-sm mb-6">
              ...
              <Link
                href="/docs/current/developer-education/glossary/index#xdr"
            ...
            <p className="text-black tw-lead-sm mb-6">
              ...
              <Link href="/docs/current/building-dapps/getting-started/tokens-and-cycles#4-convert-icp-into-cycles" className="link-subtle">
        ...
        <section className="container-12 relative py-30 md:py-40">
          ...
          <div className="grid grid-cols-1 grid-rows-2 md:grid-rows-none md:grid-cols-2 gap-5">
            <CardWithDescription
              title="Get Cycles"
              description=""
              href="/docs/current/building-dapps/getting-started/tokens-and-cycles#obtaining-cycles"
