  ...
  return (
    ...
    >
      ...
      >
          ...
          >
            ...
            <div className="md:w-7/10 relative">
              ...
              >
                ...
                Now imagine an autonomous serverless cloud that hosts data as
                well as logic, where software is tamperproof and unstoppable,
                can scale horizontally, and processes HTTP, where you can build
                sovereign systems and services that don't need the protection of
                firewalls...
                <span style={{ display: "block", height: "0.6em" }}></span>
        ...
        <section className="md:pt-30" id="traditional-it">
          <AnimateSpawn
          ...
          >
            <div className="md:w-6/10">
              ...
              >
                ...
                talent are just a few of the blockers holding tech endeavors
                back from innovating and staying ahead of the competition
          ...
          <div className="mb-20 md:mb-40 container-12 flex flex-col gap-16 md:gap-40 relative pt-20">
            ...
            >
              ...
              <p className="tw-lead-sm">
                ...
                on the Internet Computer. It offers serverless features
                comparable to existing cloud providers with extra benefits like
                tamperproof code, decentralization and statefulness.
              </p>
              <p className="tw-lead-sm">
            ...
            >
              ...
              <p className="tw-lead-sm">
                Simply put, it has no backdoors through which hackers can pass,
                or hosted software or data can be attacked by viruses and
                ransomware. That's because it's a virtual platform created by
                advanced math &mdash; fault-tolerant network protocols and
                cryptography developed by world class cryptographers, engineers
                and computer scientists in a project that applied hundreds of
                person-years effort.
              </p>
              <p className="tw-lead-sm">
          ...
          <div className="flex flex-col gap-16 md:gap-40">
            ...
            >
              <h3 className="tw-heading-4 md:tw-heading-60 mb-6">
                Encrypted file sharing & requesting
              </h3>
              <p className="tw-paragraph md:tw-lead-sm mb-6 md:mb-10">
                Effortless document sharing on the Internet Computer. No
                plugins, no passwords. DocuTrack enables seamless document
                requests, streamlining interactions for service providers and
                clients.
              </p>
              <Link
                className="link-primary link-with-icon"
                href="https://pxg7f-3yaaa-aaaap-qa6eq-cai.ic0.app/"
              >
                <LinkArrowRight /> Try it out and request your first file
              </Link>
            </TranslatedLayout>
            ...
            <div className="container-10 py-30 md:py-40 flex flex-col sm:flex-row text-white relative">
              ...
              <div className="flex-1 mt-40 sm:mt-0">
                ...
                <p className="tw-lead-sm md:tw-lead mb-6 md:mb-8">
                  ...
                  with experts to get a better sense of how the Internet
                  Computer could benefit your business.
                </p>
                <p className="mb-0">
                  <Link
        ...
        <section className="max-w-page relative mx-auto mb-20 px-6 md:mb-40 md:px-15 mt-40">
          ...
          >
            ...
            ></motion.div>
            <motion.h2
              className="tw-heading-3 text-center mb-2 md:w-[650px] mx-auto md:tw-heading-60 md:mb-6 lg:w-6/12"
              variants={transitions.item}
            >
