          ...
          >
            ...
            <div className="md:w-6/12 mx-auto text-center mb-12 md:mb-20 relative z-10">
              ...
              >
                ...
                the world of tokens. Tokens allow users, investors and
                developers to particpate in the network by allowing computation,
              ...
              >
                <div className="flex-1 group-hover:-translate-y-3 transition-transform">
                  ...
                  <p className="tw-paragraph-sm text-black mb-0 group-hover:text-white">
                    ...
                    currencies. Note that they will have custody over any ICP
                    you buy until you send it to a wallet you control.
                  </p>
                </div>
              ...
              >
                <div className="flex-1 group-hover:-translate-y-3 transition-transform">
                  ...
                  <p className="tw-paragraph-sm text-black group-hover:text-white">
                    If you want to store tokens, nfts, or connect to dapps on
                    the IC, there are a number of wallets and self-custody
                    options.
                  </p>
                </div>
                <ChevronRight className="text-infinite group-hover:text-white transition-colors"></ChevronRight>
              ...
              >
                ...
                <div className="tw-paragraph md:mb-0">
                  ...
                  <p>
                    ...
                    The price of cycles is fixed to ensure your computational
                    cost is always predictable.
                  </p>
                ...
                >
                  <div className="tw-paragraph md:mb-0">
                    <p className="">
                      ...
                      tokens and vote on network proposals. Staking and voting
                      are easily to do in the official NNS dapp.
                    </p>
                    <p className="mb-8">
            ...
            >
              ...
              <div className=" flex gap-2/10 flex-col md:flex-row">
                ...
                >
                  <div className="tw-paragraph md:mb-0">
                    <p className="mb-0">
                      The fee of an ICP ledger transaction is fixed at 0.0001
                      ICP. It allows efficient transfers and dapp payments. Use
                      the NNS dapp or the available wallets to send
                      transacitons:
                    </p>
                  </div>
                </motion.div>
            ...
            >
              ...
              <div className="md:mx-auto md:w-10/12 ">
                ...
                <motion.h2
                  ...
                  variants={transitions.item}
                >
                  A range of custody options are available, including support
                  for holding private keys in an airgapped machine or ledger
                  device.
                </motion.h2>
              ...
              >
                ...
                >
                  ...
                  <p className="tw-paragraph-sm text-black-60">
                    ...
                    researchers, cryptographers and engineers propose, design
                    and develop improvements to the Internet Computer
                    blockchain.
                  </p>
                  <p className="mb-3">
                    <a
                ...
                >
                  ...
                  <p className="tw-paragraph-sm text-black-60">
                    Internet Computer community commits to long term future of
                    the project. 50% of tokens staked, nearly 25% of all tokens
                    are staked for over 8 years.
                  </p>
                </motion.div>
                <motion.div
