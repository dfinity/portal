...
const developers = [
  {
    ...
    description: (
      <>
        ...
        ,{" "}
        <Link
          href="https://internetcomputer.org/docs/current/building-apps/using-network-features/verifiable-credentials/overview"
          className="link-primary-light"
          target="_blank"
          rel="noopener noreferrer"
        >
            ...
            >
              <div className="md:w-[55%]  pt-16 md:pt-40 ">
                ...
                <Link
                  ...
                  href="https://internetcomputer.org/docs/current/building-apps/authentication/integrate-internet-identity"
                >
                  <LinkArrowRight />
          ...
          <div className="container-10 relative">
            ...
            >
              <div className="md:w-1/2  pt-16 md:pt-40 ">
                ...
                <Link
                  className="button-primary mt-6"
                  href="https://internetcomputer.org/docs/current/building-apps/using-network-features/verifiable-credentials/issuer"
                >
                  Become an Issuer
                </Link>
              </div>
              ...
              >
                  ...
                  <p className="tw-paragraph md:tw-lead-sm mb-0">
                    <ul>
                      ...
                      <li>
                        ...
                        for instance the <Link href="/docs/current/defi/token-ledgers/usage/icp_ledger_usage">IC Ledger canister</Link>.
                      </li>
                    </ul>
                  </p>
                  <p className="tw-paragraph md:tw-lead-sm mb-0">
                ...
                >
                  ...
                  <p className="tw-paragraph md:tw-lead-sm mb-0">
                    ...
                    <div>
                      <Link
                        href="/docs/current/building-apps/using-network-features/verifiable-credentials/how-it-works"
