...
function HomeNavBar() {
    ...
    useEffect(() => {
        ...
        window.addEventListener("scroll", shouldDisplayHomeNav);
        return () =>
            window.removeEventListener("scroll", shouldDisplayHomeNav);
    }, [])
...
function WhatsIC() {
    return <div className={styles.whatsIC}>
        ...
        <p className={styles.whatsICBody}>Imagine building scalable Dapps, DeFi, websites, enterprise systems and open
        ...
        <p className={styles.whatsICBody}>The Internet Computer is blockchain reimagined, a world computer built by a
            ...
            Computer is the world's fastest, most scalable blockchain. It unleashes the full capacity of smart contracts
            enabling infinite data and computation capacity hosted entirely on chain. Developers, the world is at your
            fingertips!</p>
        ...
        <WhatsTheIcBG className={styles.whatsICBG}/>
    </div>
}
