...
export default function Home(): JSX.Element {
    ...
    const shouldRenderLandingPageMobile = mobileAndTabletCheck();
    const shouldRenderLandingPageDesktop = !shouldRenderLandingPageMobile;
    useEffect(() => {
    ...
    return (
        <Layout
            ...
            <>
                {shouldRenderLandingPageDesktop && <LandingPageDesktop/>}
                {shouldRenderLandingPageMobile && <LandingPageMobile/>}
            </>
        </Layout>
    );
}
