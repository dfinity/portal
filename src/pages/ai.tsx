    ...
    >
      ...
      >
        ...
        <section className="container-10 relative mt-40 sm:mt-52 md:mt-60">
          ...
          <AnimateSpawn
            variants={transitions.container}
            className="bg-white px-4 md:px-10 pt-6 pb-1 md:pb-12 md:pt-12 gap-8 mb-10 sm:mb-40 rounded-xl"
          >
            <motion.div>
              <aside className="container-10 md:flex md:items-center mt-6 md:mt-0 !pl-0	!pr-0">
                <div className="md:w-1/2">
              ...
              <aside className="container-10 mt-12 md:mt-32 md:flex md:items-center !pl-0	!pr-0">
                <div className="md:w-1/3">
                  ...
                  <motion.p className="text-2xl mb-0 ">
                    ...
                    involves running AI inference as smart contracts onchain,
                    which addresses AI’s trust issues. Users can verify the
                    inputs to the models they utilize, reducing the need to
                    trust them blindly. However, AI training and inference are
                    highly resource-intensive, and the limited computational
                    capabilities of traditional blockchain networks often fall
                    short. In contrast, the advanced design of the Internet
                    Computer Protocol (ICP) successfully marries the security of
                    smart contracts with the robust computational demands of AI.
                    The following properties of ICP make decentralized and
